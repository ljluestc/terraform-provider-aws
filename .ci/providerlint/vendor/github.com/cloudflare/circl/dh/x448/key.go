...
// key is a low-order point, thus the shared key is all-zeros and the 

// returns false.

red(shared, secret, public *Key) bool {
	validPk := *public
