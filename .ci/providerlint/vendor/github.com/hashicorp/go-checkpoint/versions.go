...
type VersionsParams struct {
	...
	Service string	// Product is used to filter the version contraints.
	Product string	// Force, if true, will force the check even if CHECKPOINT_DISABLE
...
type VersionsResponse struct {
...
}// Versions returns the version constrains for a given service and product. Versions(p *VersionsParams) (*VersionsResponse, error) {
	...
	v.Set("product", p.Product)	u := &url.URL{
		Scheme:   "https",
