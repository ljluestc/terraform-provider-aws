...
ctxCancelcontext.CancelnegotiatedVersion int// clientWaitGroup is used to manage the lifecycle of the plugin management
// goroutines.
...
// forcefully killed.
processKilled boolunixSocketCfg UnixSocketConfig
...
cmd.Stdin = os.Stdinif c.config.SecureConfig != nil {
...
reattach
 := c.config.Reattach.Reattach// For backwards compatibility default to cmdrunner.Reattachif reattach
 == nil {
reattach
 = cmdrunner.Reattach
