...
// source: grpc_broker.protopackage pluginimport proto "github.com/golang/protobuf/proto"
import fmt "fmt"
...
const _ = proto.ProtoPackageIsVersion2 // please upgrade the proto packagetype ConnInfo struct {
...
*ConnInfo) Reset(){ *m = ConnInfo{} }*ConnInfo) String() string { return proto.CompactTextString(m) } (*ConnInfo) ProtoMessage()    {} (*ConnInfo) Descriptor() ([]byte, []int) {
...
t _ = grpc.SupportPackageIsVersion4// GRPCBrokerClient is the client API for GRPCBroker service.
//
...
type GRPCBrokerClient interface {
 ...
 (c *gRPCBrokerClient) StartStream(ctx context.Context, opts ...grpc.CallOption) (GRPCBroker_StartStreamClient, error) {
	...
	if err != nil {
		return nil, err	x := &gRPCBrokerStartStreamClient{stream}
	return x, nil
...
err := x.ServerStream.RecvMsg(m); err != nil {
 ...
 init() { proto.RegisterFile("grpc_broker.proto", fileDescriptor_grpc_broker_3322b07398605250) }var fileDescriptor_grpc_broker_3322b07398605250 = []byte{
