...
// source: grpc_controller.protopackage pluginimport proto "github.com/golang/protobuf/proto"
import fmt "fmt"
...
const _ = proto.ProtoPackageIsVersion2 // please upgrade the proto packagetype Empty struct {
XXX_NoUnkeyedLiteral struct{} `json:"-"`
XXX_unrecognized     []byte   `json:"-"`
XXX_sizecache        int32    `json:"-"`
}
*Empty) Reset(){ *m = Empty{} }*Empty) String() string { return proto.CompactTextString(m) } (*Empty) ProtoMessage()    {} (*Empty) Descriptor() ([]byte, []int) {
...
const _ = grpc.SupportPackageIsVersion4// GRPCControllerClient is the client API for GRPCController service.// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
