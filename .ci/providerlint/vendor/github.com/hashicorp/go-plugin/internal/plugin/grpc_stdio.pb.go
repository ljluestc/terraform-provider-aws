...
// source: grpc_stdio.protopackage pluginimport proto "github.com/golang/protobuf/proto"
import fmt "fmt"
import math "math"
import empty "github.com/golang/protobuf/ptypes/empty"import (
	context "context"
...
const _ = proto.ProtoPackageIsVersion2 // please upgrade the proto packagetype StdioData_Channel int32const (
...
type StdioData struct {
	...
	XXX_sizecache        int32    `json:"-"`*StdioData) Reset(){ *m = StdioData{} } (m *StdioData) String() string { return proto.CompactTextString(m) } (*StdioData) ProtoMessage()    {}tdioData) Descriptor() ([]byte, []int) {
...
const _ = grpc.SupportPackageIsVersion4// GRPCStdioClient is the client API for GRPCStdio service.
//
...
it is not sent again.
 ...
 (c *gRPCStdioClient) StreamStdio(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (GRPCStdio_StreamStdioClient, error) {
	...
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	return x, nil
...
type GRPCStdioServer interface {
 ...
 init() { proto.RegisterFile("grpc_stdio.proto", fileDescriptor_grpc_stdio_db2934322ca63bd5) }var fileDescriptor_grpc_stdio_db2934322ca63bd5 = []byte{
