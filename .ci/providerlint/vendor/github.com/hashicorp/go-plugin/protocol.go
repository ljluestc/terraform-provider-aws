...
Init() error// Config is extra configuration to be outputted to stdout. This will
...
Config() string// Serve is called to serve connections on the given listener. This should
...
io.Closer// Dispense dispenses a new instance of the plugin with the given name.
Dispense(string) (interface{}, error)// Ping checks that the client connection is still healthy.
Ping() error
}
