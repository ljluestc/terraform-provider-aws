...
DetectVendoring boolpathToRemove string
logger       *log.Logger
}
...
}binPath := filepath.Join(targetDir, binaryName)gb.pathToRemove = binPathreturn binPath, nil
}
...
noopCleanup
 := 
(contexntext) {}var installedVersion *version.Versionif gb.Version != nil {
