...
// SPDX-License-Identifier: MPL-2.0package pubkeyconst (
	// See https://www.hashicorp.com/security
	DefaultPublicKey = `-----BEGIN PGP PUBLIC KEY BLOCK-----mQINBGB9+xkBEACabYZOWKmgZsHTdRDiyPJxhbuUiKX65GUWkyRMJKi/1dviVxOX
