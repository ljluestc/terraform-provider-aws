...
// SPDX-License-Identifier: MPL-2.0//go:build go1.18
// +build go1.18package hcl// This file contains additional diagnostics-related symbols that use the
// Go 1.18 type parameters syntax and would therefore be incompatible with
// Go 1.17 and earlier.// DiagnosticExtra attempts to retrieve an "extra value" of type T from the
...
// failure. DiagnosticExtra[T any](diag *Diagnostic) (T, bool) {
	extra := diag.Extra
	var zero T	for {
