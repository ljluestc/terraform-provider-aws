...
// SPDX-License-Identifier: MPL-2.0package hcl// ExprCall tests if the given expression is a 
tion call and,
// if so, extracts the 
...
tion to a wrapped
// Expression object. ExprCall(expr Expression) (*StaticCall, Diagnostics) {
