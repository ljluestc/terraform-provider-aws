...
type Block struct {
	Type   string
	Labels []string
	Body   Body	DefRange    Range   // Range that can be considered the "definition" for seeking in an editor
...
type BodyContent struct {
	...
	Blocks     Blocks	MissingItemRange Range
...
tions are not permitted at all,
	...
	Variables() []Traversal	Range() Range
	StartRange() Range
