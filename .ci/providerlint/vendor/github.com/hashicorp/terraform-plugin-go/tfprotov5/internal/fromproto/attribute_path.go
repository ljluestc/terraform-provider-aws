...
ributePath(in *tfplugin5.AttributePath) (*tftypes.AttributePath, error) {
...
ributePaths(in []*tfplugin5.AttributePath) ([]*tftypes.AttributePath, error) {
...
ributePathStep(step *tfplugin5.AttributePath_Step) (tftypes.AttributePathStep, error) {
...
ributePathSteps(in []*tfplugin5.AttributePath_Step) ([]tftypes.AttributePathStep, error) {
