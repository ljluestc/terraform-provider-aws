...
gnostic(in *tfplugin5.Diagnostic) (*tfprotov5.Diagnostic, error) {
...
gnosticSeverity(in tfplugin5.Diagnostic_Severity) tfprotov5.DiagnosticSeverity {
	return tfprotov5.DiagnosticSeverity(in)
}


gnostics(in []*tfplugin5.Diagnostic) ([]*tfprotov5.Diagnostic, error) {
