...
ributePath(in *tftypes.AttributePath) (*tfplugin6.AttributePath, error) {
	if in == nil {
		return nil, nil
	}
...
ributePaths(in []*tftypes.AttributePath) ([]*tfplugin6.AttributePath, error) {
...
ributePath_Step(step tftypes.AttributePathStep) (*tfplugin6.AttributePath_Step, error) {
...
ributePath_Steps(in []tftypes.AttributePathStep) ([]*tfplugin6.AttributePath_Step, error) {
