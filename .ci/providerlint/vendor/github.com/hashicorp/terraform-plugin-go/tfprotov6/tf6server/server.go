...
// Serve 
. Each implementation modifies the ServeConfig being
...
serveConfig
plyServeOpt(in *ServeConfig) error {
	return s(in)
}
...
hDebug(ctx context.Context, config chan *plugin.ReattachConfig, closeCh chan struct{}) ServeOpt {
	return serveConfig
...
hManagedDebugStopSignals(signals []os.Signal) ServeOpt {
	return serveConfig
...
hManagedDebugReattachConfigTimeout(timeout time.Duration) ServeOpt {
	return serveConfig
...
hGoPluginLogger(logger hclog.Logger) ServeOpt {
	return serveConfig
...
hLoggingSink(t testing.T) ServeOpt {
	return serveConfig
...
houtLogStderrOverride() ServeOpt {
	return serveConfig
...
hLogEnvVarName(name string) ServeOpt {
	return serveConfig
...
ve(name string, serverFactory 
fprotov6.ProviderServer, opts ...ServeOpt) error {
	// Defaults
	conf := ServeConfig{
	...
	serveConfig := &plugin.ServeConfig{
		...
		GRPCServer: 
s []grpc.ServerOption) *grpc.Server {
	...
	// This is currently intended to be executed via provider main 
 and
...
geStop(ctx context.Context, cancel context.Cancel
opCh chan struct{}) {
	select {
	case <-ctx.Done():
		return
...
*server) stoppableContext(ctx context.Context) context.Context {
	s.stopMu.Lock()
...
*server) loggingContext(ctx context.Context) context.Context {
	if s.useTFLogSink {
...
(name string, serve tfprotov6.ProviderServer, opts ...ServeOpt) tfplugin6.ProviderServer {
...
*server) GetMetadata(ctx context.Context, req *tfplugin6.GetMetadata_Request) (*tfplugin6.GetMetadata_Response, error) {
	rpc := "GetMetadata"
...
*server) GetProviderSchema(ctx context.Context, req *tfplugin6.GetProviderSchema_Request) (*tfplugin6.GetProviderSchema_Response, error) {
...
*server) ConfigureProvider(ctx context.Context, req *tfplugin6.ConfigureProvider_Request) (*tfplugin6.ConfigureProvider_Response, error) {
...
*server) ValidateProviderConfig(ctx context.Context, req *tfplugin6.ValidateProviderConfig_Request) (*tfplugin6.ValidateProviderConfig_Response, error) {
...
*server) StopProvider(ctx context.Context, req *tfplugin6.StopProvider_Request) (*tfplugin6.StopProvider_Response, error) {
	rpc := "StopProvider"
	ctx = s.loggingContext(ctx)
	ctx = logging.RpcContext(ctx, rpc)
	ctx = s.stoppableContext(ctx)
...
*server) ValidateDataResourceConfig(ctx context.Context, req *tfplugin6.ValidateDataResourceConfig_Request) (*tfplugin6.ValidateDataResourceConfig_Response, error) {
...
*server) ReadDataSource(ctx context.Context, req *tfplugin6.ReadDataSource_Request) (*tfplugin6.ReadDataSource_Response, error) {
	rpc := "ReadDataSource"
	ctx = s.loggingContext(ctx)
	ctx = logging.RpcContext(ctx, rpc)
	ctx = logging.DataSourceContext(ctx, req.TypeName)
...
*server) ValidateResourceConfig(ctx context.Context, req *tfplugin6.ValidateResourceConfig_Request) (*tfplugin6.ValidateResourceConfig_Response, error) {
...
*server) UpgradeResourceState(ctx context.Context, req *tfplugin6.UpgradeResourceState_Request) (*tfplugin6.UpgradeResourceState_Response, error) {
...
*server) ReadResource(ctx context.Context, req *tfplugin6.ReadResource_Request) (*tfplugin6.ReadResource_Response, error) {
	rpc := "ReadResource"
	ctx = s.loggingContext(ctx)
	ctx = logging.RpcContext(ctx, rpc)
	ctx = logging.ResourceContext(ctx, req.TypeName)
...
*server) PlanResourceChange(ctx context.Context, req *tfplugin6.PlanResourceChange_Request) (*tfplugin6.PlanResourceChange_Response, error) {
...
*server) ApplyResourceChange(ctx context.Context, req *tfplugin6.ApplyResourceChange_Request) (*tfplugin6.ApplyResourceChange_Response, error) {
...
*server) ImportResourceState(ctx context.Context, req *tfplugin6.ImportResourceState_Request) (*tfplugin6.ImportResourceState_Response, error) {
