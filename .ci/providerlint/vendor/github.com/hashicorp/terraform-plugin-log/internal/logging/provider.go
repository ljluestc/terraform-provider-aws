...
// from a provider. If no root logger has been created, it will return nil.
 ...
 GetProviderRootLogger(ctx context.Context) hclog.Logger {
...
r the options are not present, it will return nil.

 GetProviderRootLoggerOptions(ctx context.Context) *hclog.LoggerOptions {
...
// logs from a provider.
 ...
 SetProviderRootLogger(ctx context.Context, logger hclog.Logger) context.Context {
...
// used for creating the provider root logger.
 ...
 SetProviderRootLoggerOptions(ctx context.Context, loggerOptions *hclog.LoggerOptions) context.Context {
...
// it will return nil.
 ...
 GetProviderSubsystemLogger(ctx context.Context, subsystem string) hclog.Logger {
...
ProviderSubsystemLogger(ctx context.Context, subsystem string, logger hclog.Logger) context.Context {
...
// The value is stored in the context.Context: if none is found, a new one will be created.
 ...
 GetProviderRootTFLoggerOpts(ctx context.Context) LoggerOpts {
...
etProviderRootTFLoggerOpts sets the LoggerOpts of the provider root logger, in the context.

 SetProviderRootTFLoggerOpts(ctx context.Context, lOpts LoggerOpts) context.Context {
...
// The value is stored in the context.Context: if none is found, a new one will be created.
 ...
 GetProviderSubsystemTFLoggerOpts(ctx context.Context, subsystem string) LoggerOpts {
...
// SetProviderSubsystemTFLoggerOpts sets the LoggerOpts of the logger for the named provider subsystem, in the context.
 ...
 SetProviderSubsystemTFLoggerOpts(ctx context.Context, subsystem string, lOpts LoggerOpts) context.Context {
