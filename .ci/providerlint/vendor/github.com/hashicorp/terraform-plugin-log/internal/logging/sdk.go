...
// If no root logger has been created, it will return nil.
 ...
 GetSDKRootLogger(ctx context.Context) hclog.Logger {
...
he options are not present, it will return nil.
 ...
 GetSDKRootLoggerOptions(ctx context.Context) *hclog.LoggerOptions {
...
// an SDK.
 ...
 SetSDKRootLogger(ctx context.Context, logger hclog.Logger) context.Context {
...
// used for creating the SDK root logger.
 ...
 SetSDKRootLoggerOptions(ctx context.Context, loggerOptions *hclog.LoggerOptions) context.Context {
...
// The value is stored in the context.Context: if none is found, a new one will be created.
 ...
 GetSDKRootTFLoggerOpts(ctx context.Context) LoggerOpts {
...
// SetSDKRootTFLoggerOpts sets the LoggerOpts of the SDK root logger, in the context.
 ...
 SetSDKRootTFLoggerOpts(ctx context.Context, lOpts LoggerOpts) context.Context {
...
// nil.
 ...
 GetSDKSubsystemLogger(ctx context.Context, subsystem string) hclog.Logger {
...
DK space.
 ...
 SetSDKSubsystemLogger(ctx context.Context, subsystem string, logger hclog.Logger) context.Context {
...
// The value is stored in the context.Context: if none is found, a new one will be created.
 ...
 GetSDKSubsystemTFLoggerOpts(ctx context.Context, subsystem string) LoggerOpts {
...
// SetSDKSubsystemTFLoggerOpts sets the LoggerOpts of the logger for the named SDK subsystem, in the context.
 ...
 SetSDKSubsystemTFLoggerOpts(ctx context.Context, subsystem string, lOpts LoggerOpts) context.Context {
