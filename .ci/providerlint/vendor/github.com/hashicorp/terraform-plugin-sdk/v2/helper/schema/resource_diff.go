...
//
// The object 
tioimilar to ResourceData, however most notably lacks
// Set, SetPartial, and Partial, as it should be used to change diff values
// only.  Most other first-class ResourceData 
tions exist, namely Get,
// GetOk, HasChange, and GetChange exist.
//
// All 
tions in ResourceDiff, save for ForceNew, can only be used on
// computed fields.
...
tion (with a new ResourceDiff) once the current
