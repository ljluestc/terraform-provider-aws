...
// SPDX-License-Identifier: MPL-2.0package tfdiagstype Diagnostic interface {
	Severity() Severity
	Description() Description
}type Severity rune// This code was previously generated with a go:generate directive calling:
