...
Ops    *CapsuleOps
 ...
 (t *capsuleType) Equals(other Type) bool {
...
return false
 ...
 (t *capsuleType) FriendlyName(mode friendlyTypeNameMode) string {
return t.Name



 (t *capsuleType) GoString() string {
...
// TypeGoString 
tion to override this with something more
// reasonable.
...
// Capsule 
tion creates an entirely-distinct cty Type, even if two calls
...
// instead of Capsule.
//
// The given name is used as the new type's "friendlye". This can be any
...
nd will ideally not create ambiguity with any predefined cty type.
//
...
// that might be returned.
 ...
 Capsule(name string, nativeType reflect.Type) Type {
return Type{
&capsuleType{
Name:   name,
GoType: nativeType,
...
// in cty operations.
 ...
 CapsuleWithOps(name string, nativeType reflect.Type, ops *CapsuleOps) Type {
...
// Is IsCapsuleType to determine if this method is safe to call.
 ...
 (t Type) EncapsulatedType() reflect.Type {
