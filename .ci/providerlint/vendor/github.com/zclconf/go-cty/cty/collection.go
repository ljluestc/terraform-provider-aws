...
his method will succeed.

 (t Type) ElementType() Type {
...
// Return true to stoerating after the current element, or false to
// continue iterating.
type ElementCallback 
(key Value, val Value) (stop bool)
