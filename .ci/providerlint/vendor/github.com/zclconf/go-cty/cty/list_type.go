...
qual to that of the receiver.
 ...
 (t typeList) Equals(other Type) bool {
...
return t.ElementTypeT.Equals(ot.ElementTypeT)
 ...
 (t typeList) FriendlyName(mode friendlyTypeNameMode) string {
...
return t.ElementTypeT
 ...
 (t typeList) GoString() string {
rn fmt.Sprintf("cty.List(%#v)", t.ElementTypeT)
}

// IsListType returns true if the given type is a list type, regardless of its
// element type.

 (t Type) IsListType() bool {
