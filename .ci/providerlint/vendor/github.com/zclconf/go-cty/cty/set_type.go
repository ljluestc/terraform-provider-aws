...
qual to that of the receiver.
 ...
 (t typeSet) Equals(other Type) bool {
...
return t.ElementTypeT.Equals(ot.ElementTypeT)
 ...
 (t typeSet) FriendlyName(mode friendlyTypeNameMode) string {
...
return t.ElementTypeT
 ...
 (t typeSet) GoString() string {
rn fmt.Sprintf("cty.Set(%#v)", t.ElementTypeT)
}

// IsSetType returns true if the given type is a list type, regardless of its
// element type.

 (t Type) IsSetType() bool {
