...
// license that can be found in the LICENSE file.//go:build gccgo && !aix && !hurd
// +build gccgo,!aix,!hurdpackage uniximport "syscall"// We can't use the gc-syntax .s files for gccgo. On the plus side
// much of the 
tionality can be written directly in Go.
