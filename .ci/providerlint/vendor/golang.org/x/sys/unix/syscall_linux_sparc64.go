...
// +build sparc64,linuxpackage unix//sysEpollWait(epfd int, events []EpollEvent, msec int) (n int, err error)
...
snbGettimeofday(tv *Timeval) (err error)
...
}sUtime(path string, buf *Utimbuf) (err error)
