...
// +build zos,s390x// Hand edited based on zerrors_linux_s390x.go
// TODO: auto-generate.package unixconst (
BRKINT                          = 0x0001
CLOCK_MONOTONIC                 = 0x1
...
{133, "EDC5133I", "pace left on device."},
{134, "EDC5134I", "
...
{166, "EDC5166I", "Access mode argument on 
tion call conflicts with PATHOPTS parameter on JCL DD statement."},
...
{229, "EDC5229I", "No pdefinition for ddname in effect"},
{230, "EDC5230I", "ESM error."},
{231, "EDC5231I", "CP or the external security manager had an error"},
{232, "EDC5232I", "The 
tion failed because it was invoked from a multithread environment."},
{244, "EDC5244I", "The program, module or DLL is not supported in this environment."},
{245, "EDC5245I", "Datanot valid."},
{246, "EDC5246I", "own system state."},
{247, "EDC5247I", "Operation not supported."},
{248, "EDC5248I", "The object name specified is not correct."},
{249, "EDC5249I", "The 
tion is not allowed."},
{257, "EDC5257I", "
tion cannot be called in the child process of a fork() from a multithreaded process until exec() is called."},
{258, "EDC5258I", "A CUN_RS_NO_UNI_ENV error was issued by Unicode Services."},
{259, "EDC5259I", "A CUN_RS_NO_CONVERSION error was issued by Unicode Services."},
{260, "EDC5260I", "A CUN_RS_TABLE_NOT_ALIGNED error was issued by Unicode Services."},
{262, "EDC5262I", "An iconv() 
tion encountered an unexpected error while using Unicode Services."},
...
{1159, "EDC8159I", "
tion call was interrupted before any data was received."},
