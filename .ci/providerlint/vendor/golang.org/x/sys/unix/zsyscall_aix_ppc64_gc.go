...
// Code generated by the command above; see README.md. DO NOT EDIT.//go:build aix && ppc64 && gc
// +build aix,ppc64,gcpackage uniximport (
"unsafe"
...
//go:cgo_import_dynamic libc_mmap64 mmap64 "libc.a/shr_64.o"//go:linkname libc_utimes libc_utimes
...
//go:linkname libc_mmap64 libc_mmap64type syscall
 uintptrvar (
libc_utimes,
libc_utimensat,
libc_getcwd,
...
libc_getrlimit,
libc_lseek,
libc_mmap64 syscall)mplemented in runtime/syscall_aix.go. rawSyscall6(trap, nargs, a1, a2, a3, a4, a5, a6 uintptr) (r1, r2 uintptr, err Errno)call6(trap, nargs, a1, a2, a3, a4, a5, a6 uintptr) (r1, r2 uintptr, err Errno)// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT
