...
// Code generated by the command above; see README.md. DO NOT EDIT.//go:build dragonfly && amd64
// +build dragonfly,amd64package uniximport (
	"syscall"
	"unsafe"
 ...
 pipe2(p *[2]_C_int, flags int) (r int, w int, err error) {
