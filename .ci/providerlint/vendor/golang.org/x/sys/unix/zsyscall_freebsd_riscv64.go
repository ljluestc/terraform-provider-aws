...
// Code generated by the command above; see README.md. DO NOT EDIT.//go:build freebsd && riscv64
// +build freebsd,riscv64package uniximport (
"syscall"
"unsafe"
...
return
 ...
 ptracePtr(request int, pid int, addr unsafe.Pointer, data int) (err error) {
_, _, e1 := Syscall6(SYS_PTRACE, uintptr(request), uintptr(pid), uintptr(addr), uintptr(data), 0, 0)
if e1 != 0 {
err = errnoErr(e1)
}
...
return
 ...
 capRightsLimit(fd int, rightsp *CapRights) (err error) {
