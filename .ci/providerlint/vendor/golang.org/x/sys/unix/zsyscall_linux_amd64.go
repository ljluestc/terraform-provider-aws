...
// Code generated by the command above; see README.md. DO NOT EDIT.//go:build linux && amd64
// +build linux,amd64package uniximport (
"syscall"
"unsafe"
...
return
 ...
 _, e1 := Syscall(SYS_MEMFD_SECRET, uintptr(flags), 0, 0)
fd = int(r0)
if e1 != 0 {
err = errnoErr(e1)
}
...
vmsg(s int, msg *Msghdr, flags int) (n int, err error) {
