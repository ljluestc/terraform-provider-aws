...
// Code generated by the command above; see README.md. DO NOT EDIT.//go:build linux && ppc64le
// +build linux,ppc64lepackage uniximport (
"syscall"
"unsafe"
...
_, e1 := Syscall(SYS_FSTATFS, uintptr(fd), uintptr(unsafe.Pointer(buf)), 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
}// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT
uncate(fd int, length int64) (err error) {
...
_p0, err = BytePtrFromString(path)
if err != nil {
return_, _, e1 := Syscall(SYS_LSTAT, uintptr(unsafe.Pointer(_p0)), uintptr(unsafe.Pointer(stat)), 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
...
_, e1 := RawSyscall(SYS_SETGROUPS, uintptr(n), uintptr(unsafe.Pointer(list)), 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
...
me(path string, buf *Utimbuf) (err error) {
var _p0 *byte
_p0, err = BytePtrFromString(path)
if err != nil {
return
...
return
 ...
 syncFileRange2(fd int, flags int, off int64, n int64) (err error) {
