...
// Code generated by the command above; see README.md. DO NOT EDIT.//go:build linux && riscv64
// +build linux,riscv64package uniximport (
	"syscall"
	"unsafe"
 ...
 riscvHWProbe(pairs []RISCVHWProbePairs, cpuCount uintptr, cpus *CPUSet, flags uint) (err error) {
	var _p0 unsafe.Pointer
	if len(pairs) > 0 {
