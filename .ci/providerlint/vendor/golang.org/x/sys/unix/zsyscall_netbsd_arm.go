...
// Code generated by the command above; see README.md. DO NOT EDIT.//go:build netbsd && arm
// +build netbsd,armpackage uniximport (
	"syscall"
	"unsafe"
...
ntptr(newp), uintptr(newsize), uintptr(flags), 0)
	xaddr = uintptr(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
