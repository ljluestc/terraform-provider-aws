...
// Code generated by the command above; see README.md. DO NOT EDIT.//go:build solaris && amd64
// +build solaris,amd64package uniximport (
	"syscall"
	"unsafe"
...
//go:cgo_import_dynamic libc_getmsg getmsg "libc.so"//go:linkname procpipe libc_pipe
...
//go:linkname procgetmsg libc_getmsgvar (
	procpipe,
	procpipe2,
	procgetsockname,
	procGetcwd,
 ...
 pipe(p *[2]_C_int) (n int, err error) {
 ...
 wait4(pid int32, statusp *_C_int, options int, rusage *Rusage) (wpid int32, err error) {
 ...
 utimensat(fd int, path string, times *[2]Timespec, flag int) (err error) {
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil {
		return
 ...
 futimesat(fildes int, path *byte, times *[2]Timeval) (err error) {
 ...
 ioctlRet(fd int, req int, arg uintptr) (ret int, err error) {
 ...
 ioctlPtrRet(fd int, req int, arg unsafe.Pointer) (ret int, err error) {
	r0, _, e1 := sysvicall6(uintptr(unsafe.Pointer(&procioctl)), 3, uintptr(fd), uintptr(req), uintptr(arg), 0, 0, 0)
	ret = int(r0)
	if e1 != 0 {
		err = e1
 ...
 Fstatvfs(fd int, vfsstat *Statvfs_t) (err error) {
 ...
 Getdents(fd int, buf []byte, basep *uintptr) (n int, err error) {
	var _p0 *byte
	if len(buf) > 0 {
		_p0 = &buf[0]
	}
 ...
 Statvfs(path string, vfsstat *Statvfs_t) (err error) {
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil {
		return
 ...
 port_associate(port int, source int, object uintptr, events int, user *byte) (n int, err error) {
 ...
 port_get(port int, pe *portEvent, timeout *Timespec) (n int, err error) {
 ...
 port_getn(port int, pe *portEvent, max uint32, nget *uint32, timeout *Timespec) (n int, err error) {
 ...
 putmsg(fd int, clptr *strbuf, dataptr *strbuf, flags int) (err error) {
 ...
 getmsg(fd int, clptr *strbuf, dataptr *strbuf, flags *int) (err error) {
