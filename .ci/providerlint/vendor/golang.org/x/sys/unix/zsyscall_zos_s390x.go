...
// Code generated by the command above; see README.md. DO NOT EDIT.//go:build zos && s390x
...
_, e1 := syscall_rawsyscall(SYS_SETGROUPS, uintptr(n), uintptr(unsafe.Pointer(list)), 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
...
return
 ...
 _, e1 := syscall_syscall6(SYS_MMAP, uintptr(addr), uintptr(length), uintptr(prot), uintptr(flag), uintptr(fd), uintptr(pos))
ret = uintptr(r0)
if e1 != 0 {
err = errnoErr(e1)
}
...
_, e1 := syscall_syscall(SYS___ACCESS_A, uintptr(unsafe.Pointer(_p0)), uintptr(mode), 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
...
_p0, err = BytePtrFromString(path)
if err != nil {
return_, _, e1 := syscall_syscall(SYS___CHDIR_A, uintptr(unsafe.Pointer(_p0)), 0, 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
...
urn
 ...
 FcntlInt(fd uintptr, cmd int, arg int) (retval int, err error) {
r0, _, e1 := syscall_syscall(SYS_FCNTL, uintptr(fd), uintptr(cmd), uintptr(arg))
retval = int(r0)
if e1 != 0 {
r = errnoErr(e1)
...
return
 ...
 fstat(fd int, stat *Stat_LE_t) (err error) {
...
return
 ...
 Fstatvfs(fd int, stat *Statvfs_t) (err error) {
...
_p0 = unsafe.Pointer(&_zero)_, _, e1 := syscall_syscall(SYS_MPROTECT, uintptr(_p0), uintptr(len(b)), uintptr(prot))
if e1 != 0 {
err = errnoErr(e1)
}
return
}// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT
nc(b []byte, flags int) (err error) {
var _p0 unsafe.Pointer
if len(b) > 0 {
_p0 = unsafe.Pointer(&b[0])
} else {
...
return
 ...
 W_Getmntent(buff *byte, size int) (lastsys int, err error) {
r0, _, e1 := syscall_syscall(SYS_W_GETMNTENT, uintptr(unsafe.Pointer(buff)), uintptr(size), 0)
lastsys = int(r0)
if e1 != 0 {
err = errnoErr(e1)return
}// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT
 W_Getmntent_A(buff *byte, size int) (lastsys int, err error) {
...
return
 ...
 mount_LE(path string, filesystem string, fstype string, mtm uint32, parmlen int32, parm string) (err error) {
var _p0 *byte
_p0, err = BytePtrFromString(path)
if err != nil {
return
...
_, e1 := syscall_syscall6(SYS___MOUNT_A, uintptr(unsafe.Pointer(_p0)), uintptr(unsafe.Pointer(_p1)), uintptr(unsafe.Pointer(_p2)), uintptr(mtm), uintptr(parmlen), uintptr(unsafe.Pointer(_p3)))
if e1 != 0 {
err = errnoErr(e1)
}
return
}// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT
 unmount(filesystem string, mtm int) (err error) {
var _p0 *byte
_p0, err = BytePtrFromString(filesystem)
if err != nil {
return
}
_, e1 := syscall_syscall(SYS___UMOUNT_A, uintptr(unsafe.Pointer(_p0)), uintptr(mtm), 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
...
_, e1 := syscall_syscall(SYS___CHROOT_A, uintptr(unsafe.Pointer(_p0)), 0, 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
...
return
// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT
 Gethostname(buf []byte) (err error) {
var _p0 unsafe.Pointer
if len(buf) > 0 {
_p0 = unsafe.Pointer(&buf[0])
} else {
_p0 = unsafe.Pointer(&_zero)_, _, e1 := syscall_syscall(SYS___GETHOSTNAME_A, uintptr(_p0), uintptr(len(buf)), 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
...
return
 ...
 Getpid() (pid int) {
 _, _ := syscall_rawsyscall(SYS_GETPID, 0, 0, 0)
pid = int(r0)
return
}// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT
...
return
 ...
 getrusage(who int, rusage *rusage_zos) (err error) {
...
return
 ...
 _, e1 := syscall_rawsyscall(SYS_GETSID, uintptr(pid), 0, 0)
sid = int(r0)
if e1 != 0 {
err = errnoErr(e1)
}
...
return
 ...
 lstat(path string, stat *Stat_LE_t) (err error) {
var _p0 *byte
_p0, err = BytePtrFromString(path)
if err != nil {
return
...
ame(from string, to string) (err error) {
var _p0 *byte
...
if err != nil {
return_, _, e1 := syscall_syscall(SYS___RENAME_A, uintptr(unsafe.Pointer(_p0)), uintptr(unsafe.Pointer(_p1)), 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
...
_, e1 := syscall_rawsyscall(SYS_SETPGID, uintptr(pid), uintptr(pgid), 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
}// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT
 Setrlimit(resource int, lim *Rlimit) (err error) {
...
_, e1 := syscall_syscall(SYS_SETGID, uintptr(uid), 0, 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
...
return
 ...
 stat(path string, statLE *Stat_LE_t) (err error) {
var _p0 *byte
_p0, err = BytePtrFromString(path)
if err != nil {
return
...
_, e1 := syscall_syscall(SYS___SYMLINK_A, uintptr(unsafe.Pointer(_p0)), uintptr(unsafe.Pointer(_p1)), 0)
if e1 != 0 {
err = errnoErr(e1)
}
return
...
return
 ...
 Tcgetattr(fildes int, termptr *Termios) (err error) {
...
return
 ...
 Tcsetattr(fildes int, when int, termptr *Termios) (err error) {
...
return
 ...
 Utime(path string, utim *Utimbuf) (err error) {
var _p0 *byte
_p0, err = BytePtrFromString(path)
if err != nil {
return
...
return
 ...
 waitpid(pid int, wstatus *_C_int, options int) (wpid int, err error) {
...
return
 ...
 gettimeofday(tv *timeval_zos) (err error) {
...
return
 ...
 Select(nmsgsfds int, r *FdSet, w *FdSet, e *FdSet, timeout *Timeval) (ret int, err error) {
