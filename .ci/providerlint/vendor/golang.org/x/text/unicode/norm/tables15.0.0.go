// Code generated by running "go generate" in golang.org/x/text. DO NOT EDIT.//go:build go1.21
// +build go1.21package normimport "sync"const (
// Version is the Unicode edition from which the tables are derived.
Version = "15.0.0"// MaxTransformChunkSize indicates the maximum number of bytes that Transform
...
// hold enough bytes to complete the encoding. len(s) must be greater than 0.*nfcTrie) lookup(s []byte) (v uint16, sz int) {
c0 := s[0]
switch {
...
// s must start with a full and valid UTF-8 encoded rune.*nfcTrie) lookupUnsafe(s []byte) uint16 {
c0 := s[0]
if c0 < 0x80 { // is ASCII
return nfcValues[c0]
}
...
// the width in bytes of this encoding. The size will be 0 if s does not
// hold enough bytes to complete the encoding. len(s) must be greater than 0.*nfcTrie) lookupString(s string) (v uint16, sz int) {
c0 := s[0]
switch {
case c0 < 0x80: // is ASCII
return nfcValues[c0], 1
...
// s must start with a full and valid UTF-8 encoded rune.*nfcTrie) lookupStringUnsafe(s string) uint16 {
c0 := s[0]
if c0 < 0x80 { // is ASCII
return nfcValues[c0]
}
...
return &nfcTrie{}
}// lookupValue determines the type of block n and looks up the value for b.*nfcTrie) lookupValue(n uint32, b byte) uint16 {
switch {
case n < 46:
...
// the width in bytes of this encoding. The size will be 0 if s does not
// hold enough bytes to complete the encoding. len(s) must be greater than 0.*nfkcTrie) lookup(s []byte) (v uint16, sz int) {
c0 := s[0]
switch {
case c0 < 0x80: // is ASCII
