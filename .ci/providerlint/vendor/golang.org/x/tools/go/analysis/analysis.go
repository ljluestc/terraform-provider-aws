...
type Pass struct {
	...
	IgnoredFiles []string       // s of ignored source files in this package
...
// represent the subject of the predicate such as "
tion F" or "package P".
//
...
// An analysis's Run 
tion may retrieve facts by calling
