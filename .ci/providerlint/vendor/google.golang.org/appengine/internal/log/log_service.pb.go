...
// source: google.golang.org/appengine/internal/log/log_service.protopackage logimport proto "github.com/golang/protobuf/proto"
import fmt "fmt"
...
const _ = proto.ProtoPackageIsVersion2 // please upgrade the proto packagetype LogServiceError_ErrorCode int32const (
...
var LogServiceError_ErrorCode_value = map[string]int32{
 ...
 (x LogServiceError_ErrorCode) Enum() *LogServiceError_ErrorCode {
	p := new(LogServiceError_ErrorCode)
	*p = x
	return p
} (x LogServiceError_ErrorCode) String() string {
	return proto.EnumName(LogServiceError_ErrorCode_name, int32(x))
} (x *LogServiceError_ErrorCode) UnmarshalJSON(data []byte) error {
	...
	*x = LogServiceError_ErrorCode(value)
	return nil
} (LogServiceError_ErrorCode) EnumDescriptor() ([]byte, []int) {
 ...
 (m *LogServiceError) Reset()         { *m = LogServiceError{} } (m *LogServiceError) String() string { return proto.CompactTextString(m) } (*LogServiceError) ProtoMessage()    {} (*LogServiceError) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{0}
} (m *LogServiceError) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LogServiceError.Unmarshal(m, b)
} (m *LogServiceError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LogServiceError.Marshal(b, m, deterministic)
} (dst *LogServiceError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LogServiceError.Merge(dst, src)
} (m *LogServiceError) XXX_Size() int {
	return xxx_messageInfo_LogServiceError.Size(m)
} (m *LogServiceError) XXX_DiscardUnknown() {
	xxx_messageInfo_LogServiceError.DiscardUnknown(m)
}var xxx_messageInfo_LogServiceError proto.InternalMessageInfotype UserAppLogLine struct {
 ...
 (m *UserAppLogLine) Reset()         { *m = UserAppLogLine{} } (m *UserAppLogLine) String() string { return proto.CompactTextString(m) } (*UserAppLogLine) ProtoMessage()    {} (*UserAppLogLine) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{1}
} (m *UserAppLogLine) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UserAppLogLine.Unmarshal(m, b)
} (m *UserAppLogLine) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UserAppLogLine.Marshal(b, m, deterministic)
} (dst *UserAppLogLine) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UserAppLogLine.Merge(dst, src)
} (m *UserAppLogLine) XXX_Size() int {
 ...
 (m *UserAppLogLine) GetTimestampUsec() int64 {
	if m != nil && m.TimestampUsec != nil {
		return *m.TimestampUsec
	}
	return 0
}
 (m *UserAppLogLine) GetLevel() int64 {
	if m != nil && m.Level != nil {
		return *m.Level
	}
	return 0
}
 (m *UserAppLogLine) GetMessage() string {
 ...
 (m *UserAppLogGroup) Reset()         { *m = UserAppLogGroup{} } (m *UserAppLogGroup) String() string { return proto.CompactTextString(m) } (*UserAppLogGroup) ProtoMessage()    {} (*UserAppLogGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{2}
} (m *UserAppLogGroup) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UserAppLogGroup.Unmarshal(m, b)
} (m *UserAppLogGroup) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UserAppLogGroup.Marshal(b, m, deterministic)
} (dst *UserAppLogGroup) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UserAppLogGroup.Merge(dst, src)
} (m *UserAppLogGroup) XXX_Size() int {
	return xxx_messageInfo_UserAppLogGroup.Size(m)
} (m *UserAppLogGroup) XXX_DiscardUnknown() {
	xxx_messageInfo_UserAppLogGroup.DiscardUnknown(m)
}var xxx_messageInfo_UserAppLogGroup proto.InternalMessageInfo
 (m *UserAppLogGroup) GetLogLine() []*UserAppLogLine {
	if m != nil {
		return m.LogLine
	}
	return nil
 ...
 (m *FlushRequest) Reset()         { *m = FlushRequest{} } (m *FlushRequest) String() string { return proto.CompactTextString(m) } (*FlushRequest) ProtoMessage()    {} (*FlushRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{3}
} (m *FlushRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FlushRequest.Unmarshal(m, b)
} (m *FlushRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FlushRequest.Marshal(b, m, deterministic)
} (dst *FlushRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FlushRequest.Merge(dst, src)
} (m *FlushRequest) XXX_Size() int {
	return xxx_messageInfo_FlushRequest.Size(m)
} (m *FlushRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_FlushRequest.DiscardUnknown(m)
}var xxx_messageInfo_FlushRequest proto.InternalMessageInfo
 (m *FlushRequest) GetLogs() []byte {
	if m != nil {
		return m.Logs
	}
	return nil
 ...
 (m *SetStatusRequest) Reset()         { *m = SetStatusRequest{} } (m *SetStatusRequest) String() string { return proto.CompactTextString(m) } (*SetStatusRequest) ProtoMessage()    {} (*SetStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{4}
} (m *SetStatusRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SetStatusRequest.Unmarshal(m, b)
} (m *SetStatusRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SetStatusRequest.Marshal(b, m, deterministic)
} (dst *SetStatusRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetStatusRequest.Merge(dst, src)
} (m *SetStatusRequest) XXX_Size() int {
	return xxx_messageInfo_SetStatusRequest.Size(m)
} (m *SetStatusRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SetStatusRequest.DiscardUnknown(m)
}var xxx_messageInfo_SetStatusRequest proto.InternalMessageInfo
 (m *SetStatusRequest) GetStatus() string {
 ...
 (m *LogOffset) Reset()         { *m = LogOffset{} } (m *LogOffset) String() string { return proto.CompactTextString(m) } (*LogOffset) ProtoMessage()    {} (*LogOffset) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{5}
} (m *LogOffset) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LogOffset.Unmarshal(m, b)
} (m *LogOffset) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LogOffset.Marshal(b, m, deterministic)
} (dst *LogOffset) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LogOffset.Merge(dst, src)
} (m *LogOffset) XXX_Size() int {
	return xxx_messageInfo_LogOffset.Size(m)
} (m *LogOffset) XXX_DiscardUnknown() {
	xxx_messageInfo_LogOffset.DiscardUnknown(m)
}var xxx_messageInfo_LogOffset proto.InternalMessageInfo
 (m *LogOffset) GetRequestId() []byte {
	if m != nil {
		return m.RequestId
	}
	return nil
 ...
 (m *LogLine) Reset()         { *m = LogLine{} } (m *LogLine) String() string { return proto.CompactTextString(m) } (*LogLine) ProtoMessage()    {} (*LogLine) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{6}
} (m *LogLine) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LogLine.Unmarshal(m, b)
} (m *LogLine) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LogLine.Marshal(b, m, deterministic)
} (dst *LogLine) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LogLine.Merge(dst, src)
} (m *LogLine) XXX_Size() int {
	return xxx_messageInfo_LogLine.Size(m)
} (m *LogLine) XXX_DiscardUnknown() {
	xxx_messageInfo_LogLine.DiscardUnknown(m)
}var xxx_messageInfo_LogLine proto.InternalMessageInfo
 (m *LogLine) GetTime() int64 {
	if m != nil && m.Time != nil {
		return *m.Time
	}
	return 0
}
 (m *LogLine) GetLevel() int32 {
	if m != nil && m.Level != nil {
		return *m.Level
	}
	return 0
}
 (m *LogLine) GetLogMessage() string {
 ...
 (m *RequestLog) Reset()         { *m = RequestLog{} } (m *RequestLog) String() string { return proto.CompactTextString(m) } (*RequestLog) ProtoMessage()    {} (*RequestLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{7}
} (m *RequestLog) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RequestLog.Unmarshal(m, b)
} (m *RequestLog) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RequestLog.Marshal(b, m, deterministic)
} (dst *RequestLog) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestLog.Merge(dst, src)
} (m *RequestLog) XXX_Size() int {
	return xxx_messageInfo_RequestLog.Size(m)
} (m *RequestLog) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestLog.DiscardUnknown(m)
}var xxx_messageInfo_RequestLog proto.InternalMessageInfoconst Default_RequestLog_ModuleId string = "default"
const Default_RequestLog_ReplicaIndex int32 = -1
const Default_RequestLog_Finished bool = true
 (m *RequestLog) GetAppId() string {
	if m != nil && m.AppId != nil {
		return *m.AppId
	}
	return ""
}
 (m *RequestLog) GetModuleId() string {
	if m != nil && m.ModuleId != nil {
		return *m.ModuleId
	}
	return Default_RequestLog_ModuleId
}
 (m *RequestLog) GetVersionId() string {
	if m != nil && m.VersionId != nil {
		return *m.VersionId
	}
	return ""
}
 (m *RequestLog) GetRequestId() []byte {
	if m != nil {
		return m.RequestId
	}
	return nil
}
 (m *RequestLog) GetOffset() *LogOffset {
	if m != nil {
		return m.Offset
	}
	return nil
}
 (m *RequestLog) GetIp() string {
	if m != nil && m.Ip != nil {
		return *m.Ip
	}
	return ""
}
 (m *RequestLog) GetNickname() string {
	if m != nil && m.Nickname != nil {
		return *m.Nickname
	}
	return ""
}
 (m *RequestLog) GetStartTime() int64 {
	if m != nil && m.StartTime != nil {
		return *m.StartTime
	}
	return 0
}
 (m *RequestLog) GetEndTime() int64 {
	if m != nil && m.EndTime != nil {
		return *m.EndTime
	}
	return 0
}
 (m *RequestLog) GetLatency() int64 {
	if m != nil && m.Latency != nil {
		return *m.Latency
	}
	return 0
}
 (m *RequestLog) GetMcycles() int64 {
	if m != nil && m.Mcycles != nil {
		return *m.Mcycles
	}
	return 0
}
 (m *RequestLog) GetMethod() string {
	if m != nil && m.Method != nil {
		return *m.Method
	}
	return ""
}
 (m *RequestLog) GetResource() string {
	if m != nil && m.Resource != nil {
		return *m.Resource
	}
	return ""
}
 (m *RequestLog) GetHttpVersion() string {
	if m != nil && m.HttpVersion != nil {
		return *m.HttpVersion
	}
	return ""
}
 (m *RequestLog) GetStatus() int32 {
	if m != nil && m.Status != nil {
		return *m.Status
	}
	return 0
}
 (m *RequestLog) GetResponseSize() int64 {
	if m != nil && m.ResponseSize != nil {
		return *m.ResponseSize
	}
	return 0
}
 (m *RequestLog) GetReferrer() string {
	if m != nil && m.Referrer != nil {
		return *m.Referrer
	}
	return ""
}
 (m *RequestLog) GetUserAgent() string {
	if m != nil && m.UserAgent != nil {
		return *m.UserAgent
	}
	return ""
}
 (m *RequestLog) GetUrlMapEntry() string {
	if m != nil && m.UrlMapEntry != nil {
		return *m.UrlMapEntry
	}
	return ""
}
 (m *RequestLog) GetCombined() string {
	if m != nil && m.Combined != nil {
		return *m.Combined
	}
	return ""
}
 (m *RequestLog) GetApiMcycles() int64 {
	if m != nil && m.ApiMcycles != nil {
		return *m.ApiMcycles
	}
	return 0
}
 (m *RequestLog) GetHost() string {
	if m != nil && m.Host != nil {
		return *m.Host
	}
	return ""
}
 (m *RequestLog) GetCost() float64 {
	if m != nil && m.Cost != nil {
		return *m.Cost
	}
	return 0
}
 (m *RequestLog) GetTaskQueueName() string {
	if m != nil && m.TaskQueueName != nil {
		return *m.TaskQueueName
	}
	return ""
}
 (m *RequestLog) GetTaskName() string {
	if m != nil && m.TaskName != nil {
		return *m.TaskName
	}
	return ""
}
 (m *RequestLog) GetWasLoadingRequest() bool {
	if m != nil && m.WasLoadingRequest != nil {
		return *m.WasLoadingRequest
	}
	return false
}
 (m *RequestLog) GetPendingTime() int64 {
	if m != nil && m.PendingTime != nil {
		return *m.PendingTime
	}
	return 0
}
 (m *RequestLog) GetReplicaIndex() int32 {
	if m != nil && m.ReplicaIndex != nil {
		return *m.ReplicaIndex
	}
	return Default_RequestLog_ReplicaIndex
}
 (m *RequestLog) GetFinished() bool {
	if m != nil && m.Finished != nil {
		return *m.Finished
	}
	return Default_RequestLog_Finished
}
 (m *RequestLog) GetCloneKey() []byte {
	if m != nil {
		return m.CloneKey
	}
	return nil
}
 (m *RequestLog) GetLine() []*LogLine {
	if m != nil {
		return m.Line
	}
	return nil
}
 (m *RequestLog) GetLinesIncomplete() bool {
	if m != nil && m.LinesIncomplete != nil {
		return *m.LinesIncomplete
	}
	return false
}
 (m *RequestLog) GetAppEngineRelease() []byte {
	if m != nil {
		return m.AppEngineRelease
	}
	return nil
}
 (m *RequestLog) GetExitReason() int32 {
	if m != nil && m.ExitReason != nil {
		return *m.ExitReason
	}
	return 0
}
 (m *RequestLog) GetWasThrottledForTime() bool {
	if m != nil && m.WasThrottledForTime != nil {
		return *m.WasThrottledForTime
	}
	return false
}
 (m *RequestLog) GetWasThrottledForRequests() bool {
 ...
 (m *RequestLog) GetServerName() []byte {
	if m != nil {
		return m.ServerName
	}
	return nil
 ...
 (m *LogModuleVersion) Reset()         { *m = LogModuleVersion{} } (m *LogModuleVersion) String() string { return proto.CompactTextString(m) } (*LogModuleVersion) ProtoMessage()    {} (*LogModuleVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{8}
} (m *LogModuleVersion) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LogModuleVersion.Unmarshal(m, b)
} (m *LogModuleVersion) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LogModuleVersion.Marshal(b, m, deterministic)
} (dst *LogModuleVersion) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LogModuleVersion.Merge(dst, src)
} (m *LogModuleVersion) XXX_Size() int {
	return xxx_messageInfo_LogModuleVersion.Size(m)
} (m *LogModuleVersion) XXX_DiscardUnknown() {
	xxx_messageInfo_LogModuleVersion.DiscardUnknown(m)
}var xxx_messageInfo_LogModuleVersion proto.InternalMessageInfoconst Default_LogModuleVersion_ModuleId string = "default"
 (m *LogModuleVersion) GetModuleId() string {
	if m != nil && m.ModuleId != nil {
		return *m.ModuleId
	}
	return Default_LogModuleVersion_ModuleId
}
 (m *LogModuleVersion) GetVersionId() string {
	if m != nil && m.VersionId != nil {
		return *m.VersionId
	}
	return ""
 ...
 (m *LogReadRequest) Reset()         { *m = LogReadRequest{} } (m *LogReadRequest) String() string { return proto.CompactTextString(m) } (*LogReadRequest) ProtoMessage()    {} (*LogReadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{9}
} (m *LogReadRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LogReadRequest.Unmarshal(m, b)
} (m *LogReadRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LogReadRequest.Marshal(b, m, deterministic)
} (dst *LogReadRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LogReadRequest.Merge(dst, src)
} (m *LogReadRequest) XXX_Size() int {
	return xxx_messageInfo_LogReadRequest.Size(m)
} (m *LogReadRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_LogReadRequest.DiscardUnknown(m)
}var xxx_messageInfo_LogReadRequest proto.InternalMessageInfo
 (m *LogReadRequest) GetAppId() string {
	if m != nil && m.AppId != nil {
		return *m.AppId
	}
	return ""
}
 (m *LogReadRequest) GetVersionId() []string {
	if m != nil {
		return m.VersionId
	}
	return nil
}
 (m *LogReadRequest) GetModuleVersion() []*LogModuleVersion {
	if m != nil {
		return m.ModuleVersion
	}
	return nil
}
 (m *LogReadRequest) GetStartTime() int64 {
	if m != nil && m.StartTime != nil {
		return *m.StartTime
	}
	return 0
}
 (m *LogReadRequest) GetEndTime() int64 {
	if m != nil && m.EndTime != nil {
		return *m.EndTime
	}
	return 0
}
 (m *LogReadRequest) GetOffset() *LogOffset {
	if m != nil {
		return m.Offset
	}
	return nil
}
 (m *LogReadRequest) GetRequestId() [][]byte {
	if m != nil {
		return m.RequestId
	}
	return nil
}
 (m *LogReadRequest) GetMinimumLogLevel() int32 {
	if m != nil && m.MinimumLogLevel != nil {
		return *m.MinimumLogLevel
	}
	return 0
}
 (m *LogReadRequest) GetIncludeIncomplete() bool {
	if m != nil && m.IncludeIncomplete != nil {
		return *m.IncludeIncomplete
	}
	return false
}
 (m *LogReadRequest) GetCount() int64 {
	if m != nil && m.Count != nil {
		return *m.Count
	}
	return 0
}
 (m *LogReadRequest) GetCombinedLogRegex() string {
	if m != nil && m.CombinedLogRegex != nil {
		return *m.CombinedLogRegex
	}
	return ""
}
 (m *LogReadRequest) GetHostRegex() string {
	if m != nil && m.HostRegex != nil {
		return *m.HostRegex
	}
	return ""
}
 (m *LogReadRequest) GetReplicaIndex() int32 {
	if m != nil && m.ReplicaIndex != nil {
		return *m.ReplicaIndex
	}
	return 0
}
 (m *LogReadRequest) GetIncludeAppLogs() bool {
	if m != nil && m.IncludeAppLogs != nil {
		return *m.IncludeAppLogs
	}
	return false
}
 (m *LogReadRequest) GetAppLogsPerRequest() int32 {
	if m != nil && m.AppLogsPerRequest != nil {
		return *m.AppLogsPerRequest
	}
	return 0
}
 (m *LogReadRequest) GetIncludeHost() bool {
	if m != nil && m.IncludeHost != nil {
		return *m.IncludeHost
	}
	return false
}
 (m *LogReadRequest) GetIncludeAll() bool {
	if m != nil && m.IncludeAll != nil {
		return *m.IncludeAll
	}
	return false
}
 (m *LogReadRequest) GetCacheIterator() bool {
	if m != nil && m.CacheIterator != nil {
		return *m.CacheIterator
	}
	return false
}
 (m *LogReadRequest) GetNumShards() int32 {
 ...
 (m *LogReadResponse) Reset()         { *m = LogReadResponse{} } (m *LogReadResponse) String() string { return proto.CompactTextString(m) } (*LogReadResponse) ProtoMessage()    {} (*LogReadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{10}
} (m *LogReadResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LogReadResponse.Unmarshal(m, b)
} (m *LogReadResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LogReadResponse.Marshal(b, m, deterministic)
} (dst *LogReadResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LogReadResponse.Merge(dst, src)
} (m *LogReadResponse) XXX_Size() int {
	return xxx_messageInfo_LogReadResponse.Size(m)
} (m *LogReadResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_LogReadResponse.DiscardUnknown(m)
}var xxx_messageInfo_LogReadResponse proto.InternalMessageInfo
 (m *LogReadResponse) GetLog() []*RequestLog {
	if m != nil {
		return m.Log
	}
	return nil
}
 (m *LogReadResponse) GetOffset() *LogOffset {
	if m != nil {
		return m.Offset
	}
	return nil
}
 (m *LogReadResponse) GetLastEndTime() int64 {
 ...
 (m *LogUsageRecord) Reset()         { *m = LogUsageRecord{} } (m *LogUsageRecord) String() string { return proto.CompactTextString(m) } (*LogUsageRecord) ProtoMessage()    {} (*LogUsageRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{11}
} (m *LogUsageRecord) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LogUsageRecord.Unmarshal(m, b)
} (m *LogUsageRecord) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LogUsageRecord.Marshal(b, m, deterministic)
} (dst *LogUsageRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LogUsageRecord.Merge(dst, src)
} (m *LogUsageRecord) XXX_Size() int {
	return xxx_messageInfo_LogUsageRecord.Size(m)
} (m *LogUsageRecord) XXX_DiscardUnknown() {
	xxx_messageInfo_LogUsageRecord.DiscardUnknown(m)
}var xxx_messageInfo_LogUsageRecord proto.InternalMessageInfo
 (m *LogUsageRecord) GetVersionId() string {
	if m != nil && m.VersionId != nil {
		return *m.VersionId
	}
	return ""
}
 (m *LogUsageRecord) GetStartTime() int32 {
	if m != nil && m.StartTime != nil {
		return *m.StartTime
	}
	return 0
}
 (m *LogUsageRecord) GetEndTime() int32 {
	if m != nil && m.EndTime != nil {
		return *m.EndTime
	}
	return 0
}
 (m *LogUsageRecord) GetCount() int64 {
	if m != nil && m.Count != nil {
		return *m.Count
	}
	return 0
}
 (m *LogUsageRecord) GetTotalSize() int64 {
	if m != nil && m.TotalSize != nil {
		return *m.TotalSize
	}
	return 0
}
 (m *LogUsageRecord) GetRecords() int32 {
 ...
 (m *LogUsageRequest) Reset()         { *m = LogUsageRequest{} } (m *LogUsageRequest) String() string { return proto.CompactTextString(m) } (*LogUsageRequest) ProtoMessage()    {} (*LogUsageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{12}
} (m *LogUsageRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LogUsageRequest.Unmarshal(m, b)
} (m *LogUsageRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LogUsageRequest.Marshal(b, m, deterministic)
} (dst *LogUsageRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LogUsageRequest.Merge(dst, src)
} (m *LogUsageRequest) XXX_Size() int {
	return xxx_messageInfo_LogUsageRequest.Size(m)
} (m *LogUsageRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_LogUsageRequest.DiscardUnknown(m)
}var xxx_messageInfo_LogUsageRequest proto.InternalMessageInfoconst Default_LogUsageRequest_ResolutionHours uint32 = 1
 (m *LogUsageRequest) GetAppId() string {
	if m != nil && m.AppId != nil {
		return *m.AppId
	}
	return ""
}
 (m *LogUsageRequest) GetVersionId() []string {
	if m != nil {
		return m.VersionId
	}
	return nil
}
 (m *LogUsageRequest) GetStartTime() int32 {
	if m != nil && m.StartTime != nil {
		return *m.StartTime
	}
	return 0
}
 (m *LogUsageRequest) GetEndTime() int32 {
	if m != nil && m.EndTime != nil {
		return *m.EndTime
	}
	return 0
}
 (m *LogUsageRequest) GetResolutionHours() uint32 {
	if m != nil && m.ResolutionHours != nil {
		return *m.ResolutionHours
	}
	return Default_LogUsageRequest_ResolutionHours
}
 (m *LogUsageRequest) GetCombineVersions() bool {
	if m != nil && m.CombineVersions != nil {
		return *m.CombineVersions
	}
	return false
}
 (m *LogUsageRequest) GetUsageVersion() int32 {
	if m != nil && m.UsageVersion != nil {
		return *m.UsageVersion
	}
	return 0
}
 (m *LogUsageRequest) GetVersionsOnly() bool {
 ...
 (m *LogUsageResponse) Reset()         { *m = LogUsageResponse{} } (m *LogUsageResponse) String() string { return proto.CompactTextString(m) } (*LogUsageResponse) ProtoMessage()    {} (*LogUsageResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_service_f054fd4b5012319d, []int{13}
} (m *LogUsageResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LogUsageResponse.Unmarshal(m, b)
} (m *LogUsageResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LogUsageResponse.Marshal(b, m, deterministic)
} (dst *LogUsageResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LogUsageResponse.Merge(dst, src)
} (m *LogUsageResponse) XXX_Size() int {
	return xxx_messageInfo_LogUsageResponse.Size(m)
} (m *LogUsageResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_LogUsageResponse.DiscardUnknown(m)
}var xxx_messageInfo_LogUsageResponse proto.InternalMessageInfo
 (m *LogUsageResponse) GetUsage() []*LogUsageRecord {
	if m != nil {
		return m.Usage
	}
	return nil
}
 (m *LogUsageResponse) GetSummary() *LogUsageRecord {
	if m != nil {
		return m.Summary
	}
	return nil
