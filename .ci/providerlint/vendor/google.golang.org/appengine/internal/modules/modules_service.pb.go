...
// source: google.golang.org/appengine/internal/modules/modules_service.protopackage modulesimport proto "github.com/golang/protobuf/proto"
import fmt "fmt"
...
const _ = proto.ProtoPackageIsVersion2 // please upgrade the proto packagetype ModulesServiceError_ErrorCode int32const (
...
var ModulesServiceError_ErrorCode_value = map[string]int32{
 ...
 (x ModulesServiceError_ErrorCode) Enum() *ModulesServiceError_ErrorCode {
	p := new(ModulesServiceError_ErrorCode)
	*p = x
	return p
} (x ModulesServiceError_ErrorCode) String() string {
	return proto.EnumName(ModulesServiceError_ErrorCode_name, int32(x))
} (x *ModulesServiceError_ErrorCode) UnmarshalJSON(data []byte) error {
	...
	*x = ModulesServiceError_ErrorCode(value)
	return nil
} (ModulesServiceError_ErrorCode) EnumDescriptor() ([]byte, []int) {
 ...
 (m *ModulesServiceError) Reset()         { *m = ModulesServiceError{} } (m *ModulesServiceError) String() string { return proto.CompactTextString(m) } (*ModulesServiceError) ProtoMessage()    {} (*ModulesServiceError) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{0}
} (m *ModulesServiceError) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ModulesServiceError.Unmarshal(m, b)
} (m *ModulesServiceError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ModulesServiceError.Marshal(b, m, deterministic)
} (dst *ModulesServiceError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ModulesServiceError.Merge(dst, src)
} (m *ModulesServiceError) XXX_Size() int {
	return xxx_messageInfo_ModulesServiceError.Size(m)
} (m *ModulesServiceError) XXX_DiscardUnknown() {
	xxx_messageInfo_ModulesServiceError.DiscardUnknown(m)
}var xxx_messageInfo_ModulesServiceError proto.InternalMessageInfotype GetModulesRequest struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
 (m *GetModulesRequest) Reset()         { *m = GetModulesRequest{} } (m *GetModulesRequest) String() string { return proto.CompactTextString(m) } (*GetModulesRequest) ProtoMessage()    {} (*GetModulesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{1}
} (m *GetModulesRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetModulesRequest.Unmarshal(m, b)
} (m *GetModulesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetModulesRequest.Marshal(b, m, deterministic)
} (dst *GetModulesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetModulesRequest.Merge(dst, src)
} (m *GetModulesRequest) XXX_Size() int {
	return xxx_messageInfo_GetModulesRequest.Size(m)
} (m *GetModulesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetModulesRequest.DiscardUnknown(m)
}var xxx_messageInfo_GetModulesRequest proto.InternalMessageInfotype GetModulesResponse struct {
	Module               []string `protobuf:"bytes,1,rep,name=module" json:"module,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
 (m *GetModulesResponse) Reset()         { *m = GetModulesResponse{} } (m *GetModulesResponse) String() string { return proto.CompactTextString(m) } (*GetModulesResponse) ProtoMessage()    {} (*GetModulesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{2}
} (m *GetModulesResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetModulesResponse.Unmarshal(m, b)
} (m *GetModulesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetModulesResponse.Marshal(b, m, deterministic)
} (dst *GetModulesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetModulesResponse.Merge(dst, src)
} (m *GetModulesResponse) XXX_Size() int {
	return xxx_messageInfo_GetModulesResponse.Size(m)
} (m *GetModulesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetModulesResponse.DiscardUnknown(m)
}var xxx_messageInfo_GetModulesResponse proto.InternalMessageInfo
 (m *GetModulesResponse) GetModule() []string {
	if m != nil {
		return m.Module
	}
	return nil
 ...
 (m *GetVersionsRequest) Reset()         { *m = GetVersionsRequest{} } (m *GetVersionsRequest) String() string { return proto.CompactTextString(m) } (*GetVersionsRequest) ProtoMessage()    {} (*GetVersionsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{3}
} (m *GetVersionsRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetVersionsRequest.Unmarshal(m, b)
} (m *GetVersionsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetVersionsRequest.Marshal(b, m, deterministic)
} (dst *GetVersionsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetVersionsRequest.Merge(dst, src)
} (m *GetVersionsRequest) XXX_Size() int {
	return xxx_messageInfo_GetVersionsRequest.Size(m)
} (m *GetVersionsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetVersionsRequest.DiscardUnknown(m)
}var xxx_messageInfo_GetVersionsRequest proto.InternalMessageInfo
 (m *GetVersionsRequest) GetModule() string {
 ...
 (m *GetVersionsResponse) Reset()         { *m = GetVersionsResponse{} } (m *GetVersionsResponse) String() string { return proto.CompactTextString(m) } (*GetVersionsResponse) ProtoMessage()    {} (*GetVersionsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{4}
} (m *GetVersionsResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetVersionsResponse.Unmarshal(m, b)
} (m *GetVersionsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetVersionsResponse.Marshal(b, m, deterministic)
} (dst *GetVersionsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetVersionsResponse.Merge(dst, src)
} (m *GetVersionsResponse) XXX_Size() int {
	return xxx_messageInfo_GetVersionsResponse.Size(m)
} (m *GetVersionsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetVersionsResponse.DiscardUnknown(m)
}var xxx_messageInfo_GetVersionsResponse proto.InternalMessageInfo
 (m *GetVersionsResponse) GetVersion() []string {
	if m != nil {
		return m.Version
	}
	return nil
 ...
 (m *GetDefaultVersionRequest) Reset()         { *m = GetDefaultVersionRequest{} } (m *GetDefaultVersionRequest) String() string { return proto.CompactTextString(m) } (*GetDefaultVersionRequest) ProtoMessage()    {} (*GetDefaultVersionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{5}
} (m *GetDefaultVersionRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetDefaultVersionRequest.Unmarshal(m, b)
} (m *GetDefaultVersionRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetDefaultVersionRequest.Marshal(b, m, deterministic)
} (dst *GetDefaultVersionRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetDefaultVersionRequest.Merge(dst, src)
} (m *GetDefaultVersionRequest) XXX_Size() int {
	return xxx_messageInfo_GetDefaultVersionRequest.Size(m)
} (m *GetDefaultVersionRequest) XXX_DiscardUnknown() {
 ...
 (m *GetDefaultVersionRequest) GetModule() string {
	if m != nil && m.Module != nil {
		return *m.Module
	}
	return ""
 ...
 (m *GetDefaultVersionResponse) Reset()         { *m = GetDefaultVersionResponse{} } (m *GetDefaultVersionResponse) String() string { return proto.CompactTextString(m) } (*GetDefaultVersionResponse) ProtoMessage()    {} (*GetDefaultVersionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{6}
} (m *GetDefaultVersionResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetDefaultVersionResponse.Unmarshal(m, b)
} (m *GetDefaultVersionResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetDefaultVersionResponse.Marshal(b, m, deterministic)
} (dst *GetDefaultVersionResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetDefaultVersionResponse.Merge(dst, src)
} (m *GetDefaultVersionResponse) XXX_Size() int {
	return xxx_messageInfo_GetDefaultVersionResponse.Size(m)
} (m *GetDefaultVersionResponse) XXX_DiscardUnknown() {
 ...
 (m *GetDefaultVersionResponse) GetVersion() string {
 ...
 (m *GetNumInstancesRequest) Reset()         { *m = GetNumInstancesRequest{} } (m *GetNumInstancesRequest) String() string { return proto.CompactTextString(m) } (*GetNumInstancesRequest) ProtoMessage()    {} (*GetNumInstancesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{7}
} (m *GetNumInstancesRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetNumInstancesRequest.Unmarshal(m, b)
} (m *GetNumInstancesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetNumInstancesRequest.Marshal(b, m, deterministic)
} (dst *GetNumInstancesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetNumInstancesRequest.Merge(dst, src)
} (m *GetNumInstancesRequest) XXX_Size() int {
	return xxx_messageInfo_GetNumInstancesRequest.Size(m)
} (m *GetNumInstancesRequest) XXX_DiscardUnknown() {
 ...
 (m *GetNumInstancesRequest) GetModule() string {
	if m != nil && m.Module != nil {
		return *m.Module
	}
	return ""
}
 (m *GetNumInstancesRequest) GetVersion() string {
	if m != nil && m.Version != nil {
		return *m.Version
	}
	return ""
 ...
 (m *GetNumInstancesResponse) Reset()         { *m = GetNumInstancesResponse{} } (m *GetNumInstancesResponse) String() string { return proto.CompactTextString(m) } (*GetNumInstancesResponse) ProtoMessage()    {} (*GetNumInstancesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{8}
} (m *GetNumInstancesResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetNumInstancesResponse.Unmarshal(m, b)
} (m *GetNumInstancesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetNumInstancesResponse.Marshal(b, m, deterministic)
} (dst *GetNumInstancesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetNumInstancesResponse.Merge(dst, src)
} (m *GetNumInstancesResponse) XXX_Size() int {
	return xxx_messageInfo_GetNumInstancesResponse.Size(m)
} (m *GetNumInstancesResponse) XXX_DiscardUnknown() {
 ...
 (m *GetNumInstancesResponse) GetInstances() int64 {
 ...
 (m *SetNumInstancesRequest) Reset()         { *m = SetNumInstancesRequest{} } (m *SetNumInstancesRequest) String() string { return proto.CompactTextString(m) } (*SetNumInstancesRequest) ProtoMessage()    {} (*SetNumInstancesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{9}
} (m *SetNumInstancesRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SetNumInstancesRequest.Unmarshal(m, b)
} (m *SetNumInstancesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SetNumInstancesRequest.Marshal(b, m, deterministic)
} (dst *SetNumInstancesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetNumInstancesRequest.Merge(dst, src)
} (m *SetNumInstancesRequest) XXX_Size() int {
	return xxx_messageInfo_SetNumInstancesRequest.Size(m)
} (m *SetNumInstancesRequest) XXX_DiscardUnknown() {
 ...
 (m *SetNumInstancesRequest) GetModule() string {
	if m != nil && m.Module != nil {
		return *m.Module
	}
	return ""
}
 (m *SetNumInstancesRequest) GetVersion() string {
	if m != nil && m.Version != nil {
		return *m.Version
	}
	return ""
}
 (m *SetNumInstancesRequest) GetInstances() int64 {
	if m != nil && m.Instances != nil {
		return *m.Instances
	}
	return 0
 ...
 (m *SetNumInstancesResponse) Reset()         { *m = SetNumInstancesResponse{} } (m *SetNumInstancesResponse) String() string { return proto.CompactTextString(m) } (*SetNumInstancesResponse) ProtoMessage()    {} (*SetNumInstancesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{10}
} (m *SetNumInstancesResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SetNumInstancesResponse.Unmarshal(m, b)
} (m *SetNumInstancesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SetNumInstancesResponse.Marshal(b, m, deterministic)
} (dst *SetNumInstancesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetNumInstancesResponse.Merge(dst, src)
} (m *SetNumInstancesResponse) XXX_Size() int {
	return xxx_messageInfo_SetNumInstancesResponse.Size(m)
} (m *SetNumInstancesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_SetNumInstancesResponse.DiscardUnknown(m)
}var xxx_messageInfo_SetNumInstancesResponse proto.InternalMessageInfotype StartModuleRequest struct {
 ...
 (m *StartModuleRequest) Reset()         { *m = StartModuleRequest{} } (m *StartModuleRequest) String() string { return proto.CompactTextString(m) } (*StartModuleRequest) ProtoMessage()    {} (*StartModuleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{11}
} (m *StartModuleRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_StartModuleRequest.Unmarshal(m, b)
} (m *StartModuleRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_StartModuleRequest.Marshal(b, m, deterministic)
} (dst *StartModuleRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StartModuleRequest.Merge(dst, src)
} (m *StartModuleRequest) XXX_Size() int {
	return xxx_messageInfo_StartModuleRequest.Size(m)
} (m *StartModuleRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_StartModuleRequest.DiscardUnknown(m)
}var xxx_messageInfo_StartModuleRequest proto.InternalMessageInfo
 (m *StartModuleRequest) GetModule() string {
	if m != nil && m.Module != nil {
		return *m.Module
	}
	return ""
}
 (m *StartModuleRequest) GetVersion() string {
	if m != nil && m.Version != nil {
		return *m.Version
	}
	return ""
 ...
 (m *StartModuleResponse) Reset()         { *m = StartModuleResponse{} } (m *StartModuleResponse) String() string { return proto.CompactTextString(m) } (*StartModuleResponse) ProtoMessage()    {} (*StartModuleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{12}
} (m *StartModuleResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_StartModuleResponse.Unmarshal(m, b)
} (m *StartModuleResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_StartModuleResponse.Marshal(b, m, deterministic)
} (dst *StartModuleResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StartModuleResponse.Merge(dst, src)
} (m *StartModuleResponse) XXX_Size() int {
	return xxx_messageInfo_StartModuleResponse.Size(m)
} (m *StartModuleResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_StartModuleResponse.DiscardUnknown(m)
}var xxx_messageInfo_StartModuleResponse proto.InternalMessageInfotype StopModuleRequest struct {
	Module               *string  `protobuf:"bytes,1,opt,name=module" json:"module,omitempty"`
	Version              *string  `protobuf:"bytes,2,opt,name=version" json:"version,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
 ...
 (m *StopModuleRequest) Reset()         { *m = StopModuleRequest{} } (m *StopModuleRequest) String() string { return proto.CompactTextString(m) } (*StopModuleRequest) ProtoMessage()    {} (*StopModuleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{13}
} (m *StopModuleRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_StopModuleRequest.Unmarshal(m, b)
} (m *StopModuleRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_StopModuleRequest.Marshal(b, m, deterministic)
} (dst *StopModuleRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StopModuleRequest.Merge(dst, src)
} (m *StopModuleRequest) XXX_Size() int {
	return xxx_messageInfo_StopModuleRequest.Size(m)
} (m *StopModuleRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_StopModuleRequest.DiscardUnknown(m)
}var xxx_messageInfo_StopModuleRequest proto.InternalMessageInfo
 (m *StopModuleRequest) GetModule() string {
	if m != nil && m.Module != nil {
		return *m.Module
	}
	return ""
}
 (m *StopModuleRequest) GetVersion() string {
	if m != nil && m.Version != nil {
		return *m.Version
	}
	return ""
 ...
 (m *StopModuleResponse) Reset()         { *m = StopModuleResponse{} } (m *StopModuleResponse) String() string { return proto.CompactTextString(m) } (*StopModuleResponse) ProtoMessage()    {} (*StopModuleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{14}
} (m *StopModuleResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_StopModuleResponse.Unmarshal(m, b)
} (m *StopModuleResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_StopModuleResponse.Marshal(b, m, deterministic)
} (dst *StopModuleResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StopModuleResponse.Merge(dst, src)
} (m *StopModuleResponse) XXX_Size() int {
	return xxx_messageInfo_StopModuleResponse.Size(m)
} (m *StopModuleResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_StopModuleResponse.DiscardUnknown(m)
}var xxx_messageInfo_StopModuleResponse proto.InternalMessageInfotype GetHostnameRequest struct {
	Module               *string  `protobuf:"bytes,1,opt,name=module" json:"module,omitempty"`
	Version              *string  `protobuf:"bytes,2,opt,name=version" json:"version,omitempty"`
 ...
 (m *GetHostnameRequest) Reset()         { *m = GetHostnameRequest{} } (m *GetHostnameRequest) String() string { return proto.CompactTextString(m) } (*GetHostnameRequest) ProtoMessage()    {} (*GetHostnameRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{15}
} (m *GetHostnameRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetHostnameRequest.Unmarshal(m, b)
} (m *GetHostnameRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetHostnameRequest.Marshal(b, m, deterministic)
} (dst *GetHostnameRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetHostnameRequest.Merge(dst, src)
} (m *GetHostnameRequest) XXX_Size() int {
	return xxx_messageInfo_GetHostnameRequest.Size(m)
} (m *GetHostnameRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetHostnameRequest.DiscardUnknown(m)
}var xxx_messageInfo_GetHostnameRequest proto.InternalMessageInfo
 (m *GetHostnameRequest) GetModule() string {
	if m != nil && m.Module != nil {
		return *m.Module
	}
	return ""
}
 (m *GetHostnameRequest) GetVersion() string {
	if m != nil && m.Version != nil {
		return *m.Version
	}
	return ""
}
 (m *GetHostnameRequest) GetInstance() string {
 ...
 (m *GetHostnameResponse) Reset()         { *m = GetHostnameResponse{} } (m *GetHostnameResponse) String() string { return proto.CompactTextString(m) } (*GetHostnameResponse) ProtoMessage()    {} (*GetHostnameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_service_9cd3bffe4e91c59a, []int{16}
} (m *GetHostnameResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetHostnameResponse.Unmarshal(m, b)
} (m *GetHostnameResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetHostnameResponse.Marshal(b, m, deterministic)
} (dst *GetHostnameResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetHostnameResponse.Merge(dst, src)
} (m *GetHostnameResponse) XXX_Size() int {
 ...
 (m *GetHostnameResponse) GetHostname() string {
