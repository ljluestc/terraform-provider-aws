...
// ProtoLegacy specifies whether to enable support for legacy 
tionality
...
//
// WARNING: compatibility agreement covers nothing provided by this flag.
// As such, 
tionality may suddenly be removed or changed at our discretion.
