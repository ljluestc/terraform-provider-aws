...
// File descriptors generated by protoc-gen-go do not rely on that property.
 ...
 legacyLoadFileDesc(b []byte) protoreflect.FileDescriptor {
...
type resolverOnly struct {
 ...
 (r resolverOnly) FindFileByPath(path string) (protoreflect.FileDescriptor, error) {
urn r.reg.FindFileByPath(path)
}

resolverOnly) FindDescriptorByName(name protoreflect.FullName) (protoreflect.Descriptor, error) {
	return r.reg.FindDescriptorByName(name)
}

 (resolverOnly) RegisterFile(protoreflect.FileDescriptor) error {
	return nil
}
