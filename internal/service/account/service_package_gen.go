// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package accountimport (
...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*account_sdkv2.Client, error) {
	cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))	return account_sdkv2.NewFromConfig(cfg, 
func(o *account_sdkv2.Options) {
