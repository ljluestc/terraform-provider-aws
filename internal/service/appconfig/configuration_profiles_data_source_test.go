...
funcTestAccAppConfigConfigurationProfilesDataSource_basic(t*testing.T){
...
functestAccConfigurationProfilesDataSourceConfig_basic(appName,rName1,rName2string)string{
