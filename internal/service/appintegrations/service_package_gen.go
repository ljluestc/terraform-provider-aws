// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package appintegrationsimport (
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*appintegrationsservice_sdkv1.AppIntegrationsService, error) {
	sess := config["session"].(*session_sdkv1.Session)	return appintegrationsservice_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
