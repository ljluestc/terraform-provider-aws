...
resp, err := conn.DescribeFleetsWithContext(ctx, input)if err != nil {
return nil, err
...
}output, err := findImageBuilder(ctx, conn, input)if err != nil {
return nil, err
...
func := describeImageBuildersPages(ctx, conn, input, 
...
output, err := findImageBuilders(ctx, conn, input)if err != nil {
funcif len(output) == 0 || output[0] == nil {
...
func
err := describeUsersPages(ctx, conn, input, 
func(page *appstream.DescribeUsersOutput, lastPage bool) bool {
if page == nil {
return !lastPage
...
err := listAssociatedStacksPages(ctx, conn, input, 
func(page *appstream.ListAssociatedStacksOutput, lastPage bool) bool {
funceturn !lastPage
