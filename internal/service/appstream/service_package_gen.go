// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package appstreamimport (
...
func (p *servicePackage) SDKResources(ctx context.Context) []*types.ServicePackageSDKResource {
	return []*types.ServicePackageSDKResource{
		{
funcypeName: "aws_appstream_directory_config",
		},
		{
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*appstream_sdkv1.AppStream, error) {
	sess := config["session"].(*session_sdkv1.Session)	return appstream_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
}
