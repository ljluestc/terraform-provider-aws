...
resource "aws_launch_configuration" "test" {
  ...
  desired_capacity
  force_deletee  launch_configuration = aws_launch_configuration.test.name  tag {
y  = "MetaGroup"
lue= %[1]q
...
lues = [%[1]q]
  ...
  names = [aws_autoscaling_group.test1.name]  depends_on = [aws_autoscaling_group.test1, aws_autoscaling_group.test2, aws_autoscaling_group.test3]
