...
funcTestExpandEC2ConfigurationsUpdate(t*testing.T){
t.Parallel()//lintignore:AWSAT002
testCases:=[]struct{
flattened[]interface{}
...
ifdiff:=cmp.Diff(expanded,testCase.expected);diff!=""{
t.Errorf("unexpecteddiff(+wanted,-got):%s",diff)
}
}
}
funcTestExpandLaunchTemplateSpecificationUpdate(t*testing.T){
...
funcTestAccBatchComputeEnvironment_basic(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
serviceRoleResourceName:="aws_iam_role.batch_service"resource.ParallelTest(t,resource.TestCase{
...
funcTestAccBatchComputeEnvironment_disappears(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"resource.ParallelTest(t,resource.TestCase{
PreCheck:func(){acctest.PreCheck(ctx,t);testAccPreCheck(ctx,t)},
ErrorCheck:acctest.ErrorCheck(t,batch.EndpointsID),
ProtoV5ProviderFactories:acctest.ProtoV5ProviderFactories,
CheckDestroy:testAccCheckComputeEnvironmentDestroy(ctx),
...
funcTestAccBatchComputeEnvironment_nameGenerated(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"resource.ParallelTest(t,resource.TestCase{
...
funcTestAccBatchComputeEnvironment_namePrefix(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"resource.ParallelTest(t,resource.TestCase{
...
funcTestAccBatchComputeEnvironment_eksConfiguration(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
eksClusterResourceName:="aws_eks_cluster.test"resource.ParallelTest(t,resource.TestCase{
PreCheck:func(){acctest.PreCheck(ctx,t);testAccPreCheck(ctx,t)},
ErrorCheck:acctest.ErrorCheck(t,batch.EndpointsID),
ProtoV5ProviderFactories:acctest.ProtoV5ProviderFactories,
...
funcTestAccBatchComputeEnvironment_createEC2(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
...
subnetResourceName:="aws_subnet.test"resource.ParallelTest(t,resource.TestCase{
PreCheck:func(){acctest.PreCheck(ctx,t);testAccPreCheck(ctx,t)},
ErrorCheck:acctest.ErrorCheck(t,batch.EndpointsID),
ProtoV5ProviderFactories:acctest.ProtoV5ProviderFactories,
CheckDestroy:testAccCheckComputeEnvironmentDestroy(ctx),
...
funcTestAccBatchComputeEnvironment_CreateEC2DesiredVCPUsEC2KeyPairImageID_computeResourcesTags(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
resourceName:="aws_batch_compute_environment.test"
...
securityGroupResourceName:="aws_security_group.test"
serviceRoleResourceName:="aws_iam_role.batch_service"
subnetResourceName:="aws_subnet.test"rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
funcTestAccBatchComputeEnvironment_createSpot(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
...
funcTestAccBatchComputeEnvironment_CreateSpotAllocationStrategy_bidPercentage(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
...
funcTestAccBatchComputeEnvironment_createFargate(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
...
funcTestAccBatchComputeEnvironment_createFargateSpot(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
...
funcTestAccBatchComputeEnvironment_updateState(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
...
funcTestAccBatchComputeEnvironment_updateServiceRole(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
...
funcTestAccBatchComputeEnvironment_defaultServiceRole(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
...
funcTestAccBatchComputeEnvironment_ComputeResources_minVCPUs(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
...
funcTestAccBatchComputeEnvironment_ComputeResources_maxVCPUs(t*testing.T){
ctx:=acctest.Context(t)
varcebatch.ComputeEnvironmentDetail
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_batch_compute_environment.test"
...
subnetResourceName2 := "aws_subnet.test_2"resource.ParallelTest(t, resource.TestCase{
PreCheck: func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
ErrorCheck:  acctest.ErrorCheck(t, batch.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
CheckDestroy:testAccCheckComputeEnvironmentDestroy(ctx),
...
conn := acctest.Provider.Meta().(*conns.AWSClient).BatchConn(ctx)for _, rs := range s.RootModule().Resources {
if rs.Type != "aws_batch_compute_environment" {
continue
}_, err := tfbatch.FindComputeEnvironmentDetailByName(ctx, conn, rs.Primary.ID)if tfresource.NotFound(err) {
continue
}if err != nil {
return err
...
}conn := acctest.Provider.Meta().(*conns.AWSClient).BatchConn(ctx)output, err := tfbatch.FindComputeEnvironmentDetailByName(ctx, conn, rs.Primary.ID)if err != nil {
return err
}*v = *outputreturn nil
}
}
func testAccPreCheck(ctx context.Context, t *testing.T) {
conn := acctest.Provider.Meta().(*conns.AWSClient).BatchConn(ctx)input := &batch.DescribeComputeEnvironmentsInput{}_, err := conn.DescribeComputeEnvironmentsWithContext(ctx, input)if acctest.PreCheckSkipError(err) {
...
return fmt.Sprintf(`
data "aws_partition" "current" {}resource "aws_iam_role" "ecs_instance" {
  name = "%[1]s_ecs_instance"  assume_role_policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [{
...
EOF
  ...
  name = "%[1]s_batch_service"  assume_role_policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [{
 "Action": "sts:AssumeRole",
...
EOF
  ...
  name = "%[1]s_ec2_spot_fleet"  assume_role_policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [{
 "Action": "sts:AssumeRole",
...
resource "aws_batch_compute_environment" "test" {
  compute_environment_name = %[1]q  service_role = aws_iam_role.batch_service.arn
  type = "UNMANAGED"
...
return acctest.ConfigCompose(testAccComputeEnvironmentConfig_base(rName), fmt.Sprintf(`
resource "aws_batch_compute_environment" "test" {
  compute_environment_name_prefix = %[1]q  service_role = aws_iam_role.batch_service.arn
  type = "UNMANAGED"
  depends_on= [aws_iam_role_policy_attachment.batch_service]
}
`, rName))
...
data "aws_partition" "current" {}data "aws_caller_identity" "current" {}resource "aws_iam_role" "cluster" {
...
Service = "ec2.${data.aws_partition.current.dns_suffix}"
 ...
 "kubernetes.io/cluster/%[1]s" = "shared"
  ...
  name= %[1]q
  role_arn = aws_iam_role.cluster.arn  vpc_config {
...
EOF
  ...
  compute_environment_name = %[1]q  eks_configuration {
 ...
 min_vcpus = 0
 max_vcpus = 128 instance_type = ["m5.large"] security_group_ids = [
 aws_security_group.test.id
 ]
 subnets = aws_subnet.test[*].id instance_role = aws_iam_instance_profile.node.arn
  }  depends_on = [
...
return acctest.ConfigCompose(testAccComputeEnvironmentConfig_base(rName), fmt.Sprintf(`
resource "aws_batch_compute_environment" "test" {
  compute_environment_name = %[1]q  compute_resources {
...
resource "aws_batch_compute_environment" "test" {
 ...
 type = "FARGATE"
  ...
  name = "%[1]s_batch_service_2"  assume_role_policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [{
 "Action": "sts:AssumeRole",
...
resource "aws_launch_template" "test" {
  name = %[1]q  vpc_security_group_ids = [
 aws_security_group.test.id
  ]
}resource "aws_batch_compute_environment" "test" {
  compute_environment_name = %[1]q  compute_resources {
...
return acctest.ConfigCompose(testAccComputeEnvironmentConfig_base(rName), fmt.Sprintf(`
resource "aws_batch_compute_environment" "test" {
  depends_on = [aws_iam_role_policy_attachment.batch_service]  compute_environment_name = %[1]q
  service_role= aws_iam_role.batch_service.arn
  type= "UNMANAGED"  tags = {
 %[2]q = %[3]q
  }
...
resource "aws_batch_compute_environment" "test" {
  compute_environment_name = %[1]q  compute_resources {
 instance_role = aws_iam_instance_profile.ecs_instance.arn
 instance_type = ["optimal"] ec2_configuration {
...
resource "aws_placement_group" "test" {
 ...
 min_vcpus = 0 placement_group = aws_placement_group.test.name security_group_ids = [
 aws_security_group.test.id
 ]
 spot_iam_fleet_role = aws_iam_role.ec2_spot_fleet.arn
 subnets = [
...
resource "aws_iam_role" "ecs_instance_2" {
  name = "%[1]s_ecs_instance_2"  assume_role_policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [{
 "Action": "sts:AssumeRole",
