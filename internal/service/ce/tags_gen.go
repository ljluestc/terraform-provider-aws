...
funcut := &costexplorer.ListTagsForResourceInput{
...
func (p *servicePackage) ListTags(ctx context.Context, meta any, identifier string) error {
	tags, err := listTags(ctx, meta.(*conns.A
func
	if err != nil {
return err
...
}// []*SERVICE.Tag handling// Tags returns ce service tags.
...
funcovedTags = removedTags.IgnoreSystem(names.CE)
