...
funcut := &chimesdkvoice.ListTagsForResourceInput{
...
funcpdateTags updates chimesdkvoice service tags.
// The identifier is typically the Amazon Resource Name (ARN), although
// it may also be a different identifier depending on the service.
...
funcovedTags = removedTags.IgnoreSystem(names.ChimeSDKVoice)
