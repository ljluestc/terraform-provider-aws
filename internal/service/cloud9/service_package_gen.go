// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package cloud9import (
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*cloud9_sdkv1.Cloud9, error) {
	sess := config["session"].(*session_sdkv1.Session)	return cloud9_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
