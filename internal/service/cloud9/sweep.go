...
// +build sweeppackage cloud9import (
	"fmt"
	...
	sweepResources := make([]sweep.Sweepable, 0)	err = conn.ListEnvironmentsPagesWithContext(ctx, input, func(page *cloud9.ListEnvironmentsOutput, lastPage bool) bool {
		if page == nil {
			return !lastPage
