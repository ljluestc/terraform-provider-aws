...
)// CustomizeConn customizes a new AWS SDK for Go v1 client for this service package's AWS API.func (p *servicePackage) CustomizeConn(ctx context.Context, conn *cloudformation_sdkv1.CloudFormation) (*cloudformation_sdkv1.CloudFormation, error) {
