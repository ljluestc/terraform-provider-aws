...
func TestAccCloudFormationTypeDataSource_ARN_private(t *testing.T) {
	...
	dataSourceName := "data.aws_cloudformation_type.test"	resource.ParallelTest(t, resource.TestCase{
PreCheck: 
...
func testAccTypeDataSourceConfig_arnPublic() string {
	return `
data "aws_partition" "current" {}data "aws_region" "current" {}data "aws_cloudformation_type" "test" {
