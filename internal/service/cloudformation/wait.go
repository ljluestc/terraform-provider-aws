...
StackSetInstanceDeletedDefaultTimeout = 30 * time.MinutestackSetOperationDelay = 5 * time.Second
)
...
var summaries []*cloudformation.StackSetOperationResultSummarylistErr := conn.ListStackSetOperationResultsPagesWithContext(ctx, input, 
