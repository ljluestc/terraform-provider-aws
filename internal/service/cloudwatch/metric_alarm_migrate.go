...
//SPDX-License-Identifier:MPL-2.0packagecloudwatchimport(
"fmt"
...
returnis,nil
}log.Printf("[DEBUG]Attributesbeforemigration:%#v",is.Attributes)is.Attributes["treat_missing_data"]="missing"log.Printf("[DEBUG]Attributesaftermigration:%#v",is.Attributes)
returnis,nil
}
