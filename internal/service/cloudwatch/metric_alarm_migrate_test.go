...
Expected:"missing",	}	for tn, tc := range cases {
 := &terraform.InstanceState{
ID:tc.ID,
Attributes: tc.Attributes,, err := tfcloudwatch.MetricAlarmMigrateState(
tc.StateVersion, is, tc.Meta) err != nil {
t.Fatalf("bad: %s, err: %#v", tn, err)
fs.Attributes["treat_missing_data"] != tc.Expected {
