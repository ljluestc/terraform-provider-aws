...
func(codebuild.EndpointsID,testAccErrorCheckSkip)
}


functestAccErrorCheckSkip(t*testing.T)resource.ErrorCheck
func{
...
//Thisisusedfortestingaws_codebuild_webhookaswellasaws_codebuild_project.
//TheTerraformAWSusermusthavedonethemanualBitbucketOAuthdanceforthis
//
functionalitytowork.Additionally,theBitbucketuserthattheTerraformAWS
//userlogsinasmusthaveaccesstotheBitbucketrepository.

functestAccBitbucketSourceLocationFromEnv()string{
...
//Thisisusedfortestingaws_codebuild_webhookaswellasaws_codebuild_project.
//TheTerraformAWSusermusthavedonethemanualGitHubOAuthdanceforthis
//
functionalitytowork.Additionally,theGitHubuserthattheTerraformAWS
//userlogsinasmusthaveaccesstotheGitHubrepository.

functestAccGitHubSourceLocationFromEnv()string{
...
funcTestAccCodeBuildProject_basic(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
...
funcTestAccCodeBuildProject_publicVisibility(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
funcTestAccCodeBuildProject_badgeEnabled(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_buildTimeout(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_queuedTimeout(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_cache(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
ExpectError:regexache.MustCompile(`cachelocationisrequiredwhencachetypeis"S3"`),
},
{
...
funcTestAccCodeBuildProject_description(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_fileSystemLocations(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
PreCheck:
func(){acctest.PreCheck(ctx,t);testAccPreCheck(ctx,t)},
ErrorCheck:acctest.ErrorCheck(t,codebuild.EndpointsID,"efs"),//usingefs.EndpointsIDwillimportefsandmakelinterssad
ProtoV5ProviderFactories:acctest.ProtoV5ProviderFactories,
CheckDestroy:testAccCheckProjectDestroy(ctx),
Steps:[]resource.TestStep{
{
...
funcTestAccCodeBuildProject_sourceVersion(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_encryptionKey(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Environment_environmentVariable(t*testing.T){
ctx:=acctest.Context(t)
varproject1,project2,project3codebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_EnvironmentEnvironmentVariable_type(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_EnvironmentEnvironmentVariable_value(t*testing.T){
ctx:=acctest.Context(t)
varproject1,project2,project3codebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Environment_certificate(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
funcTestAccCodeBuildProject_Logs_cloudWatchLogs(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Logs_s3Logs(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_buildBatch(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"

ifacctest.Partition()=="aws-us-gov"{
t.Skip("CodeBuildProjectbuildbatchconfigisnotsupportedinGovCloudpartition")
}
...
funcTestAccCodeBuildProject_Source_gitCloneDepth(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceGitSubmodules_codeCommit(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceGitSubmodules_gitHub(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceGitSubmodules_gitHubEnterprise(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondarySourcesGitSubmodules_codeCommit(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondarySourcesGitSubmodules_gitHub(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondarySourcesGitSubmodules_gitHubEnterprise(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondarySourcesVersions(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceBuildStatus_gitHubEnterprise(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
ifacctest.Partition()=="aws-us-gov"{
t.Skip("CodeBuildProjectbuildstatusconfigisnotsupportedinGovCloudpartition")
}
...
funcTestAccCodeBuildProject_Source_insecureSSL(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceReportBuildStatus_bitbucket(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceReportBuildStatus_gitHub(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceReportBuildStatus_gitHubEnterprise(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceType_bitbucket(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceType_codeCommit(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceType_codePipeline(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceType_gitHubEnterprise(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceType_s3(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceType_noSource(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SourceType_noSourceInvalid(t*testing.T){
ctx:=acctest.Context(t)
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
rBuildspec:=`
version:0.2
...
ExpectError:regexache.MustCompile("`buildspec`mustbesetwhensource's`type`is`NO_SOURCE`"),
},
{
Config:testAccProjectConfig_sourceTypeNoSource(rName,"location",rBuildspec),
ExpectError:regexache.MustCompile("`location`mustbeemptywhensource's`type`is`NO_SOURCE`"),
},
},
})
}
...
funcTestAccCodeBuildProject_tags(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_vpc(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_windowsServer2019Container(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_armContainer(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Artifacts_artifactIdentifier(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Artifacts_encryptionDisabled(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Artifacts_location(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
...
funcTestAccCodeBuildProject_Artifacts_name(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Artifacts_namespaceType(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Artifacts_overrideArtifactName(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Artifacts_packaging(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Artifacts_path(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Artifacts_type(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Artifacts_bucketOwnerAccess(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_secondaryArtifacts(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondaryArtifacts_artifactIdentifier(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondaryArtifacts_overrideArtifactName(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondaryArtifacts_encryptionDisabled(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondaryArtifacts_location(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName1:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
rName2:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
funcTestAccCodeBuildProject_SecondaryArtifacts_name(t*testing.T){
acctest.Skip(t,"Currentlynosolutiontoallowupdatesonnameattribute")
...
funcTestAccCodeBuildProject_SecondaryArtifacts_namespaceType(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondaryArtifacts_packaging(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondaryArtifacts_path(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondaryArtifacts_type(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_SecondarySources_codeCommit(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestProject_nameValidation(t*testing.T){
t.Parallel()
...
iflen(errors)!=tc.ErrCount{
t.Fatalf("ExpectedtheAWSCodeBuildprojectnametotriggeravalidationerror-%s",errors)
}
}
}


funcTestAccCodeBuildProject_concurrentBuildLimit(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_Environment_registryCredential(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName:="aws_codebuild_project.test"
...
funcTestAccCodeBuildProject_disappears(t*testing.T){
ctx:=acctest.Context(t)
varprojectcodebuild.Project
rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
functestAccCheckProjectExists(ctxcontext.Context,nstring,project*codebuild.Project)resource.TestCheck
func{
return
...
ifrs.Primary.ID==""{
returnfmt.Errorf("NoCodeBuildProjectIDisset")
}
...
ifoutput==nil{
returnfmt.Errorf("CodeBuildProject(%s)notfound",rs.Primary.ID)
}
...
functestAccCheckProjectDestroy(ctxcontext.Context)resource.TestCheck
func{
return
func(s*terraform.State)error{
conn:=acctest.Provider.Meta().(*conns.AWSClient).CodeBuildConn(ctx)
...
ifrs.Type!="aws_codebuild_project"{
continue
}
...
returnfmt.Errorf("CodeBuildProject%sstillexists",rs.Primary.ID)
}
...
functestAccCheckProjectCertificate(project*codebuild.Project,expectedCertificatestring)resource.TestCheck
func{
return
func(s*terraform.State)error{
ifaws.StringValue(project.Environment.Certificate)!=expectedCertificate{
returnfmt.Errorf("CodeBuildProjectcertificate(%s)didnotmatch:%s",aws.StringValue(project.Environment.Certificate),expectedCertificate)
}
returnnil
}
}
...
functestAccPreCheck(ctxcontext.Context,t*testing.T){
conn:=acctest.Provider.Meta().(*conns.AWSClient).CodeBuildConn(ctx)
...
iferr!=nil&&!tfresource.NotFound(err){
t.Fatalf("unexpectedPreCheckerror:%s",err)
}
}


functestAccProjectConfig_Base_ServiceRole(rNamestring)string{
returnfmt.Sprintf(`
...
functestAccProjectConfig_basic(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
...
functestAccProjectConfig_visibility(rName,visibilitystring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_visibilityResourceRole(rName,visibilitystring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_badgeEnabled(rNamestring,badgeEnabledbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
badge_enabled=%[1]t
name=%[2]q
...
functestAccProjectConfig_buildTimeout(rNamestring,buildTimeoutint)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
build_timeout=%[1]d
name=%[2]q
...
functestAccProjectConfig_queuedTimeout(rNamestring,queuedTimeoutint)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
queued_timeout=%[1]d
name=%[2]q
...
functestAccProjectConfig_s3ComputedLocation(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
...
functestAccProjectConfig_cache(rName,cacheLocation,cacheTypestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
...
functestAccProjectConfig_localCache(rName,modeTypestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_description(rName,descriptionstring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
description=%[1]q
name=%[2]q
...
functestAccProjectConfig_sourceVersion(rName,sourceVersionstring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_encryptionKey(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
...
functestAccProjectConfig_environmentVariableOne(rName,key1,value1string)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_environmentVariableTwo(rName,key1,value1,key2,value2string)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_environmentVariableZero(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_environmentVariableType(rName,environmentVariableTypestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_environmentCertificate(rNamestring,oNamestring)string{
...
functestAccProjectConfig_environmentRegistryCredential1(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_environmentRegistryCredential2(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_cloudWatchLogs(rName,status,gName,sNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_buildBatch(rNamestring,combineArtifactsbool,computeTypesAllowedstring,maximumBuildsAllowed,timeoutInMinsint)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_s3Logs(rName,status,locationstring,encryptionDisabledbool)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_sourceGitCloneDepth(rNamestring,gitCloneDepthint)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceGitSubmodulesCodeCommit(rNamestring,fetchSubmodulesbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceGitSubmodulesGitHub(rNamestring,fetchSubmodulesbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceGitSubmodulesGitHubEnterprise(rNamestring,fetchSubmodulesbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_secondarySourcesGitSubmodulesCodeCommit(rNamestring,fetchSubmodulesbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_secondarySourcesNone(rNamestring,fetchSubmodulesbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_secondarySourcesGitSubmodulesGitHub(rNamestring,fetchSubmodulesbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_secondarySourcesGitSubmodulesGitHubEnterprise(rNamestring,fetchSubmodulesbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_secondarySourceVersionsCodeCommit(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_secondarySourceVersionsCodeCommitUpdated(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceInsecureSSL(rNamestring,insecureSSLbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceReportBuildStatusBitbucket(rName,sourceLocationstring,reportBuildStatusbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceReportBuildStatusGitHub(rNamestring,reportBuildStatusbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceReportBuildStatusGitHubEnterprise(rNamestring,reportBuildStatusbool)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceTypeBitbucket(rName,sourceLocationstring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceTypeCodeCommit(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceTypeCodePipeline(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceTypeGitHubEnterprise(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceTypeS3(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_s3_bucket""test"{
bucket=%[1]q
}
...
functestAccProjectConfig_sourceTypeNoSource(rNamestring,rLocationstring,rBuildspecstring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_tags(rName,tagKey,tagValuestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_vpc1(rNamestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
...
functestAccProjectConfig_vpc2(rNamestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
acctest.ConfigAvailableAZsNoOptIn(),
fmt.Sprintf(`
...
functestAccProjectConfig_windowsServer2019Container(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_armContainer(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_artifactsArtifactIdentifier(rNamestring,artifactIdentifierstring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_artifactsEncryptionDisabled(rNamestring,encryptionDisabledbool)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_artifactsLocation(rName,bucketNamestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_artifactsName(rNamestring,namestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_artifactsNamespaceType(rName,namespaceTypestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_artifactsOverrideArtifactName(rNamestring,overrideArtifactNamebool)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_artifactsPackaging(rName,packagingstring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_artifactsPath(rName,pathstring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_artifactsType(rNamestring,artifactTypestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_artifactsBucketOwnerAccess(rNamestring,typstring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondaryArtifacts(rNamestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondaryArtifactsNone(rNamestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondaryArtifactsArtifactIdentifier(rNamestring,artifactIdentifierstring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondaryArtifactsEncryptionDisabled(rNamestring,encryptionDisabledbool)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondaryArtifactsLocation(rName,bucketNamestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondaryArtifactsName(rNamestring,namestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondaryArtifactsNamespaceType(rName,namespaceTypestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondaryArtifactsOverrideArtifactName(rNamestring,overrideArtifactNamebool)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondaryArtifactsPackaging(rName,packagingstring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondaryArtifactsPath(rName,pathstring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondaryArtifactsType(rNamestring,artifactTypestring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
fmt.Sprintf(`
resource"aws_s3_bucket""test"{
...
functestAccProjectConfig_secondarySourcesCodeCommit(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_sourceBuildStatusGitHubEnterprise(rNamestring)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
name=%[1]q
service_role=aws_iam_role.test.arn
...
functestAccProjectConfig_concurrentBuildLimit(rNamestring,concurrentBuildLimitint)string{
returnacctest.ConfigCompose(testAccProjectConfig_Base_ServiceRole(rName),fmt.Sprintf(`
resource"aws_codebuild_project""test"{
...
functestAccProjectConfig_fileSystemLocations(rName,mountPointstring)string{
returnacctest.ConfigCompose(
testAccProjectConfig_Base_ServiceRole(rName),
acctest.ConfigAvailableAZsNoOptIn(),
fmt.Sprintf(`
