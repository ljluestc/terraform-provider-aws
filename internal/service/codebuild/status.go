...
)// statusReportGroup fetches the Report Group and its Statusfunc statusReportGroup(ctx context.Context, conn *codebuild.CodeBuild, arn string) retry.StateRefresh
func {
