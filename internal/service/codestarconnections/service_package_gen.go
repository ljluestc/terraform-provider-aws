// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package codestarconnectionsimport (
...
cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))return codestarconnections_sdkv2.NewFromConfig(cfg, func(o *codestarconnections_sdkv2.Options) {
