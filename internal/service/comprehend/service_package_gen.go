// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package comprehendimport (
...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*comprehend_sdkv2.Client, error) {
	cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))	return comprehend_sdkv2.NewFromConfig(cfg, 
func(o *comprehend_sdkv2.Options) {
