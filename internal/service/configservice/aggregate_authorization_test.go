...
// eckDestroy: testAccCheckAggregateAuthorizationDestroy,
...
//  rs.Type != "aws_config_aggregate_authorization" {
// continue
// / acuntId, region, err := tfconfig.AggregateAuthorizationParseID(rs.Primary.ID)
//  err != nil {
// return err
// / agegateAuthorizations, err := tfconfig.DescribeAggregateAuthorizations(conn)// if e != nil {
// return err
// / fo_, auth := range aggregateAuthorizations {
