...
conformancePackDeleteTimeout = 5 * time.MinuteconformancePackStatusNotFound = "NotFound"
...
output, err := conn.DescribeConformancePacksWithContext(ctx, input)if err != nil {
return nil, err
...
output, err := conn.DescribeConformancePackStatusWithContext(ctx, input)if err != nil {
return nil, err
...
output, err := conn.DescribeOrganizationConfigRulesWithContext(ctx, input)if err != nil {
return nil, err
...
output, err := conn.DescribeOrganizationConfigRuleStatusesWithContext(ctx, input)if err != nil {
return nil, err
...
output, err := conn.DescribeOrganizationConformancePacksWithContext(ctx, input)if err != nil {
return nil, err
...
output, err := conn.DescribeOrganizationConformancePackStatusesWithContext(ctx, input)if err != nil {
return nil, err
...
var statuses []*configservice.MemberAccountStatusfor {
output, err := conn.GetOrganizationConfigRuleDetailedStatusWithContext(ctx, input)if err != nil {
return nil, err
}statuses = append(statuses, output.OrganizationConfigRuleDetailedStatus...)if aws.StringValue(output.NextToken) == "" {
break
}input.NextToken = output.NextToken
}return statuses, nil
...
}var statuses []*configservice.OrganizationConformancePackDetailedStatusfor {
output, err := conn.GetOrganizationConformancePackDetailedStatusWithContext(ctx, input)if err != nil {
return nil, err
}statuses = append(statuses, output.OrganizationConformancePackDetailedStatuses...)if aws.StringValue(output.NextToken) == "" {
break
}input.NextToken = output.NextToken
}return statuses, nil
...
status, err := describeConformancePackStatus(ctx, conn, name)if err != nil {
...
return func() (interface{}, string, error) {
status, err := describeOrganizationConfigRuleStatus(ctx, conn, name)// Transient ResourceDoesNotExist error after creation caught here
...
memberAccountStatuses, err := getOrganizationConfigRuleDetailedStatus(ctx, conn, name, aws.StringValue(status.OrganizationRuleStatus))if err != nil {
...
}var errBuilder strings.Builderfor _, mas := range memberAccountStatuses {
...
return func() (interface{}, string, error) {
status, err := describeOrganizationConformancePackStatus(ctx, conn, name)// Transient ResourceDoesNotExist error after creation caught here
// in cases where the StateChangeConf's delay time is not sufficient
...
return func() (interface{}, string, error) {
status, err := describeOrganizationConformancePackStatus(ctx, conn, name)if err != nil {
return nil, "", err
}if status == nil {
return nil, "", nil
}if status.ErrorCode != nil {
...
memberAccountStatuses, err := getOrganizationConformancePackDetailedStatus(ctx, conn, name, status)if err != nil {
...
}_, err := stateChangeConf.WaitForStateContext(ctx)if tfawserr.ErrCodeEquals(err, configservice.ErrCodeNoSuchConformancePackException) {
return nil
}return err
