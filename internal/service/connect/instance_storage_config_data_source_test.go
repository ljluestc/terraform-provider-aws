...
datasourceName := "data.aws_connect_instance_storage_config.test"resource.Test(t, resource.TestCase{
PreCheck:
...
name = %[1]q
role = aws_iam_role.firehose.idpolicy = <<EOF
{
"Version": "2012-10-17",
"Statement": [
 {
...
resource_type = "CONTACT_TRACE_RECORDS"storage_config {
...
instance_id= aws_connect_instance.test.id
resource_type = "MEDIA_STREAMS"storage_config {
 kinesis_video_stream_config {
prefix= "tf-test-prefix"
retention_period_hours = 1encryption_config {
encryption_type = "KMS"
...
depends_on = [aws_s3_bucket_server_side_encryption_configuration.test]instance_id= aws_connect_instance.test.id
resource_type = "CHAT_TRANSCRIPTS"storage_config {
 s3_config {
bucket_name= aws_s3_bucket.test.id
bucket_prefix = "tf-test-Chat-Transcripts"encryption_config {
encryption_type = "KMS"
key_id = aws_kms_key.test.arn
}
 }
