...
Check: resource.ComposeAggregateTestCheckfunc(
	...
	ctx := acctest.Context(t)	var v connect.DescribeRoutingProfileOutput
	rName := sdkacctest.RandomWithPrefix("resource-test-terraform")
	rName2 := sdkacctest.RandomWithPrefix("resource-test-terraform")
	rName3 := sdkacctest.RandomWithPrefix("resource-test-terraform")
	resourceName := "aws_connect_routing_profile.test"	resource.Test(t, resource.TestCase{
PreCheck:func() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, connect.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
CheckDestroy:testAccCheckRoutingProfileDestroy(ctx),
...
ExpectNonEmptyPlan: true,
	...
	rName3 := sdkacctest.RandomWithPrefix("resource-test-terraform")
	resourceName := "aws_connect_routing_profile.test"
	description := "testMediaConcurrencies"	resource.Test(t, resource.TestCase{
PreCheck:func() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, connect.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
CheckDestroy:testAccCheckRoutingProfileDestroy(ctx),
...
Check: resource.ComposeAggregateTestCheckfunc(
	...
	rName4 := sdkacctest.RandomWithPrefix("resource-test-terraform")
	resourceName := "aws_connect_routing_profile.test"
	description := "testQueueConfigs"	resource.Test(t, resource.TestCase{
PreCheck:func() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, connect.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
CheckDestroy:testAccCheckRoutingProfileDestroy(ctx),
...
Check: resource.ComposeAggregateTestCheckfunc(
	...
	rName2 := sdkacctest.RandomWithPrefix("resource-test-terraform")
	rName3 := sdkacctest.RandomWithPrefix("resource-test-terraform")
	description := "tags"	resourceName := "aws_connect_routing_profile.test"	resource.Test(t, resource.TestCase{
PreCheck:func() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, connect.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
CheckDestroy:testAccCheckRoutingProfileDestroy(ctx),
...
instanceID, routingProfileID, err := tfconnect.RoutingProfileParseID(rs.Primary.ID)if err != nil {
	return err
}conn := acctest.Provider.Meta().(*conns.AWSClient).ConnectConn(ctx)params := &connect.DescribeRoutingProfileInput{
...
continue
	}	conn := acctest.Provider.Meta().(*conns.AWSClient).ConnectConn(ctx)	instanceID, routingProfileID, err := tfconnect.RoutingProfileParseID(rs.Primary.ID)	if err != nil {
return err
	}	params := &connect.DescribeRoutingProfileInput{
InstanceId: aws.String(instanceID),
RoutingProfileId: aws.String(routingProfileID),
	}	_, err = conn.DescribeRoutingProfileWithContext(ctx, params)	if tfawserr.ErrCodeEquals(err, connect.ErrCodeResourceNotFoundException) {
continue
	}	if err != nil {
return err
	}
...
description= %[2]qmedia_concurrencies {
 channel= "VOICE"
 concurrency = 1
}tags = {
...
description= "Test updating the default outbound queue id"media_concurrencies {
 channel= "VOICE"
 concurrency = 1
}tags = {
 "Name" = "Test Routing Profile",
...
name = %[1]q
default_outbound_queue_id = aws_connect_queue.default_outbound_queue.queue_id
description= %[3]qmedia_concurrencies {
 channel= "VOICE"
 concurrency = 1
}queue_configs {
 channel= "VOICE"
...
`, rName3, label))
	...
	return `
resource "aws_connect_queue" "test" {
count = 16instance_id= aws_connect_instance.test.id
...
name = %[1]q
default_outbound_queue_id = aws_connect_queue.default_outbound_queue.queue_id
description= "test queue batched associations"media_concurrencies {
 channel= "VOICE"
 concurrency = 1
}dynamic "queue_configs" {
 for_each = [aws_connect_queue.test[0].queue_id, aws_connect_queue.test[1].queue_id] content {
channel= "CHAT"
...
description= "test queue batched associations"media_concurrencies {
 ...
 for_each = aws_connect_queue.test[*].queue_id content {
channel= "CHAT"
delay = queue_configs.key + 1
priority = queue_configs.key + 1
queue_id = queue_configs.value
