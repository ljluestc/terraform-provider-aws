...
botAssociationCreateTimeout = 5 * time.MinutephoneNumberCreatedTimeout = 2 * time.Minute
phoneNumberUpdatedTimeout = 2 * time.Minute
phoneNumberDeletedTimeout = 2 * time.MinutevocabularyCreatedTimeout = 5 * time.Minute
