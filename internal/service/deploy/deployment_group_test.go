...
// SPDX-License-Identifier: MPL-2.0package deploy_testimport (
	...
	resourceName := "aws_codedeploy_deployment_group.test"	rName := sdkacctest.RandString(5)	resource.ParallelTest(t, resource.TestCase{
PreCheck:k(ctx, t) },
...
resource.TestCheckResourceAttrPair(resourceName, "service_role_arn", "aws_iam_role.test", "arn"),resource.TestCheckResourceAttr(resourceName, "blue_green_deployment_config.#", "0"),resource.TestCheckResourceAttr(resourceName, "ec2_tag_set.#", "0"),
...
resource.TestCheckResourceAttr(resourceName, "deployment_config_name", "CodeDeployDefault.OneAtATime"),
resource.TestCheckResourceAttrPair(resourceName, "service_role_arn", "aws_iam_role.test_updated", "arn"),resource.TestCheckResourceAttr(resourceName, "ec2_tag_set.#", "0"),
resource.TestCheckResourceAttr(resourceName, "ec2_tag_filter.#", "1"),
resource.TestCheckTypeSetElemNestedAttrs(resourceName, "ec2_tag_filter.*", map[string]string{
"key":"filterkey",
"type":  "KEY_AND_VALUE",
...
resource.TestCheckResourceAttr(resourceName, "deployment_group_name", "tf-acc-test-"+rName),
resource.TestCheckResourceAttr(resourceName, "deployment_config_name", "CodeDeployDefault.OneAtATime"),
resource.TestCheckResourceAttrPair(resourceName, "service_role_arn", "aws_iam_role.test", "arn"),resource.TestCheckResourceAttr(resourceName, "ec2_tag_set.#", "1"),
...
resource.TestCheckResourceAttr(resourceName, "ec2_tag_filter.#", "0"),resource.TestCheckResourceAttr(resourceName, "alarm_configuration.#", "0"),
resource.TestCheckResourceAttr(resourceName, "auto_rollback_configuration.#", "0"),
resource.TestCheckResourceAttr(resourceName, "trigger_configuration.#", "0"),
),
},
...
resource.TestCheckResourceAttr(resourceName, "deployment_group_name", "tf-acc-test-updated-"+rName),
resource.TestCheckResourceAttr(resourceName, "deployment_config_name", "CodeDeployDefault.OneAtATime"),
resource.TestCheckResourceAttrPair(resourceName, "service_role_arn", "aws_iam_role.test_updated", "arn"),resource.TestCheckResourceAttr(resourceName, "ec2_tag_set.#", "1"),
resource.TestCheckTypeSetElemNestedAttrs(resourceName, "ec2_tag_set.*", map[string]string{
"ec2_tag_filter.#": "1",
}),
resource.TestCheckTypeSetElemNestedAttrs(resourceName, "ec2_tag_set.*.ec2_tag_filter.*", map[string]string{
...
ImportStateVerify: true,
	...
	rName := sdkacctest.RandString(5)	resource.ParallelTest(t, resource.TestCase{
PreCheck:k(ctx, t) },
ErrorCheck: acctest.ErrorCheck(t, codedeploy.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
CheckDestroy:testAccCheckDeploymentGroupDestroy(ctx),
...
resource.TestCheckResourceAttr(
resourceName, "deployment_config_name", "CodeDeployDefault.OneAtATime"),resource.TestCheckResourceAttr(
...
resource.TestCheckResourceAttr(
resourceName, "deployment_style.0.deployment_type", "BLUE_GREEN"),resource.TestCheckResourceAttr(
...
testAccCheckDeploymentGroupExists(ctx, resourceName, &group),
resource.TestCheckResourceAttr(
resourceName, "load_balancer_info.#", "1"),resource.TestCheckResourceAttr(
...
resourceName, "deployment_style.0.deployment_option", "WITH_TRAFFIC_CONTROL"),
resource.TestCheckResourceAttr(
resourceName, "deployment_style.0.deployment_type", "IN_PLACE"),resource.TestCheckResourceAttr(
resourceName, "load_balancer_info.#", "1"),
resource.TestCheckResourceAttr(
resourceName, "load_balancer_info.0.elb_info.#", "1"),
resource.TestCheckTypeSetElemNestedAttrs(resourceName, "load_balancer_info.0.elb_info.*", map[string]string{
...
resource.TestCheckResourceAttr(
resourceName, "blue_green_deployment_config.0.deployment_ready_option.0.action_on_timeout", "CONTINUE_DEPLOYMENT"),resource.TestCheckResourceAttr(
resourceName, "blue_green_deployment_config.0.green_fleet_provisioning_option.#", "1"),
resource.TestCheckResourceAttr(
resourceName, "blue_green_deployment_config.0.green_fleet_provisioning_option.0.action", "DISCOVER_EXISTING"),resource.TestCheckResourceAttr(
...
resource.TestCheckResourceAttr(
resourceName, "deployment_style.0.deployment_type", "BLUE_GREEN"),resource.TestCheckResourceAttr(
resourceName, "blue_green_deployment_config.#", "1"),resource.TestCheckResourceAttr(
resourceName, "blue_green_deployment_config.0.deployment_ready_option.#", "1"),
resource.TestCheckResourceAttr(
resourceName, "blue_green_deployment_config.0.deployment_ready_option.0.action_on_timeout", "STOP_DEPLOYMENT"),
resource.TestCheckResourceAttr(
resourceName, "blue_green_deployment_config.0.deployment_ready_option.0.wait_time_in_minutes", "60"),resource.TestCheckResourceAttr(
resourceName, "blue_green_deployment_config.0.green_fleet_provisioning_option.#", "1"),
resource.TestCheckResourceAttr(
resourceName, "blue_green_deployment_config.0.green_fleet_provisioning_option.0.action", "COPY_AUTO_SCALING_GROUP"),resource.TestCheckResourceAttr(
resourceName, "blue_green_deployment_config.0.terminate_blue_instances_on_deployment_success.#", "1"),
resource.TestCheckResourceAttr(
...
resourceName, "deployment_style.#", "1"),
resource.TestCheckResourceAttr(
resourceName, "deployment_style.0.deployment_type", "IN_PLACE"),// The state is preserved, but AWS ignores it
resource.TestCheckResourceAttr(
...
Check: resource.ComposeTestCheckFunc(
testAccCheckDeploymentGroupExists(ctx, resourceName, &group),resource.TestCheckResourceAttr(
resourceName, "deployment_style.#", "1"),
resource.TestCheckResourceAttr(
resourceName, "deployment_style.0.deployment_option", "WITH_TRAFFIC_CONTROL"),
resource.TestCheckResourceAttr(
...
ImportStateVerify: true,
	...
	resourceName := "aws_codedeploy_deployment_group.test"	resource.ParallelTest(t, resource.TestCase{
PreCheck:k(ctx, t) },
ErrorCheck: acctest.ErrorCheck(t, codedeploy.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
CheckDestroy:testAccCheckDeploymentGroupDestroy(ctx),
...
TriggerTargetArn: aws.String("arn:aws:sns:us-west-2:123456789012:test-topic"), // lintignore:AWSAT003,AWSAT005 // unit test
	...
	}	actual := tfcodedeploy.BuildTriggerConfigs(input)	if !reflect.DeepEqual(actual, expected) {
t.Fatalf("tfcodedeploy.BuildTriggerConfigs output is not correct.\nGot:\n%#v\nExpected:\n%#v\n",
actual, expected)
	}
}func TestDeploymentGroup_triggerConfigsToMap(t *testing.T) {
	t.Parallel()	input := []*codedeploy.TriggerConfig{
{
TriggerEvents: []*string{
aws.String("DeploymentFailure"),
...
"trigger_target_arn": "arn:aws:sns:us-west-2:123456789012:test-topic-2", // lintignore:AWSAT003,AWSAT005 // unit test
	}	actual := tfcodedeploy.TriggerConfigsToMap(input)[0]	fatal := false	if actual["trigger_name"] != expected["trigger_name"] {
fatal = true
...
Enabled: aws.Bool(true),
	}	actual := tfcodedeploy.BuildAutoRollbackConfig(input)	if !reflect.DeepEqual(actual, expected) {
...
actual, expected)
	...
	t.Parallel()	input := &codedeploy.AutoRollbackConfiguration{
Events: []*string{
aws.String("DEPLOYMENT_FAILURE"),
...
"enabled": false,
	}	actual := tfcodedeploy.AutoRollbackConfigToMap(input)[0]	fatal := false	if actual["enabled"] != expected["enabled"] {
fatal = true
...
DeploymentType:aws.String("BLUE_GREEN"),
	}	actual := tfcodedeploy.ExpandDeploymentStyle(input)	if !reflect.DeepEqual(actual, expected) {
...
actual, expected)
	...
	t.Parallel()	expected := map[string]interface{}{
...
DeploymentType:aws.String("IN_PLACE"),
	}	actual := tfcodedeploy.FlattenDeploymentStyle(input)[0]	fatal := false	if actual["deployment_option"] != expected["deployment_option"] {
fatal = true
...
actual, tc.Expected)
	...
	t.Parallel()	input := &codedeploy.LoadBalancerInfo{
...
"name": "xyz-tg",
	...
	}	actual := tfcodedeploy.FlattenLoadBalancerInfo(input)[0].(map[string]interface{})	fatal := false	a := actual["target_group_info"].(*schema.Set)
...
TerminationWaitTimeInMinutes: aws.Int64(90),
	...
	}	actual := tfcodedeploy.ExpandBlueGreenDeploymentConfig(input)	if !reflect.DeepEqual(actual, expected) {
...
actual, expected)
	...
	t.Parallel()	input := &codedeploy.BlueGreenDeploymentConfiguration{
DeploymentReadyOption: &codedeploy.DeploymentReadyOption{
...
"termination_wait_time_in_minutes": 90,
	...
	}	actual := tfcodedeploy.FlattenBlueGreenDeploymentConfig(input)[0]	fatal := false	a := actual["deployment_ready_option"].([]map[string]interface{})[0]
...
IgnorePollAlarmFailure: aws.Bool(false),
	}	actual := tfcodedeploy.BuildAlarmConfig(input)	if !reflect.DeepEqual(actual, expected) {
t.Fatalf("tfcodedeploy.BuildAlarmConfig output is not correct.\nGot:\n%#v\nExpected:\n%#v\n",
actual, expected)
	}
}func TestDeploymentGroup_alarmConfigToMap(t *testing.T) {
	t.Parallel()	input := &codedeploy.AlarmConfiguration{
Alarms: []*codedeploy.Alarm{
{
...
"ignore_poll_alarm_failure": true,
	}	actual := tfcodedeploy.AlarmConfigToMap(input)[0]	fatal := false	if actual["enabled"] != expected["enabled"] {
fatal = true
...
found = truenumberOfEvents := len(actual.TriggerEvents)
...
sort.Strings(actualEvents)if !reflect.DeepEqual(actualEvents, expectedEvents) {
...
}conn := acctest.Provider.Meta().(*conns.AWSClient).DeployConn(ctx)resp, err := conn.GetDeploymentGroupWithContext(ctx, &codedeploy.GetDeploymentGroupInput{
ApplicationName:aws.String(rs.Primary.Attributes["app_name"]),
DeploymentGroupName: aws.String(rs.Primary.Attributes["deployment_group_name"]),
})if err != nil {
return err
}*group = *resp.DeploymentGroupInforeturn nil
	}
...
EOF
  ...
  name = "tf-acc-test-%[1]s"  assume_role_policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [
{
...
resource "aws_codedeploy_deployment_group" "test" {
  ...
  name = "tf-acc-test-%[1]s"
  role = aws_iam_role.test_updated.id  policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [
{
...
EOF
  ...
  name = "tf-acc-test-updated-%[1]s"  assume_role_policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [
{
...
resource "aws_codedeploy_deployment_group" "test" {
  app_name= aws_codedeploy_app.test.name
  deployment_group_name = "tf-acc-test-%[1]s"
  service_role_arn = aws_iam_role.test.arn  on_premises_instance_tag_filter {
key= "filterkey"
type  = "KEY_AND_VALUE"
value = "filtervalue"
  }
...
resource "aws_codedeploy_deployment_group" "test" {
  app_name= aws_codedeploy_app.test.name
  deployment_group_name = "tf-acc-test-%[1]s"
  service_role_arn = aws_iam_role.test.arn  trigger_configuration {
...
resource "aws_codedeploy_deployment_group" "test" {
  app_name= aws_codedeploy_app.test.name
  deployment_group_name = "tf-acc-test-%[1]s"
  service_role_arn = aws_iam_role.test.arn  auto_rollback_configuration {
enabled = true
...
resource "aws_codedeploy_deployment_group" "test" {
  app_name= aws_codedeploy_app.test.name
  deployment_group_name = "tf-acc-test-%[1]s"
  service_role_arn = aws_iam_role.test.arn  alarm_configuration {
alarms  = ["test-alarm"]
enabled = true
  }
}
...
resource "aws_codedeploy_deployment_group" "test" {
  app_name= aws_codedeploy_app.test.name
  deployment_group_name = "tf-acc-test-%[1]s"
  service_role_arn = aws_iam_role.test.arn  deployment_style {
deployment_option = "WITH_TRAFFIC_CONTROL"
deployment_type= "BLUE_GREEN"
  }  load_balancer_info {
elb_info {
...
resource "aws_codedeploy_deployment_group" "test" {
  app_name= aws_codedeploy_app.test.name
  deployment_group_name = "tf-acc-test-%[1]s"
  service_role_arn = aws_iam_role.test.arn  load_balancer_info {
elb_info {
 name = "acc-test-codedeploy-dep-group"
}
  }
...
deployment_option = "WITH_TRAFFIC_CONTROL"
deployment_type= "BLUE_GREEN"
  }  autoscaling_groups = [aws_autoscaling_group.test.name]  load_balancer_info {
elb_info {
 name = "acc-test-codedeploy-dep-group"
}
  }  blue_green_deployment_config {
...
values = ["opt-in-not-required"]
  ...
  name_prefix= "tf-acc-test-codedeploy-deployment-group-"  lifecycle {
create_before_destroy = true
  ...
  max_size= 2
  min_size= 0
  desired_capacity = 1  vpc_zone_identifier = [data.aws_subnet.test.id]  launch_configuration = aws_launch_configuration.test.name  lifecycle {
create_before_destroy = true
  }
}
`, rName) + testAccDeploymentGroupConfig_base(rName)
...
Name = "tf-acc-test-codedeploy-deployment-group-ecs"
  ...
  cidr_blockt.cidr_block, 8, count.index)
...
type= "forward"
  ...
  memory = "512"
  network_mode= "awsvpc"
  requires_compatibilities = ["FARGATE"]  container_definitions = <<DEFINITION
[
  {
"cpu": 256,
"essential": true,
...
POLICY
  ...
  role = aws_iam_role.test.name  policy = <<POLICY
{
  "Version": "2012-10-17",
  "Statement": [
{
...
resource "aws_codedeploy_deployment_group" "test" {
  app_name= aws_codedeploy_app.test.name
  deployment_group_name = "tf-acc-test-%[1]s"
  service_role_arn = aws_iam_role.test.arn  tags = {
%[2]q = %[3]q
  }
}
