...
// +build sweeppackage deployimport (
	"fmt"
...
return fmt.Errorf("error getting client: %s", err)
	...
	var errs *multierror.Error	input := &codedeploy.ListApplicationsInput{}	err = conn.ListApplicationsPagesWithContext(ctx, input, func(page *codedeploy.ListApplicationsOutput, lastPage bool) bool {
...
d.Set("name", appName)sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
	})	if err != nil {
