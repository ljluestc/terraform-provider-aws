// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package devicefarmimport (
...
func (p *servicePackage) SDKResources(ctx context.Context) []*types.ServicePackageSDKResource {
	return []*types.ServicePackageSDKResource{
		{
funcypeName: "aws_devicefarm_device_pool",
			Name:"Device Pool",
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*devicefarm_sdkv1.DeviceFarm, error) {
	sess := config["session"].(*session_sdkv1.Session)	return devicefarm_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
}
