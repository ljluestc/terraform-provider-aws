...
func(p*servicePackage)NewConn(ctxcontext.Context,configmap[string]any)(*docdb_sdkv1.DocDB,error){
sess:=config["session"].(*session_sdkv1.Session)

returndocdb_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint:aws_sdkv1.String(config["endpoint"].(string))})),nil
}
