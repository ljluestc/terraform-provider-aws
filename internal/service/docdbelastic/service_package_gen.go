// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package docdbelasticimport (
...
cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))return docdbelastic_sdkv2.NewFromConfig(cfg, func(o *docdbelastic_sdkv2.Options) {
