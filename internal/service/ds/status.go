...
output, err := FindDirectoryByID(ctx, conn, id)if tfresource.NotFound(err) {
return nil, "", nil
}if err != nil {
return nil, "", err
...
return func() (interface{}, string, error) {
output, err := FindDomainController(ctx, conn, directoryID, domainControllerID)if tfresource.NotFound(err) {
return nil, "", nil
}if err != nil {
return nil, "", err
...
return func() (interface{}, string, error) {
output, err := FindDirectoryByID(ctx, conn, directoryID)if tfresource.NotFound(err) {
return nil, "", nil
}if err != nil {
return nil, "", err
...
return func() (interface{}, string, error) {
output, err := FindRegion(ctx, conn, directoryID, regionName)if tfresource.NotFound(err) {
return nil, "", nil
}if err != nil {
return nil, "", err
}return output, aws.StringValue(output.Status), nil
...
return func() (interface{}, string, error) {
output, err := FindSharedDirectory(ctx, conn, ownerDirectoryID, sharedDirectoryID)if tfresource.NotFound(err) {
return nil, "", nil
}if err != nil {
return nil, "", err
}return output, aws.StringValue(output.ShareStatus), nil
