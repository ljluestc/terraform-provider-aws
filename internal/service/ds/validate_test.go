...
diag.NewAttributeErrorDiagnostic(
	path.Root("test"),
	"InvalidAttributeValueMatch",
	`AttributetestmustbeavalidDirectoryServiceDirectoryID,got:a3b15b67b8`,
),
	},
},
"invalid2":{
...
diag.NewAttributeErrorDiagnostic(
	path.Root("test"),
	"InvalidAttributeValueMatch",
	`AttributetestmustbeavalidDirectoryServiceDirectoryID,got:d-abcdefghij`,
),
	},
},
	}
...
diag.NewAttributeErrorDiagnostic(
	path.Root("test"),
	"InvalidAttributeValueMatch",
	`Attributetestmustbeafullyqualifieddomainnameandmayendwithatrailingperiod,got:test`,
),
	},
},
	}
...
diag.NewAttributeErrorDiagnostic(
	path.Root("test"),
	"InvalidAttributeValueMatch",
	"Attributetestcancontainupper-andlower-caseletters,numbers,andpunctuationcharacters,got:pass\nword",
),
	},
},
	}
