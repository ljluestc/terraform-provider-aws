...
funcource.TestMatchResourceAttr(dataSourceName, "local_bgp_asn", regexache.MustCompile(`^\d+$`)),
...
Steps: []resource.TestStep{
funcig: testAccOutpostsLocalGatewayVirtualInterfaceDataSourceConfig_id(),
Check: resource.ComposeTestCheck
func(
	resource.TestMatchResourceAttr(dataSourceName, "id", regexache.MustCompile(`^lgw-vif-`)),
	...
	resource.TestMatchResourceAttr(dataSourceName, "local_gateway_id", regexache.MustCompile(`^lgw-`)),
funcource.TestMatchResourceAttr(dataSourceName, "peer_bgp_asn", regexache.MustCompile(`^\d+$`)),
	resource.TestMatchResourceAttr(dataSourceName, "vlan", regexache.MustCompile(`^\d+$`)),
),
	},
},
...
Check: resource.ComposeTestCheck
funcource.TestCheckResourceAttrPair(dataSourceName, "id", sourceDataSourceName, "id"),
