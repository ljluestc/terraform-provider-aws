...
funcource.TestCheckResourceAttr(resourceName, "egress.#", "0"),
...
Check: resource.ComposeTestCheck
func(
funcource.TestCheckResourceAttr(resourceName, "subnet_ids.#", "2"),
...
funcreassignment of the two subnets to the `aws_network_acl` will happen
