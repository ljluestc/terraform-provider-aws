...
Check: resource.ComposeTestCheck
func(
functest.CheckResourceDisappears(ctx, acctest.Provider, tfec2.ResourceVPCDHCPOptions(), "aws_vpc_dhcp_options.test"),
),
ExpectNonEmptyPlan: true,
	},
},
...
if !ok {
func
funcrn rs.Primary.Attributes["vpc_id"], nil
	}
}


func testAccCheckVPCDHCPOptionsAssociationDestroy(ctx context.Context) resource.TestCheck
func {
	return 
func(s *terraform.State) error {
func
funcrs.Type != "aws_vpc_dhcp_options_association" {
func
...
func testAccCheckVPCDHCPOptionsAssociationExist(ctx context.Context, n string) resource.TestCheck
func {
	return 
func(s *terraform.State) error {
