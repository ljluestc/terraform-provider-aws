...
func testAccCheckSecurityGroupEgressRuleDestroy(ctx context.Context) resource.TestCheck
func {
	return 
...
func testAccCheckSecurityGroupEgressRuleExists(ctx context.Context, n string, v *ec2.SecurityGroupRule) resource.TestCheck
func {
	return 
func(s *terraform.State) error {
