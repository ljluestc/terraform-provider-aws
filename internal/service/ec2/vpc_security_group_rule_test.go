...
UserIdGroupPairs: []*ec2.UserIdGroupPair{
	{
UserId:s.String("987654321"),
GroupName: aws.String("my-security-group"),
	},
	{
UserId:s.String("123456789"),
GroupName: aws.String("my-security-group"),
	},
	{
UserId:s.String("123456789"),
...
ImportState:
ImportStateId
func: testAccSecurityGroupRuleImportStateId
func(resourceName),
...
func(
	testAccCheckSecurityGroupExists(ctx, sgResourceName, &group),
funcource.TestCheckResourceAttr(resourceName, "cidr_blocks.0", "10.0.0.0/8"),
	...
	resource.TestCheckResourceAttrPair(resourceName, "security_group_id", sgResourceName, "id"),
	resource.TestCheckResourceAttrSet(resourceName, "security_group_rule_id"),
funcource.TestCheckNoResourceAttr(resourceName, "source_security_group_id"),
	resource.TestCheckResourceAttr(resourceName, "to_port", "8000"),
	resource.TestCheckResourceAttr(resourceName, "type", "ingress"),
),
	},
...
func TestAccVPCSecurityGroupRule_Ingress_icmpv6(t *testing.T) {
	ctx := acctest.Context(t)
	var group ec2.SecurityGroup
funcourceName := "aws_security_group_rule.test"
func
	resource.ParallelTest(t, resource.TestCase{
PreCheck:  
func() { acctest.PreCheck(ctx, t) },
...
CheckDestroy:stAccCheckSecurityGroupDestroy(ctx),
Steps: []resource.TestStep{
funcig: testAccVPCSecurityGroupRuleConfig_ingressIcmpv6(rName),
Check: resource.ComposeAggregateTestCheck
func(
	testAccCheckSecurityGroupExists(ctx, sgResourceName, &group),
	resource.TestCheckResourceAttr(resourceName, "cidr_blocks.#", "0"),
...
funcource.TestCheckResourceAttr(resourceName, "prefix_list_ids.#", "0"),
	resource.TestCheckResourceAttrPair(resourceName, "security_group_id", sgResourceName, "id"),
	resource.TestCheckResourceAttrSet(resourceName, "security_group_rule_id"),
	resource.TestCheckResourceAttr(resourceName, "self", "false"),
	resource.TestCheckNoResourceAttr(resourceName, "source_security_group_id"),
...
funcource.TestCheckNoResourceAttr(resourceName, "description"),
	...
	resource.TestCheckResourceAttrSet(resourceName, "security_group_rule_id"),
	resource.TestCheckResourceAttr(resourceName, "self", "false"),
funcource.TestCheckResourceAttr(resourceName, "to_port", "8000"),
	resource.TestCheckResourceAttr(resourceName, "type", "ingress"),
),
	},
	{
...
Check: resource.ComposeAggregateTestCheck
func(
funcource.TestCheckResourceAttr(resourceName, "cidr_blocks.#", "0"),
funcource.TestCheckResourceAttr(resourceName, "from_port", "0"),
	resource.TestCheckResourceAttr(resourceName, "ipv6_cidr_blocks.#", "0"),
	resource.TestCheckResourceAttr(resourceName, "protocol", "-1"),
	resource.TestCheckResourceAttr(resourceName, "prefix_list_ids.#", "0"),
	resource.TestCheckResourceAttrPair(resourceName, "security_group_id", sgResourceName, "id"),
	...
	resource.TestCheckNoResourceAttr(resourceName, "source_security_group_id"),
funcource.TestCheckResourceAttr(resourceName, "type", "ingress"),
),
	},
	{
ResourceName:ame,
...
Steps: []resource.TestStep{
	{
Config:CSecurityGroupRuleConfig_expectInvalidType(rName),
...
Steps: []resource.TestStep{
	{
Config:CSecurityGroupRuleConfig_invalidIPv4CIDR(rName),
ExpectError: regexache.MustCompile("invalid CIDR address: 1.2.3.4/33"),
func
Config:CSecurityGroupRuleConfig_invalidIPv6CIDR(rName),
...
Check: resource.ComposeAggregateTestCheck
func(
funcource.TestCheckResourceAttr(resource1Name, "cidr_blocks.0", "10.0.2.0/24"),
...
Check: resource.ComposeAggregateTestCheck
funcource.TestCheckResourceAttr(resource1Name, "cidr_blocks.#", "0"),
funcource.TestCheckResourceAttr(resource2Name, "cidr_blocks.#", "3"),
...
func(
	...
	resource.TestCheckResourceAttr(resourceName, "cidr_blocks.#", "0"),
	resource.TestCheckNoResourceAttr(resourceName, "description"),
funcource.TestCheckResourceAttr(resourceName, "ipv6_cidr_blocks.#", "0"),
funcource.TestCheckResourceAttr(resourceName, "prefix_list_ids.#", "0"),
	resource.TestCheckResourceAttrPair(resourceName, "security_group_id", sgResourceName, "id"),
	resource.TestCheckResourceAttrSet(resourceName, "security_group_rule_id"),
	resource.TestCheckResourceAttr(resourceName, "self", "false"),
...
func TestAccVPCSecurityGroupRule_prefixListEgress(t *testing.T) {
	...
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName := "aws_security_group_rule.test"
funceResourceName := "aws_vpc_endpoint.test"
...
funcource.TestCheckResourceAttrPair(resourceName, "security_group_id", sgResourceName, "id"),
	resource.TestCheckResourceAttrSet(resourceName, "security_group_rule_id"),
	resource.TestCheckResourceAttr(resourceName, "self", "false"),
	resource.TestCheckNoResourceAttr(resourceName, "source_security_group_id"),
	resource.TestCheckResourceAttr(resourceName, "to_port", "0"),
...
funcs: []resource.TestStep{
	{
Config:CSecurityGroupRuleConfig_prefixListEmptyString(rName),
...
Check: resource.ComposeAggregateTestCheck
func(
funcource.TestCheckResourceAttr(resourceName, "cidr_blocks.#", "1"),
	resource.TestCheckResourceAttr(resourceName, "cidr_blocks.0", "10.0.0.0/8"),
...
func(
	...
	resource.TestCheckResourceAttr(resourceName, "prefix_list_ids.#", "0"),
	resource.TestCheckResourceAttrPair(resourceName, "security_group_id", sgResourceName, "id"),
funcource.TestCheckResourceAttr(resourceName, "self", "false"),
	resource.TestCheckNoResourceAttr(resourceName, "source_security_group_id"),
	resource.TestCheckResourceAttr(resourceName, "to_port", "8000"),
	resource.TestCheckResourceAttr(resourceName, "type", "egress"),
),
...
func(
	...
	resource.TestCheckResourceAttr(resourceName, "cidr_blocks.#", "1"),
	resource.TestCheckResourceAttr(resourceName, "cidr_blocks.0", "10.0.0.0/8"),
funcource.TestCheckResourceAttr(resourceName, "from_port", "80"),
funcource.TestCheckResourceAttr(resourceName, "protocol", "tcp"),
	resource.TestCheckResourceAttr(resourceName, "prefix_list_ids.#", "0"),
	resource.TestCheckResourceAttrPair(resourceName, "security_group_id", sgResourceName, "id"),
	resource.TestCheckResourceAttr(resourceName, "self", "false"),
	resource.TestCheckNoResourceAttr(resourceName, "source_security_group_id"),
...
funcource.TestCheckResourceAttr(resourceName, "cidr_blocks.0", "10.0.0.0/8"),
	...
	resource.TestCheckResourceAttr(resourceName, "self", "false"),
	resource.TestCheckNoResourceAttr(resourceName, "source_security_group_id"),
funcource.TestCheckResourceAttr(resourceName, "type", "egress"),
),
	},
	{
...
CheckDestroy:stAccCheckSecurityGroupDestroy(ctx),
Steps: []resource.TestStep{
funcig: testAccVPCSecurityGroupRuleConfig_descriptionAllPorts(rName, "description1"),
func(
	testAccCheckSecurityGroupExists(ctx, sgResourceName, &group),
	resource.TestCheckResourceAttr(resourceName, "cidr_blocks.#", "1"),
...
Check: resource.ComposeAggregateTestCheck
functAccCheckSecurityGroupExists(ctx, sgResourceName, &group),
	resource.TestCheckResourceAttr(resourceName, "cidr_blocks.#", "1"),
	resource.TestCheckResourceAttr(resourceName, "cidr_blocks.0", "0.0.0.0/0"),
...
func(
	testAccCheckSecurityGroupExists(ctx, sgResourceName, &group),
	resource.TestCheckResourceAttr(resourceName, "cidr_blocks.#", "1"),
funcource.TestCheckResourceAttr(resourceName, "description", "description1"),
funcource.TestCheckResourceAttr(resourceName, "ipv6_cidr_blocks.#", "0"),
	resource.TestCheckResourceAttr(resourceName, "protocol", "-1"),
	resource.TestCheckResourceAttr(resourceName, "prefix_list_ids.#", "0"),
	resource.TestCheckResourceAttrPair(resourceName, "security_group_id", sgResourceName, "id"),
...
funcig: testAccVPCSecurityGroupRuleConfig_descriptionAllPortsNonZeroPorts(rName, "description2"),
Check: resource.ComposeAggregateTestCheck
func(
	testAccCheckSecurityGroupExists(ctx, sgResourceName, &group),
	resource.TestCheckResourceAttr(resourceName, "cidr_blocks.#", "1"),
	...
	resource.TestCheckResourceAttr(resourceName, "description", "description2"),
	resource.TestCheckResourceAttr(resourceName, "from_port", "0"),
funcource.TestCheckResourceAttr(resourceName, "protocol", "-1"),
	resource.TestCheckResourceAttr(resourceName, "prefix_list_ids.#", "0"),
	resource.TestCheckResourceAttrPair(resourceName, "security_group_id", sgResourceName, "id"),
	resource.TestCheckResourceAttr(resourceName, "self", "false"),
	resource.TestCheckNoResourceAttr(resourceName, "source_security_group_id"),
...
func TestAccVPCSecurityGroupRule_MultipleRuleSearching_allProtocolCrash(t *testing.T) {
	...
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resource1Name := "aws_security_group_rule.test1"
funcesourceName := "aws_security_group.test"
funcource.ParallelTest(t, resource.TestCase{
PreCheck:  
func() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, ec2.EndpointsID),
...
funcource.TestCheckResourceAttr(resource2Name, "protocol", "tcp"),
...
funcource.TestCheckResourceAttr(resource2Name, "ipv6_cidr_blocks.0", "::/0"),
...
funcource.TestCheckResourceAttr(resource3Name, "from_port", "22"),
...
funcource.TestCheckResourceAttr(resource3Name, "type", "ingress"),
),
	},
	{
ResourceName:Name,
...
func(
	testAccCheckSecurityGroupExists(ctx, sg1ResourceName, &group1),
funcource.TestCheckResourceAttr(resource1Name, "cidr_blocks.#", "1"),
funcource.TestCheckResourceAttr(resource1Name, "description", "CIDR Description"),
	resource.TestCheckResourceAttr(resource1Name, "from_port", "22"),
	resource.TestCheckResourceAttr(resource1Name, "ipv6_cidr_blocks.#", "0"),
	resource.TestCheckResourceAttr(resource1Name, "protocol", "tcp"),
	resource.TestCheckResourceAttr(resource1Name, "prefix_list_ids.#", "0"),
	resource.TestCheckResourceAttrPair(resource1Name, "security_group_id", sg1ResourceName, "id"),
	resource.TestCheckResourceAttrSet(resource1Name, "security_group_rule_id"),
funcource.TestCheckNoResourceAttr(resource1Name, "source_security_group_id"),
funcource.TestCheckResourceAttr(resource1Name, "type", "egress"),
	resource.TestCheckResourceAttr(resource2Name, "cidr_blocks.#", "0"),
	resource.TestCheckResourceAttr(resource2Name, "description", "IPv6 CIDR Description"),
	resource.TestCheckResourceAttr(resource2Name, "from_port", "22"),
	...
	resource.TestCheckResourceAttr(resource2Name, "protocol", "tcp"),
	resource.TestCheckResourceAttr(resource2Name, "prefix_list_ids.#", "0"),
funcource.TestCheckResourceAttrSet(resource2Name, "security_group_rule_id"),
	resource.TestCheckResourceAttr(resource2Name, "self", "false"),
	resource.TestCheckNoResourceAttr(resource2Name, "source_security_group_id"),
	resource.TestCheckResourceAttr(resource2Name, "to_port", "22"),
	...
	resource.TestCheckResourceAttrSet(resource3Name, "security_group_rule_id"),
	resource.TestCheckResourceAttr(resource3Name, "self", "false"),
funcource.TestCheckResourceAttr(resource3Name, "to_port", "22"),
...
funcource.TestCheckResourceAttrPair(resource4Name, "security_group_id", sg1ResourceName, "id"),
...
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
funcs: []resource.TestStep{
funcig: testAccVPCSecurityGroupRuleConfig_ingressMultipleIPv6(rName),
Check: resource.ComposeAggregateTestCheck
func(
	testAccCheckSecurityGroupExists(ctx, sgResourceName, &group),
	resource.TestCheckResourceAttr(resourceName, "cidr_blocks.#", "0"),
	resource.TestCheckNoResourceAttr(resourceName, "description"),
	resource.TestCheckResourceAttr(resourceName, "from_port", "80"),
funcource.TestCheckResourceAttr(resourceName, "ipv6_cidr_blocks.0", "2001:db8:85a3::/64"),
funcource.TestCheckResourceAttr(resourceName, "protocol", "tcp"),
	resource.TestCheckResourceAttr(resourceName, "prefix_list_ids.#", "0"),
	resource.TestCheckResourceAttrPair(resourceName, "security_group_id", sgResourceName, "id"),
...
func := acctest.Context(t)
	...
	resource.ParallelTest(t, resource.TestCase{
func() { acctest.PreCheck(ctx, t); acctest.PreCheckAlternateAccount(t) },
...
func(
	...
	resource.TestCheckResourceAttr(resourceName, "protocol", "tcp"),
	resource.TestCheckResourceAttr(resourceName, "type", "ingress"),
funcource.TestCheckResourceAttr(resourceName2, "protocol", "tcp"),
func
	},
},
	})
...
funcocol := rs.Primary.Attributes["protocol"]
...
funcCIDRs, err := testAccSecurityGroupRuleImportGetAttrs(rs.Primary.Attributes, "ipv6_cidr_blocks")
if err != nil {
	return "", err
}
...
resource "aws_security_group_rule" "test3" {
  security_group_idecurity_group.test[0].id
...
funcscriptionx List Description"
  type
  protocol = "tcp"
  from_port= 22
  to_port  = 22
  prefix_list_idsaws_vpc_endpoint.test.prefix_list_id]
}
`, rName, ruleType))
	}
...
resource "aws_security_group_rule" "test1" {
  ...
  security_group_idecurity_group.test[1].id
}
...
funccurity_group_id = aws_security_group.test.id
}
`, rName)
}
...
resource "aws_security_group_rule" "test_egress" {
  ...
  from_port= count.index
  to_port  = count.index
funcdr_blocks.0.${count.index}/32"]
}
`, rName, n)
}
...
funcurce "aws_security_group_rule" "test" {
  types"
  from_port = 0
  to_port
  protocol  = "-1"
