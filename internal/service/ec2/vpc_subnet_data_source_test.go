...
funcource.TestCheckResourceAttrPair(ds1ResourceName, "availability_zone", snResourceName, "availability_zone"),
...
Steps: []resource.TestStep{
funcig: testAccVPCSubnetDataSourceConfig_ipv6(rName, rInt),
	},
	{
...
funcig: testAccVPCSubnetDataSourceConfig_ipv6IPv6CIDRBlock(rName, rInt),
Check: resource.ComposeAggregateTestCheck
func(
	resource.TestCheckResourceAttrSet("data.aws_subnet.by_ipv6_cidr", "ipv6_cidr_block_association_id"),
),
