...
func testAccCheckTrafficMirrorFilterDestroy(ctx context.Context) resource.TestCheck
func {
	return 
...
func testAccCheckTrafficMirrorFilterExists(ctx context.Context, n string, v *ec2.TrafficMirrorFilter) resource.TestCheck
func {
	return 
func(s *terraform.State) error {
