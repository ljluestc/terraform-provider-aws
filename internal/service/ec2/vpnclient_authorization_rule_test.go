...
funcource.TestCheckResourceAttr(resourceName, "authorize_all_groups", "true"),
...
funcource.TestCheckResourceAttr(resource1Name, "authorize_all_groups", "false"),
...
func(
	...
	testAccCheckClientVPNAuthorizationRuleExists(ctx, resource2Name, &v),
funcource.TestCheckResourceAttr(resource2Name, "authorize_all_groups", "true"),
