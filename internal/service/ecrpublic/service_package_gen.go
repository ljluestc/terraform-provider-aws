// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package ecrpublicimport (
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*ecrpublic_sdkv1.ECRPublic, error) {
	sess := config["session"].(*session_sdkv1.Session)	return ecrpublic_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
