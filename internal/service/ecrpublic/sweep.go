...
// +build sweeppackage ecrpublicimport (
"fmt"
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.DescribeRepositoriesPagesWithContext(ctx, input, func(page *ecrpublic.DescribeRepositoriesOutput, lastPage bool) bool {
if page == nil {
return !lastPage
