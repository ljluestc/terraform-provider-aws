...
func (p *servicePackage) ListTags(ctx context.Context, meta any, identifier string) error {
	tags, err := listTags(ctx, meta.(*conns.AWSClient).ECRPublicConn(ctx), identifier)	if err != nil {
turn err
	}	if inContext, ok := tftags.FromContext(ctx); ok {
Context.TagsOut = types.Some(tags)
	}	return nil
}// []*SERVICE.Tag handling// Tags returns ecrpublic service tags.
func Tags(tags tftags.KeyValueTags) []*ecrpublic.Tag {
	result := make([]*ecrpublic.Tag, 0, len(tags))	for k, v := range tags.Map() {
g := &ecrpublic.Tag{
Key:aws.String(k),
Value: aws.String(v),
...
put := &ecrpublic.UntagResourceInput{
ResourceArn: aws.String(identifier),
...
put := &ecrpublic.TagResourceInput{
ResourceArn: aws.String(identifier),
Tags:
