...
registerInstancesFromLoadBalancer",
registerTargets",
scribe*",
gisterInstancesWithLoadBalancer",
gisterTargets"
],
"Resource": "*"
}
...
Name = %[1]q
  ...
  name = %[1]q  dns_config {
namespace_id = aws_service_discovery_private_dns_namespace.test.iddns_records {
ttl  = 5
type = "SRV"
}
  }
...
DEFINITION
  ...
  desired_count= 1  service_connect_configuration {
enabled= true
namespace = aws_service_discovery_http_namespace.test.arnlog_configuration {
...
enabled= true
namespace = aws_service_discovery_http_namespace.test.arnservice {
client_alias {
