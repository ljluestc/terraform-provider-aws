...
functestAccErrorCheckSkip(t*testing.T)resource.ErrorCheckFunc{
	returnacctest.ErrorCheckSkipMessagesContaining(t,
		"isnotsupporedinthisregion",
	)
}
funcTestAccElastiCacheCluster_Engine_memcached(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_Engine_redis(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_Engine_redis_v5(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_Engine_None(t*testing.T){
	ctx:=acctest.Context(t)
		...
		Steps:[]resource.TestStep{
			{
				...
				//Verify"ExactlyOneOf"intheschemafor"engine"and"replication_group_id"
				//throwsaplan-timeerrorwhenneitherareconfigured.
				ExpectError:regexache.MustCompile(`Invalidcombinationofarguments`),
			},
		},
	})
}
funcTestAccElastiCacheCluster_PortRedis_default(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_ParameterGroupName_default(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_ipDiscovery(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_port(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_snapshotsWithUpdates(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_NumCacheNodes_decrease(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_NumCacheNodes_increase(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_NumCacheNodes_increaseWithPreferredAvailabilityZones(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_vpc(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varcsgelasticache.CacheSubnetGroup
	varecelasticache.CacheCluster
	rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)	resource.ParallelTest(t,resource.TestCase{
		PreCheck:
func(){acctest.PreCheck(ctx,t)},
...
funcTestAccElastiCacheCluster_multiAZInVPC(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varcsgelasticache.CacheSubnetGroup
...
funcTestAccElastiCacheCluster_AZMode_memcached(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varclusterelasticache.CacheCluster
	rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName:="aws_elasticache_cluster.test"	resource.ParallelTest(t,resource.TestCase{
		PreCheck:
func(){acctest.PreCheck(ctx,t)},
		...
		Steps:[]resource.TestStep{
			{
				...
				ExpectError:regexache.MustCompile(`expectedaz_modetobeoneof.*,gotunknown`),
			},
			{
				Config:testAccClusterConfig_azModeMemcached(rName,"cross-az"),
				ExpectError:regexache.MustCompile(`az_mode"cross-az"isnotsupportedwithnum_cache_nodes=1`),
			},
			{
...
funcTestAccElastiCacheCluster_AZMode_redis(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varclusterelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_EngineVersion_memcached(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varpre,mid,postelasticache.CacheCluster
	rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName:="aws_elasticache_cluster.test"	resource.ParallelTest(t,resource.TestCase{
		PreCheck:
func(){acctest.PreCheck(ctx,t)},
...
funcTestAccElastiCacheCluster_EngineVersion_redis(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varv1,v2,v3,v4,v5,v6,v7,v8elasticache.CacheCluster
	rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName:="aws_elasticache_cluster.test"	resource.ParallelTest(t,resource.TestCase{
		PreCheck:
func(){acctest.PreCheck(ctx,t)},
...
funcTestAccElastiCacheCluster_NodeTypeResize_memcached(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varpre,postelasticache.CacheCluster
	rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName:="aws_elasticache_cluster.test"	resource.ParallelTest(t,resource.TestCase{
		PreCheck:
func(){acctest.PreCheck(ctx,t)},
...
funcTestAccElastiCacheCluster_NodeTypeResize_redis(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varpre,postelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_NumCacheNodes_redis(t*testing.T){
	ctx:=acctest.Context(t)
	rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)	resource.ParallelTest(t,resource.TestCase{
		PreCheck:
func(){acctest.PreCheck(ctx,t)},
		...
		Steps:[]resource.TestStep{
			{
				...
				ExpectError:regexache.MustCompile(`engine"redis"doesnotsupportnum_cache_nodes>1`),
			},
		},
	})
}
funcTestAccElastiCacheCluster_ReplicationGroupID_availabilityZone(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varclusterelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_ReplicationGroupID_singleReplica(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varclusterelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_ReplicationGroupID_multipleReplica(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varcluster1,cluster2elasticache.CacheCluster
	varreplicationGroupelasticache.ReplicationGroup
	rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
funcTestAccElastiCacheCluster_Memcached_finalSnapshot(t*testing.T){
	ctx:=acctest.Context(t)
	rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)	resource.ParallelTest(t,resource.TestCase{
		PreCheck:
func(){acctest.PreCheck(ctx,t)},
		...
		Steps:[]resource.TestStep{
			{
				...
				ExpectError:regexache.MustCompile(`engine"memcached"doesnotsupportfinal_snapshot_identifier`),
			},
		},
	})
}
funcTestAccElastiCacheCluster_Redis_finalSnapshot(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varclusterelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_Redis_autoMinorVersionUpgrade(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varclusterelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_Engine_Redis_LogDeliveryConfigurations(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_tags(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varclusterelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_tagWithOtherModification(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varclusterelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_TransitEncryption(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}
		...
		Steps:[]resource.TestStep{
			{
				...
				ExpectError:regexache.MustCompile(`Transitencryptionisnotsupportedformemcachedversion1.6.11`),
			},
			{
				Config:testAccClusterConfig_transitEncryption(rName,"redis","6.2"),
				ExpectError:regexache.MustCompile(`aws_elasticache_clusterdoesnotsupporttransitencryptionusingtheredisengine,useaws_elasticache_replication_groupinstead`),
			},
			{
...
funcTestAccElastiCacheCluster_outpost_memcached(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_outpost_redis(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varecelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_outpostID_memcached(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varpre,postelasticache.CacheCluster
...
funcTestAccElastiCacheCluster_outpostID_redis(t*testing.T){
	ctx:=acctest.Context(t)
	iftesting.Short(){
		t.Skip("skippinglong-runningtestinshortmode")
	}	varpre,postelasticache.CacheCluster
...
functestAccCheckClusterAttributes(v*elasticache.CacheCluster)resource.TestCheckFunc{
	return
func(s*terraform.State)error{
		ifv.NotificationConfiguration==nil{
			returnfmt.Errorf("ExpectedNotificationConfigurationforElastiCacheCluster(%s)",*v.CacheClusterId)
		}		ifstrings.ToLower(*v.NotificationConfiguration.TopicStatus)!="active"{
			returnfmt.Errorf("ExpectedNotificationConfigurationstatustobe'active',got(%s)",*v.NotificationConfiguration.TopicStatus)
		}		returnnil
	}
}
functestAccCheckClusterReplicationGroupIDAttribute(cluster*elasticache.CacheCluster,replicationGroup*elasticache.ReplicationGroup)resource.TestCheckFunc{
	return
func(s*terraform.State)error{
		ifcluster.ReplicationGroupId==nil{
			returnerrors.New("expectedclusterReplicationGroupIdtobeset")
		}		ifaws.StringValue(cluster.ReplicationGroupId)!=aws.StringValue(replicationGroup.ReplicationGroupId){
			returnerrors.New("expectedclusterReplicationGroupIdtoequalreplicationgroupID")
		}		returnnil
	}
}
functestAccCheckClusterNotRecreated(i,j*elasticache.CacheCluster)resource.TestCheckFunc{
	return
func(s*terraform.State)error{
		if!aws.TimeValue(i.CacheClusterCreateTime).Equal(aws.TimeValue(j.CacheClusterCreateTime)){
			returnerrors.New("ElastiCacheClusterwasrecreated")
		}		returnnil
	}
}
functestAccCheckClusterRecreated(i,j*elasticache.CacheCluster)resource.TestCheckFunc{
	return
func(s*terraform.State)error{
		ifaws.TimeValue(i.CacheClusterCreateTime).Equal(aws.TimeValue(j.CacheClusterCreateTime)){
			returnerrors.New("ElastiCacheClusterwasnotrecreated")
		}		returnnil
	}
}
functestAccCheckClusterDestroy(ctxcontext.Context)resource.TestCheckFunc{
	return
func(s*terraform.State)error{
		conn:=acctest.Provider.Meta().(*conns.AWSClient).ElastiCacheConn(ctx)		for_,rs:=ranges.RootModule().Resources{
			ifrs.Type!="aws_elasticache_cluster"{
				continue
			}			_,err:=tfelasticache.FindCacheClusterByID(ctx,conn,rs.Primary.ID)			iftfresource.NotFound(err){
				continue
			}			iferr!=nil{
				returnerr
			}			returnfmt.Errorf("ElastiCacheCluster%sstillexists",rs.Primary.ID)
		}
		returnnil
	}
}
functestAccCheckClusterExists(ctxcontext.Context,nstring,v*elasticache.CacheCluster)resource.TestCheckFunc{
	return
func(s*terraform.State)error{
		...
		if!ok{
			...
			returnfmt.Errorf("NoElastiCacheClusterIDisset")
		}		conn:=acctest.Provider.Meta().(*conns.AWSClient).ElastiCacheConn(ctx)		output,err:=tfelasticache.FindCacheClusterByID(ctx,conn,rs.Primary.ID)		iferr!=nil{
			returnerr
		}		*v=*output		returnnil
	}
}
functestAccClusterConfig_engineMemcached(rNamestring)string{
	returnfmt.Sprintf(`
...
functestAccClusterConfig_engineRedis(rNamestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
engine="redis"
...
functestAccClusterConfig_engineRedisV5(rNamestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
...
functestAccClusterConfig_engineNone(rNamestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
node_type="cache.t3.small"
...
functestAccClusterConfig_outpost_memcached(rNamestring,outpostIDint)string{
...
functestAccClusterConfig_outpost_redis(rNamestring,outpostIDint)string{
	returnacctest.ConfigCompose(acctest.ConfigVPCWithSubnets(rName,1),fmt.Sprintf(`
data"aws_outposts_outposts""test"{}data"aws_outposts_outpost""test"{
id=tolist(data.aws_outposts_outposts.test.ids)[%[2]d]
}resource"aws_elasticache_subnet_group""test"{
...
functestAccClusterConfig_parameterGroupName(rName,engine,engineVersion,parameterGroupNamestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
engine=%[2]q
...
functestAccClusterConfig_ipDiscovery(rName,ipDiscovery,networkTypestring)string{
	returnacctest.ConfigCompose(acctest.ConfigVPCWithSubnetsIPv6(rName,1),fmt.Sprintf(`
resource"aws_elasticache_subnet_group""test"{
name=%[1]q
description=%[1]q
subnet_ids=aws_subnet.test[*].id
...
functestAccClusterConfig_port(rNamestring,portint)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
engine="memcached"
...
functestAccClusterConfig_snapshots(rNamestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
engine="redis"
...
functestAccClusterConfig_snapshotsUpdated(rNamestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
engine="redis"
...
functestAccClusterConfig_numCacheNodes(rNamestring,numCacheNodesint)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
apply_immediately=true
cluster_id=%[1]q
...
functestAccClusterConfig_numCacheNodesPreferredAvailabilityZones(rNamestring,numCacheNodesint)string{
	preferredAvailabilityZones:=make([]string,numCacheNodes)
	fori:=rangepreferredAvailabilityZones{
...
functestAccClusterConfig_inVPC(rNamestring)string{
	returnacctest.ConfigCompose(acctest.ConfigVPCWithSubnets(rName,1),fmt.Sprintf(`
resource"aws_elasticache_subnet_group""test"{
name=%[1]q
description=%[1]q
...
#Includinguppercaselettersinthisnametoensure
#thatwecorrectlyhandlethefactthattheAPI
#normalizesnamestolowercase.
cluster_id=%[1]q
node_type="cache.t3.small"
num_cache_nodes=1
engine="redis"
...
functestAccClusterConfig_multiAZInVPC(rNamestring)string{
	returnacctest.ConfigCompose(acctest.ConfigVPCWithSubnets(rName,2),fmt.Sprintf(`
resource"aws_elasticache_subnet_group""test"{
name=%[1]q
description=%[1]q
subnet_ids=aws_subnet.test[*].id
...
functestAccClusterConfig_redisDefaultPort(rNamestring)string{
	returnfmt.Sprintf(`
resource"aws_security_group""test"{
name=%[1]q
description=%[1]qtags={
...
functestAccClusterConfig_azModeMemcached(rName,azModestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
apply_immediately=true
az_mode=%[2]q
...
functestAccClusterConfig_azModeRedis(rName,azModestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
apply_immediately=true
az_mode=%[2]q
...
functestAccClusterConfig_engineVersionMemcached(rName,engineVersionstring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
apply_immediately=true
cluster_id=%[1]q
...
functestAccClusterConfig_engineVersionRedis(rName,engineVersionstring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
apply_immediately=true
cluster_id=%[1]q
...
functestAccClusterConfig_nodeTypeMemcached(rName,nodeTypestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
apply_immediately=true
cluster_id=%[1]q
...
functestAccClusterConfig_nodeTypeRedis(rName,nodeTypestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
apply_immediately=true
cluster_id=%[1]q
...
functestAccClusterConfig_numCacheNodesRedis(rNamestring,numCacheNodesint)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
apply_immediately=true
cluster_id=%[1]q
...
functestAccClusterConfig_replicationGroupIDAvailabilityZone(rNamestring)string{
	returnacctest.ConfigCompose(acctest.ConfigAvailableAZsNoOptIn(),fmt.Sprintf(`
resource"aws_elasticache_replication_group""test"{
description="TerraformAcceptanceTesting"
...
functestAccClusterConfig_replicationGroupIDReplica(rNamestring,countint)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_replication_group""test"{
description="TerraformAcceptanceTesting"
replication_group_id=%[1]q
...
functestAccClusterConfig_memcachedFinalSnapshot(rNamestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
engine="memcached"
...
functestAccClusterConfig_redisFinalSnapshot(rNamestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
engine="redis"
...
functestAccClusterConfig_redisAutoMinorVersionUpgrade(rNamestring,enablebool)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
engine="redis"
...
functestAccClusterConfig_dataSourceEngineRedisLogDeliveryConfigurations(rNamestring,slowLogDeliveryEnabledbool,slowDeliveryDestinationstring,slowDeliveryFormatstring,engineLogDeliveryEnabledbool,engineDeliveryDestinationstring,engineLogDeliveryFormatstring)string{
	returnfmt.Sprintf(`
...
functestAccClusterConfig_tags1(rName,tag1Key,tag1Valuestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
engine="memcached"
...
functestAccClusterConfig_tags2(rName,tag1Key,tag1Value,tag2Key,tag2Valuestring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
engine="memcached"
...
functestAccClusterConfig_versionAndTag(rName,version,tagKey1,tagValue1string)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
cluster_id=%[1]q
node_type="cache.t3.small"
...
functestAccClusterConfig_transitEncryption(rName,engine,versionstring)string{
	returnfmt.Sprintf(`
resource"aws_elasticache_cluster""test"{
apply_immediately=true
cluster_id="%[1]s"
