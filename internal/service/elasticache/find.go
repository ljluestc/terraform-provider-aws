...
)// FindReplicationGroupByID retrieves an ElastiCache Replication Group by id.func FindReplicationGroupByID(ctx context.Context, conn *elasticache.ElastiCache, id string) (*elasticache.ReplicationGroup, error) {
...
}// FindReplicationGroupMemberClustersByID retrieves all of an ElastiCache Replication Group's MemberClusters by the id of the Replication Group.func FindReplicationGroupMemberClustersByID(ctx context.Context, conn *elasticache.ElastiCache, id string) ([]*elasticache.CacheCluster, error) {
...
}// FindCacheClusterByID retrieves an ElastiCache Cache Cluster by id.func FindCacheClusterByID(ctx context.Context, conn *elasticache.ElastiCache, id string) (*elasticache.CacheCluster, error) {
	input := &elasticache.DescribeCacheClustersInput{
		CacheClusterId: aws.String(id),
	}
	return FindCacheCluster(ctx, conn, input)
}// FindCacheClusterWithNodeInfoByID retrieves an ElastiCache Cache Cluster with Node Info by id.func FindCacheClusterWithNodeInfoByID(ctx context.Context, conn *elasticache.ElastiCache, id string) (*elasticache.CacheCluster, error) {
	input := &elasticache.DescribeCacheClustersInput{
		CacheClusterId: aws.String(id),
		ShowCacheNodeInfo: aws.Bool(true),
	}
	return FindCacheCluster(ctx, conn, input)
}// FindCacheCluster retrieves an ElastiCache Cache Cluster using DescribeCacheClustersInput.func FindCacheCluster(ctx context.Context, conn *elasticache.ElastiCache, input *elasticache.DescribeCacheClustersInput) (*elasticache.CacheCluster, error) {
...
// Order of the clusters is not guaranteed.func FindCacheClustersByID(ctx context.Context, conn *elasticache.ElastiCache, idList []string) ([]*elasticache.CacheCluster, error) {
...
}// FindGlobalReplicationGroupByID retrieves an ElastiCache Global Replication Group by id.func FindGlobalReplicationGroupByID(ctx context.Context, conn *elasticache.ElastiCache, id string) (*elasticache.GlobalReplicationGroup, error) {
...
}// FindGlobalReplicationGroupMemberByID retrieves a member Replication Group by id from a Global Replication Group.func FindGlobalReplicationGroupMemberByID(ctx context.Context, conn *elasticache.ElastiCache, globalReplicationGroupID string, id string) (*elasticache.GlobalReplicationGroupMember, error) {
...
func FindParameterGroupByName(ctx context.Context, conn *elasticache.ElastiCache, name string) (*elasticache.CacheParameterGroup, error) {
	...
	}	output, err := conn.DescribeCacheParameterGroupsWithContext(ctx, &input)	if tfawserr.ErrCodeEquals(err, elasticache.ErrCodeCacheParameterGroupNotFoundFault) {
		return nil, &retry.NotFoundError{
			LastError:err,
			LastRequest: input,
		}
...
func FindCacheSubnetGroupByName(ctx context.Context, conn *elasticache.ElastiCache, name string) (*elasticache.CacheSubnetGroup, error) {
	...
	}	output, err := conn.DescribeCacheSubnetGroupsWithContext(ctx, &input)	if tfawserr.ErrCodeEquals(err, elasticache.ErrCodeCacheSubnetGroupNotFoundFault) {
		return nil, &retry.NotFoundError{
			LastError:err,
			LastRequest: input,
		}
