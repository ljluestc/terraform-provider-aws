...
func TestAccElastiCacheGlobalReplicationGroup_basic(t *testing.T) {
	...
	var pg elasticache.CacheParameterGroup	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	primaryReplicationGroupId := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)	resourceName := "aws_elasticache_global_replication_group.test"
	primaryReplicationGroupResourceName := "aws_elasticache_replication_group.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t); testAccPreCheckGlobalReplicationGroup(ctx, t) },
...
func TestAccElastiCacheGlobalReplicationGroup_disappears(t *testing.T) {
	...
	resourceName := "aws_elasticache_global_replication_group.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t); testAccPreCheckGlobalReplicationGroup(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, elasticache.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func TestAccElastiCacheGlobalReplicationGroup_clusterMode_basic(t *testing.T) {
	...
	var primaryReplicationGroup elasticache.ReplicationGroup	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)	resourceName := "aws_elasticache_global_replication_group.test"
	primaryReplicationGroupResourceName := "aws_elasticache_replication_group.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t); testAccPreCheckGlobalReplicationGroup(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, elasticache.EndpointsID),
...
func TestAccElastiCacheGlobalReplicationGroup_SetEngineVersionOnCreate_MinorUpgrade(t *testing.T) {
	...
	var rg elasticache.ReplicationGroup	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	primaryReplicationGroupId := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName := "aws_elasticache_global_replication_group.test"
	primaryReplicationGroupResourceName := "aws_elasticache_replication_group.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
...
func TestAccElastiCacheGlobalReplicationGroup_SetEngineVersionOnCreate_MinorDowngrade(t *testing.T) {
	...
	primaryReplicationGroupId := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t); testAccPreCheckGlobalReplicationGroup(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, elasticache.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func TestAccElastiCacheGlobalReplicationGroup_SetParameterGroupOnUpdate_NoVersion(t *testing.T) {
	...
	if testing.Short() {
		t.Skip("skipping long-running test in short mode")
	}	var globalReplicationGroup elasticache.GlobalReplicationGroup	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	primaryReplicationGroupId := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)	resourceName := "aws_elasticache_global_replication_group.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t); testAccPreCheckGlobalReplicationGroup(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, elasticache.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func TestAccElastiCacheGlobalReplicationGroup_UpdateParameterGroupName(t *testing.T) {
	...
	primaryReplicationGroupId := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	parameterGroupName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)	resourceName := "aws_elasticache_global_replication_group.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t); testAccPreCheckGlobalReplicationGroup(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, elasticache.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func testAccPreCheckGlobalReplicationGroup(ctx context.Context, t *testing.T) {
	conn := acctest.Provider.Meta().(*conns.AWSClient).ElastiCacheConn(ctx)	input := &elasticache.DescribeGlobalReplicationGroupsInput{}
	_, err := conn.DescribeGlobalReplicationGroupsWithContext(ctx, input)	if acctest.PreCheckSkipError(err) ||
...
func testAccMatchReplicationGroupActualVersion(ctx context.Context, j *elasticache.ReplicationGroup, r *regexp.Regexp) resource.TestCheckFunc {
	return 
func(s *terraform.State) error {
		conn := acctest.Provider.Meta().(*conns.AWSClient).ElastiCacheConn(ctx)		cacheCluster := j.NodeGroups[0].NodeGroupMembers[0]
...
replication_group_id = %[2]q
description = "test"node_type = "cache.m5.large"engine= "redis"
engine_version= "5.0.6"
num_cache_clusters = 2automatic_failover_enabled = %[3]s
}
...
resource "aws_elasticache_global_replication_group" "test" {
global_replication_group_id_suffix = %[1]q
primary_replication_group_id = aws_elasticache_replication_group.test.idglobal_replication_group_description = %[3]q
}resource "aws_elasticache_replication_group" "test" {
replication_group_id = %[2]q
description = "test"engine= "redis"
engine_version= "5.0.6"
...
resource "aws_elasticache_global_replication_group" "test" {
global_replication_group_id_suffix = %[1]q
primary_replication_group_id = aws_elasticache_replication_group.test.idautomatic_failover_enabled = %[3]s
}resource "aws_elasticache_replication_group" "test" {
replication_group_id = %[2]q
description = "test"node_type = "cache.m5.large"engine= "redis"
engine_version= "5.0.6"
...
resource "aws_elasticache_global_replication_group" "test" {
global_replication_group_id_suffix = %[1]q
primary_replication_group_id = aws_elasticache_replication_group.test.idautomatic_failover_enabled = %[4]s
}resource "aws_elasticache_replication_group" "test" {
replication_group_id = %[2]q
description = "test"node_type = "cache.m5.large"engine= "redis"
engine_version= "5.0.6"
num_cache_clusters = 2automatic_failover_enabled = %[3]slifecycle {
...
func testAccGlobalReplicationGroupConfig_multipleSecondaries(rName string) string {
	return acctest.ConfigCompose(
		...
		fmt.Sprintf(`
resource "aws_elasticache_global_replication_group" "test" {
provider = awsglobal_replication_group_id_suffix = %[1]q
primary_replication_group_id = aws_elasticache_replication_group.primary.id
}resource "aws_elasticache_replication_group" "primary" {
provider = awsreplication_group_id = "%[1]s-p"
description = "primary"subnet_group_name = aws_elasticache_subnet_group.primary.namenode_type = "cache.m5.large"engine= "redis"
engine_version= "5.0.6"
num_cache_clusters = 1
}resource "aws_elasticache_replication_group" "alternate" {
provider = awsalternatereplication_group_id= "%[1]s-a"
description = "alternate"
global_replication_group_id = aws_elasticache_global_replication_group.test.global_replication_group_idsubnet_group_name = aws_elasticache_subnet_group.alternate.namenum_cache_clusters = 1
}resource "aws_elasticache_replication_group" "third" {
provider = awsthirdreplication_group_id= "%[1]s-t"
description = "third"
global_replication_group_id = aws_elasticache_global_replication_group.test.global_replication_group_idsubnet_group_name = aws_elasticache_subnet_group.third.namenum_cache_clusters = 1
}
`, rName))
}
...
provider = awsalternatereplication_group_id= "%[1]s-a"
description = "alternate"
global_replication_group_id = aws_elasticache_global_replication_group.test.global_replication_group_idsubnet_group_name = aws_elasticache_subnet_group.secondary.namenum_cache_clusters = 1
}
`, rName))
}
...
description = "test"engine= "redis"
engine_version = "6.2"
node_type= "cache.m5.large"parameter_group_name = "default.redis6.x.cluster.on"
...
automatic_failover_enabled = true
num_node_groups= %[2]d
replicas_per_node_group = 1lifecycle {
...
resource "aws_elasticache_global_replication_group" "test" {
global_replication_group_id_suffix = %[1]q
primary_replication_group_id = aws_elasticache_replication_group.test.idnum_node_groups = %[3]d
}resource "aws_elasticache_replication_group" "test" {
replication_group_id = %[1]q
description = "test"engine= "redis"
engine_version = "6.2"
...
resource "aws_elasticache_global_replication_group" "test" {
global_replication_group_id_suffix = %[1]q
primary_replication_group_id = aws_elasticache_replication_group.test.idengine_version = %[4]q
}resource "aws_elasticache_replication_group" "test" {
replication_group_id = %[2]q
description = "test"engine= "redis"
engine_version= %[3]q
...
resource "aws_elasticache_global_replication_group" "test" {
global_replication_group_id_suffix = %[1]q
primary_replication_group_id = aws_elasticache_replication_group.test.idparameter_group_name = %[4]q
}resource "aws_elasticache_replication_group" "test" {
replication_group_id = %[2]q
description = "test"engine= "redis"
engine_version= %[3]q
...
provider = %[2]sstate = "available"filter {
 name= "opt-in-status"
