...
funcTestAccElastiCacheReplicationGroupDataSource_basic(t*testing.T){
...
funcTestAccElastiCacheReplicationGroupDataSource_clusterMode(t*testing.T){
ctx:=acctest.Context(t)
iftesting.Short(){
t.Skip("skippinglong-runningtestinshortmode")
}rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
funcTestAccElastiCacheReplicationGroupDataSource_multiAZ(t*testing.T){
ctx:=acctest.Context(t)
iftesting.Short(){
t.Skip("skippinglong-runningtestinshortmode")
}rName:=sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
funcTestAccElastiCacheReplicationGroupDataSource_nonExistent(t*testing.T){
ctx:=acctest.Context(t)
...
funcTestAccElastiCacheReplicationGroupDataSource_Engine_Redis_LogDeliveryConfigurations(t*testing.T){
ctx:=acctest.Context(t)
iftesting.Short(){
t.Skip("skippinglong-runningtestinshortmode")
...
functestAccReplicationGroupDataSourceConfig_basic(rNamestring)string{
returnacctest.ConfigAvailableAZsNoOptIn()+fmt.Sprintf(`
...
functestAccReplicationGroupDataSourceConfig_clusterMode(rNamestring)string{
returnfmt.Sprintf(`
resource"aws_elasticache_replication_group""test"{
replication_group_id=%[1]q
description="testdescription"
...
functestAccReplicationGroupDataSourceConfig_multiAZ(rNamestring)string{
returnfmt.Sprintf(`
resource"aws_elasticache_replication_group""test"{
replication_group_id=%[1]q
description="testdescription"
...
`,rName)
}consttestAccReplicationGroupDataSourceConfig_nonExistent=`
data"aws_elasticache_replication_group""test"{
