...
)//StatusReplicationGroupfetchestheReplicationGroupanditsStatusfuncStatusReplicationGroup(ctxcontext.Context,conn*elasticache.ElastiCache,replicationGroupIDstring)retry.StateRefreshFunc{
return
...
iferr!=nil{
returnnil,"",err
}returnrg,aws.StringValue(rg.Status),nil
}
}//StatusReplicationGroupMemberClustersfetchestheReplicationGroup'sMemberClustersandeither"available"orthefirstnon-"available"status.
//NOTE:This
functionassumesthattheintendedend-stateistohaveallmemberclustersin"available"status.funcStatusReplicationGroupMemberClusters(ctxcontext.Context,conn*elasticache.ElastiCache,replicationGroupIDstring)retry.StateRefreshFunc{
return
func()(interface{},string,error){
...
for_,v:=rangeclusters{
clusterStatus:=aws.StringValue(v.CacheClusterStatus)
ifclusterStatus!=CacheClusterStatusAvailable{
status=clusterStatus
break
}
}
returnclusters,status,nil
}
}const(
...
CacheClusterStatusRebootingClusterNodes="rebootingclusternodes"
CacheClusterStatusRestoreFailed="restore-failed"
CacheClusterStatusSnapshotting="snapshotting"
)//StatusCacheClusterfetchestheCacheClusteranditsStatusfuncStatusCacheCluster(ctxcontext.Context,conn*elasticache.ElastiCache,cacheClusterIDstring)retry.StateRefreshFunc{
return
func()(interface{},string,error){
...
iferr!=nil{
returnnil,"",err
}returnc,aws.StringValue(c.CacheClusterStatus),nil
}
}const(
...
)//statusGlobalReplicationGroupfetchestheGlobalReplicationGroupanditsStatusfuncstatusGlobalReplicationGroup(ctxcontext.Context,conn*elasticache.ElastiCache,globalReplicationGroupIDstring)retry.StateRefreshFunc{
return
func()(interface{},string,error){
...
iferr!=nil{
returnnil,"",err
}returngrg,aws.StringValue(grg.Status),nil
}
}const(
GlobalReplicationGroupMemberStatusAssociated="associated"
)//statusGlobalReplicationGroupMemberfetchesaGlobalReplicationGroupMemberanditsStatusfuncstatusGlobalReplicationGroupMember(ctxcontext.Context,conn*elasticache.ElastiCache,globalReplicationGroupID,idstring)retry.StateRefreshFunc{
return
func()(interface{},string,error){
...
iferr!=nil{
returnnil,"",err
}returnmember,aws.StringValue(member.Status),nil
}
}
