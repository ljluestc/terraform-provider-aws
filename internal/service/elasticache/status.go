...
)// StatusReplicationGroup fetches the Replication Group and its Statusfunc StatusReplicationGroup(ctx context.Context, conn *elasticache.ElastiCache, replicationGroupID string) retry.StateRefreshFunc {
	return 
...
// NOTE: This 
function assumes that the intended end-state is to have all member clusters in "available" status.func StatusReplicationGroupMemberClusters(ctx context.Context, conn *elasticache.ElastiCache, replicationGroupID string) retry.StateRefreshFunc {
	return 
func() (interface{}, string, error) {
...
)// StatusCacheCluster fetches the Cache Cluster and its Statusfunc StatusCacheCluster(ctx context.Context, conn *elasticache.ElastiCache, cacheClusterID string) retry.StateRefreshFunc {
	return 
func() (interface{}, string, error) {
...
)// statusGlobalReplicationGroup fetches the Global Replication Group and its Statusfunc statusGlobalReplicationGroup(ctx context.Context, conn *elasticache.ElastiCache, globalReplicationGroupID string) retry.StateRefreshFunc {
	return 
func() (interface{}, string, error) {
...
)// statusGlobalReplicationGroupMember fetches a Global Replication Group Member and its Statusfunc statusGlobalReplicationGroupMember(ctx context.Context, conn *elasticache.ElastiCache, globalReplicationGroupID, id string) retry.StateRefreshFunc {
	return 
func() (interface{}, string, error) {
