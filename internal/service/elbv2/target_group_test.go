...
func TestAccELBV2TargetGroup_backwardsCompatibility(t *testing.T) {
	...
	resourceName := "aws_alb_target_group.test"	resource.ParallelTest(t, resource.TestCase{
PreCheck:  
...
func TestAccELBV2TargetGroup_ProtocolVersion_basic(t *testing.T) {
	...
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName := "aws_lb_target_group.test"	resource.ParallelTest(t, resource.TestCase{
PreCheck:  
func() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, elbv2.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func TestAccELBV2TargetGroup_ALBAlias_missingPortProtocolVPC(t *testing.T) {
	ctx := acctest.Context(t)
	rName := fmt.Sprintf("test-target-group-%s", sdkacctest.RandString(10))	resource.ParallelTest(t, resource.TestCase{
PreCheck:  
func() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, elbv2.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func TestAccELBV2TargetGroup_Name_noDuplicates(t *testing.T) {
	...
	resourceName := "aws_lb_target_group.first"	resource.ParallelTest(t, resource.TestCase{
PreCheck:  
func() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, elbv2.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
continue
	}	_, err := tfelbv2.FindTargetGroupByARN(ctx, conn, rs.Primary.ID)	if tfresource.NotFound(err) {
continue
	}	if err != nil {
return err
...
resource "aws_lb_target_group" "test" {
  ...
  port= 443
  protocol = "HTTP"
  vpc_id= aws_vpc.test.id  deregistration_delay = 200
  slow_start  = 0  # HTTP Only  stickiness {
 type= "lb_cookie"
...
resource "aws_lb_target_group" "test" {
  ...
  vpc_id  = aws_vpc.test2.id  deregistration_delay = 200  stickiness {
 type= "lb_cookie"
 cookie_duration = 10000
  }  health_check {
...
resource "aws_vpc" "test" {
 ...
 Name = %[1]q
  ...
  port= 443
  protocol = "TLS"
  vpc_id= aws_vpc.test.id  target_type= "ip"
  ip_address_type = "ipv6"  health_check {
 interval= 10
 port = "traffic-port"
 protocol= "TCP"
 healthy_threshold= 3
...
func testAccTargetGroupConfig_appStickiness(rName string, addAppStickinessBlock bool, enabled bool) string {
	var appSstickinessBlock string	if addAppStickinessBlock {
...
resource "aws_lb_target_group" "test" {
  ...
  port= 443
  protocol = "HTTPS"
  vpc_id= aws_vpc.test.id  deregistration_delay = 200  %[2]s  health_check {
 path = "/health2"
 interval= 30
 port = 8082
 protocol= "HTTPS"
...
resource "aws_lb_target_group" "test" {
  ...
  port= 443
  protocol = "HTTPS"
  vpc_id= aws_vpc.test.id  deregistration_delay = %[2]d
  slow_start  = 0  stickiness {
 type= "lb_cookie"
 cookie_duration = 10000
  }  health_check {
...
resource "aws_lb_target_group" "test" {
  name  = %[1]q
  target_type = "lambda"  health_check {
 path= "/health"
 interval = 60
  }
}
...
resource "aws_lb_target_group" "test" {
  ...
  protocol = "TCP"
  vpc_id= aws_vpc.test.id  deregistration_delay = 200
  slow_start  = 0  preserve_client_ip = %[2]t  tags = {
 Name = %[1]q
  }
}resource "aws_vpc" "test" {
  cidr_block = "10.0.0.0/16"  tags = {
...
func testAccTargetGroupConfig_stickiness(rName string, addStickinessBlock bool, enabled bool) string {
	var stickinessBlock string	if addStickinessBlock {
...
resource "aws_lb_target_group" "test" {
  ...
  port  = 25
  protocol = %[1]q
  vpc_id= aws_vpc.test.id  stickiness {
 type = %[2]q
 enabled = %[3]t
  }
}resource "aws_vpc" "test" {
...
resource "aws_lb_target_group" "test" {
  ...
  port= 8082
  protocol = "TCP"
  vpc_id= aws_vpc.test.id  deregistration_delay = 200  health_check {
 interval= 10
 port = "traffic-port"
 protocol= "TCP"
 healthy_threshold= 3
...
resource "aws_lb_target_group" "test" {
  ...
  port= 8082
  protocol = "TCP"
  vpc_id= aws_vpc.test.id  proxy_protocol_v2 = true
  deregistration_delay = 200  health_check {
 interval= 10
 port = "traffic-port"
 protocol= "TCP"
 healthy_threshold= 3
...
resource "aws_lb_target_group" "test" {
  ...
  port= 8082
  protocol = "TCP"
  vpc_id= aws_vpc.test.id  connection_termination = true
  deregistration_delay= 200  health_check {
 interval= 10
 port = "traffic-port"
 protocol= "TCP"
...
func testAccTargetGroupConfig_albLoadBalancingAlgorithm(rName string, nonDefault bool, algoType string) string {
	var algoTypeParam string	if nonDefault {
...
func testAccTargetGroupConfig_albLoadBalancingCrossZoneEnabled(rName string, nonDefault bool, enabled bool) string {
	var crossZoneParam string	if nonDefault {
