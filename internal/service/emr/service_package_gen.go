// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package emrimport (
...
TypeName: "aws_emr_release_labels",	}
	...
	return []*types.ServicePackageSDKResource{Factory:  ResourceBlockPublicAccessConfiguration,
...
TypeName: "aws_emr_studio_session_mapping",	}
	...
	return names.EMR
}// NewConn returns a new AWS SDK for Go v1 client for this service package's AWS API.func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*emr_sdkv1.EMR, error) {
	sess := config["session"].(*session_sdkv1.Session)	return emr_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
