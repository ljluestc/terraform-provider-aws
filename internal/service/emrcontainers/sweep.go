...
// +build sweeppackage emrcontainersimport (
"fmt"
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListVirtualClustersPagesWithContext(ctx, input, func(page *emrcontainers.ListVirtualClustersOutput, lastPage bool) bool {
if page == nil {
return !lastPage
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListJobTemplatesPagesWithContext(ctx, input, func(page *emrcontainers.ListJobTemplatesOutput, lastPage bool) bool {
if page == nil {
return !lastPage
