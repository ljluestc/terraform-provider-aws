...
value := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)nameModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
valueModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)resourceName := "aws_cloudwatch_event_connection.api_key"resource.ParallelTest(t, resource.TestCase{
PreCheck: 
...
password := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)nameModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
descriptionModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
usernameModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
passwordModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)resourceName := "aws_cloudwatch_event_connection.basic"resource.ParallelTest(t, resource.TestCase{
PreCheck: 
func() { acctest.PreCheck(ctx, t) },
ErrorCheck:  acctest.ErrorCheck(t, eventbridge.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
httpMethod := "POST"// client_parameters
clientID := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
clientSecret := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)// oauth_http_parameters
bodyKey := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
bodyValue := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
bodyIsSecretValue := trueheaderKey := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
headerValue := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
headerIsSecretValue := truequeryStringKey := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
queryStringValue := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
queryStringIsSecretValue := true// modified
...
httpMethodModified := "GET"// client_parameters
clientIDModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
clientSecretModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)// oauth_http_parameters modified
...
bodyIsSecretValueModified := falseheaderKeyModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
headerValueModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
headerIsSecretValueModified := falsequeryStringKeyModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
queryStringValueModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
queryStringIsSecretValueModified := falseresourceName := "aws_cloudwatch_event_connection.oauth"resource.ParallelTest(t, resource.TestCase{
PreCheck: 
func() { acctest.PreCheck(ctx, t) },
ErrorCheck:  acctest.ErrorCheck(t, eventbridge.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
description := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
key := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
value := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)// invocation_http_parameters
bodyKey := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
bodyValue := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
bodyIsSecretValue := trueheaderKey := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
headerValue := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
headerIsSecretValue := truequeryStringKey := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
queryStringValue := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
queryStringIsSecretValue := true// invocation_http_parameters modified
bodyKeyModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
bodyValueModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
bodyIsSecretValueModified := falseheaderKeyModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
headerValueModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
headerIsSecretValueModified := falsequeryStringKeyModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
queryStringValueModified := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
queryStringIsSecretValueModified := falseresourceName := "aws_cloudwatch_event_connection.invocation_http_parameters"resource.ParallelTest(t, resource.TestCase{
PreCheck: 
func() { acctest.PreCheck(ctx, t) },
ErrorCheck:  acctest.ErrorCheck(t, eventbridge.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
resourceName := "aws_cloudwatch_event_connection.api_key"resource.ParallelTest(t, resource.TestCase{
PreCheck: 
func() { acctest.PreCheck(ctx, t) },
ErrorCheck:  acctest.ErrorCheck(t, eventbridge.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
continue
}_, err := tfevents.FindConnectionByName(ctx, conn, rs.Primary.ID)if tfresource.NotFound(err) {
continue
}if err != nil {
return err
...
}conn := acctest.Provider.Meta().(*conns.AWSClient).EventsConn(ctx)output, err := tfevents.FindConnectionByName(ctx, conn, rs.Primary.ID)if err != nil {
return err
}*v = *outputreturn nil
}
}
