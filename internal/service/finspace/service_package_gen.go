// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package finspaceimport (
...
cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))return finspace_sdkv2.NewFromConfig(cfg, func(o *finspace_sdkv2.Options) {
