// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package fisimport (
...
cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))return fis_sdkv2.NewFromConfig(cfg, func(o *fis_sdkv2.Options) {
