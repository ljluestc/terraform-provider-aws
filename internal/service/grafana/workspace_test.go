...
PreCheck:k(ctx, t); acctest.PreCheckPartitionHasService(t, managedgrafana.EndpointsID) },
...
resource "aws_ec2_managed_prefix_list" "test" {
  ...
  service_nameaws_region.current.name}.grafana-workspace"
  ...
  name= %[1]q
  description= %[1]q
  role_arn network_access_control {
