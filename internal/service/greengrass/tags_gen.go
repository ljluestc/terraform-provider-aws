...
tags, err := listTags(ctx, meta.(*conns.AWSClient).GreengrassConn(ctx), identifier)if err != nil {
return err
}if inContext, ok := tftags.FromContext(ctx); ok {
inContext.TagsOut = types.Some(tags)
}return nil
}// map[string]*string handling// Tags returns greengrass service tags.
