...
detectorDataSourceName := "data.aws_guardduty_detector.test"resource.ParallelTest(t, resource.TestCase{
PreCheck: func() {
...
return `
data "aws_guardduty_detector" "test" {}data "aws_guardduty_finding_ids" "test" {
