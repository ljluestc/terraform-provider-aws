...
// SPDX-License-Identifier: MPL-2.0package iamimport (
	"encoding/base64"
	"fmt"
	"strings"	"github.com/hashicorp/terraform-provider-aws/internal/vault/helper/pgpkeys"
...
// prefixed with the phrase "keybase:"func retrieveGPGKey(pgpKey string) (string, error) {
...
// should be set such that errors return a meaningful user-facing response.func encryptValue(encryptionKey, value, description string) (string, string, error) {
