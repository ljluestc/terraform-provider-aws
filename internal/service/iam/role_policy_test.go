...
// during that step.func TestAccIAMRolePolicy_unknownsInPolicy(t *testing.T) {
ctx := acctest.Context(t)
...
func err := conn.DeleteRolePolicyWithContext(ctx, params)
return err
}
