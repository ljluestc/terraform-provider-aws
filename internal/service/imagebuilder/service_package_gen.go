// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package imagebuilderimport (
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*imagebuilder_sdkv1.Imagebuilder, error) {
	sess := config["session"].(*session_sdkv1.Session)	return imagebuilder_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
