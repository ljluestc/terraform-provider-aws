// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package inspectorimport (
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*inspector_sdkv1.Inspector, error) {
	sess := config["session"].(*session_sdkv1.Session)	return inspector_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
