...
// +build !generatepackage inspectorimport (
	"context"
...
)// Custom Inspector Classic tag service update functions using the same format as generated code.// updateTags updates Inspector Classic resource tags.
