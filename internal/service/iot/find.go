...
}var v *iot.GroupNameAndArnerr := conn.ListThingGroupsForThingPagesWithContext(ctx, input, func(page *iot.ListThingGroupsForThingOutput, lastPage bool) bool {
if page == nil {
return !lastPage
...
var rule *iot.TopicRuleListItemerr := conn.ListTopicRulesPagesWithContext(ctx, &iot.ListTopicRulesInput{}, func(page *iot.ListTopicRulesOutput, lastPage bool) bool {
if page == nil {
return !lastPage
...
var destination *iot.TopicRuleDestinationSummaryerr := conn.ListTopicRuleDestinationsPagesWithContext(ctx, &iot.ListTopicRuleDestinationsInput{}, func(page *iot.ListTopicRuleDestinationsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
