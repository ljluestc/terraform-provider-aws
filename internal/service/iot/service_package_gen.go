// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package iotimport (
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*iot_sdkv1.IoT, error) {
	sess := config["session"].(*session_sdkv1.Session)	return iot_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
