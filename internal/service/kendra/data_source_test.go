...
// SPDX-License-Identifier: MPL-2.0package kendra_testimport (
	...
	resourceName := "aws_kendra_data_source.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck:
...
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
	...
	rName4 := sdkacctest.RandomWithPrefix("resource-test-terraform")
	rName5 := sdkacctest.RandomWithPrefix("resource-test-terraform")
	resourceName := "aws_kendra_data_source.test"	originalWebCrawlerMode := string(types.WebCrawlerModeHostOnly)
	updatedWebCrawlerMode := string(types.WebCrawlerModeSubdomains)	resource.ParallelTest(t, resource.TestCase{
		PreCheck:
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, names.KendraEndpointID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
	...
	rName6 := sdkacctest.RandomWithPrefix("resource-test-terraform")
	rName7 := sdkacctest.RandomWithPrefix("resource-test-terraform")
	resourceName := "aws_kendra_data_source.test"	originalHost1 := "https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kendra_index"
	originalPort1 := 123
	updatedHost1 := "https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kendra_faq"
	updatedPort1 := 234	host2 := "https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kendra_experience"
	port2 := 456	resource.ParallelTest(t, resource.TestCase{
		PreCheck:
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, names.KendraEndpointID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
	...
	updatedCrawlDepth := 4	resource.ParallelTest(t, resource.TestCase{
		PreCheck:
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, names.KendraEndpointID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
	...
	updatedMaxLinksPerPage := 110	resource.ParallelTest(t, resource.TestCase{
		PreCheck:
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, names.KendraEndpointID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
	...
	updatedMaxUrlsPerMinuteCrawlRate := 250	resource.ParallelTest(t, resource.TestCase{
		PreCheck:
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, names.KendraEndpointID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
	...
	rName7 := sdkacctest.RandomWithPrefix("resource-test-terraform")
	resourceName := "aws_kendra_data_source.test"	originalHost1 := "https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kendra_index"
	originalPort1 := 123	resource.ParallelTest(t, resource.TestCase{
		PreCheck:
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, names.KendraEndpointID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
	...
	originalPort1 := 123
	updatedHost1 := "https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kendra_faq"
	updatedPort1 := 234	resource.ParallelTest(t, resource.TestCase{
		PreCheck:
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, names.KendraEndpointID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "custom_document_enrichment_configuration.0.inline_configurations.*", map[string]string{
						"document_content_deletion": "false",						"condition.#": "1",
						...
						"condition.0.condition_on_value.0.string_value": "foo",						"target.#": "1",
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "custom_document_enrichment_configuration.0.inline_configurations.*", map[string]string{
						...
						"condition.0.operator":string(types.ConditionOperatorEquals),
						"condition.0.condition_on_value.#":"1",
						"condition.0.condition_on_value.0.string_value": "foo2",						"target.#": "1",
						"target.0.target_document_attribute_key": "_category",
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "custom_document_enrichment_configuration.0.inline_configurations.*", map[string]string{
						...
						"condition.0.operator": string(types.ConditionOperatorEquals),
						"condition.0.condition_on_value.#": "1",
						"condition.0.condition_on_value.0.date_value":"2006-01-02T15:04:05+00:00",						"target.#": "1",
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "custom_document_enrichment_configuration.0.inline_configurations.*", map[string]string{
						"document_content_deletion": "true",						"condition.#": "1",
						...
						"condition.0.condition_on_value.#": "1",
						"condition.0.condition_on_value.0.long_value":"3",						"target.#": "1",
	...
	rName10 := sdkacctest.RandomWithPrefix("resource-test-terraform")	originalOperator := string(types.ConditionOperatorEquals)
	updatedOperator := string(types.ConditionOperatorGreaterThan)	originalStringValue := "original"
	updatedStringValue := "updated"	resourceName := "aws_kendra_data_source.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck:
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, names.KendraEndpointID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "custom_document_enrichment_configuration.0.post_extraction_hook_configuration.0.lambda_arn", "aws_lambda_
function.test", "arn"),
					...
					resource.TestCheckResourceAttrPair(resourceName, "custom_document_enrichment_configuration.0.pre_extraction_hook_configuration.0.lambda_arn", "aws_lambda_
function.test", "arn"),
...
function.test", "arn"),
	...
	rName11 := sdkacctest.RandomWithPrefix("resource-test-terraform")	resourceName := "aws_kendra_data_source.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck:
func() { acctest.PreCheck(ctx, t); testAccPreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, names.KendraEndpointID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func(s *terraform.State) error {
		conn := acctest.Provider.Meta().(*conns.AWSClient).KendraClient(ctx)		for _, rs := range s.RootModule().Resources {
			...
			_, err = tfkendra.FindDataSourceByID(ctx, conn, id, indexId)			if tfresource.NotFound(err) {
				continue
			}			if err != nil {
				return err
			}
...
func(s *terraform.State) error {
		...
		if err != nil {
			return err
		}		conn := acctest.Provider.Meta().(*conns.AWSClient).KendraClient(ctx)		_, err = tfkendra.FindDataSourceByID(ctx, conn, id, indexId)		if err != nil {
...
"cloudwatch:PutMetricData"
 ...
 condition {
test= "StringEquals"
variable = "cloudwatch:namespace"values = [
"Kendra"
]
 }
}statement {
...
name= %[2]q
assume_role_policy = data.aws_iam_policy_document.test.jsoninline_policy {
 name = "data_source_policy" policy = jsonencode({
Version = "2012-10-17"
Statement = [
{
 Action= ["s3:GetObject"]
...
name = %[2]qassume_role_policy = data.aws_iam_policy_document.test_lambda.json
...
name= %[1]q
type= "S3"
role_arn = local.select_arn == "first" ? aws_iam_role.test_data_source.arn : aws_iam_role.test_data_source2.arnconfiguration {
 s3_configuration {
...
name= %[1]q
type= "S3"
role_arn = aws_iam_role.test_data_source2.arnconfiguration {
 s3_configuration {
...
name= %[1]q
type= "S3"
role_arn = aws_iam_role.test_data_source.arnconfiguration {
 s3_configuration {
...
role_arn = aws_iam_role.test_data_source.arnconfiguration {
 s3_configuration {
bucket_name = aws_s3_bucket.test.iddocuments_metadata_configuration {
s3_prefix = %[2]q
}
 }
}
...
role_arn = aws_iam_role.test_data_source.arnconfiguration {
 s3_configuration {
bucket_name = aws_s3_bucket.test.idexclusion_patterns = ["example"]
...
role_arn = aws_iam_role.test_data_source.arnconfiguration {
 s3_configuration {
bucket_name = aws_s3_bucket.test.idexclusion_patterns = ["example2", "foo"]
...
urls {
seed_url_configuration {
 web_crawler_mode = %[2]q seed_urls = [
"https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kendra_index"
 ]
}
}
...
role_arn = aws_iam_role.test_data_source.arnconfiguration {
 web_crawler_configuration {
max_urls_per_minute_crawl_rate = %[2]durls {
seed_url_configuration {
 seed_urls = [
"https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kendra_index"
 ]
...
url_inclusion_patterns = ["hello"]urls {
seed_url_configuration {
 seed_urls = [
"https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kendra_index"
 ]
...
url_inclusion_patterns = ["hello2", "bar"]urls {
seed_url_configuration {
 seed_urls = [
"https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kendra_index"
 ]
...
document_content_deletion = falsecondition {
condition_document_attribute_key = "_document_title"
operator = "Equals"condition_on_value {
 string_value = "foo"
}
}target {
target_document_attribute_key= "_category"
target_document_attribute_value_deletion = falsetarget_document_attribute_value {
 string_value = "bar"
}
}
 }
...
target_document_attribute_key= "_category"
target_document_attribute_value_deletion = truetarget_document_attribute_value {
 string_value = "bar2"
}
}
 } inline_configurations {
...
document_content_deletion = truecondition {
condition_document_attribute_key = "_excerpt_page_number"
operator = "GreaterThan"condition_on_value {
 long_value = 3
}
}target {
...
bucket_name = aws_s3_bucket.test.id
 ...
 role_arn = aws_iam_role.test_extraction_hook.arn post_extraction_hook_configuration {
lambda_arn = aws_lambda_
function.test.arn
s3_bucket= aws_s3_bucket.test_extraction_hook.idinvocation_condition {
condition_document_attribute_key = "_excerpt_page_number"
operator = %[2]qcondition_on_value {
 long_value = 3
}
}
...
bucket_name = aws_s3_bucket.test.id
 ...
 role_arn = local.select_arn == "first" ? aws_iam_role.test_extraction_hook.arn : aws_iam_role.test_extraction_hook2.arn post_extraction_hook_configuration {
lambda_arn = aws_lambda_
function.test.arn
s3_bucket= aws_s3_bucket.test_extraction_hook.idinvocation_condition {
condition_document_attribute_key = "_excerpt_page_number"
...
lambda_arn = aws_lambda_
function.test.arn
s3_bucket= local.select_bucket == "first" ? aws_s3_bucket.test_extraction_hook.id : aws_s3_bucket.test_extraction_hook2.idinvocation_condition {
condition_document_attribute_key = "_excerpt_page_number"
operator = "Equals"condition_on_value {
 long_value = 3
}
...
bucket_name = aws_s3_bucket.test.id
 ...
 role_arn = aws_iam_role.test_extraction_hook.arn post_extraction_hook_configuration {
lambda_arn = local.select_lambda_arn == "first" ? aws_lambda_
function.test.arn : aws_lambda_
function.test2.arn
s3_bucket= aws_s3_bucket.test_extraction_hook.idinvocation_condition {
condition_document_attribute_key = "_excerpt_page_number"
operator = "Equals"condition_on_value {
