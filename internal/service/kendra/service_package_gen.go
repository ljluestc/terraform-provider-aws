// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package kendraimport (
...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*kendra_sdkv2.Client, error) {
	cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))	return kendra_sdkv2.NewFromConfig(cfg, 
func(o *kendra_sdkv2.Options) {
