// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package keyspacesimport (
...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*keyspaces_sdkv2.Client, error) {
	cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))	return keyspaces_sdkv2.NewFromConfig(cfg, func(o *keyspaces_sdkv2.Options) {
