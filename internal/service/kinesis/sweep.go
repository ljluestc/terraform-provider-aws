...
// +build sweeppackage kinesisimport (
"fmt"
...
sweepResources := make([]sweep.Sweepable, 0)input := &kinesis.ListStreamsInput{}
...
d.Set("name", v.StreamName)sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
