...
Name = %[1]q
  ...
  cidr_blockt.cidr_block, 2, count.index)
...
application_code_configuration {
 ...
 property_group {
PERTY-GROUP-ID1"property
 Key9 = "Value1"
 Key8 = "Value2"

 } property_group {
PERTY-GROUP-ID2"property
 KeyA = "ValueZ"
 KeyB = "ValueY"
 KeyC = "ValueX"
