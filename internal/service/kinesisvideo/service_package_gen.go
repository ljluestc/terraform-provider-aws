// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package kinesisvideoimport (
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*kinesisvideo_sdkv1.KinesisVideo, error) {
	sess := config["session"].(*session_sdkv1.Session)	return kinesisvideo_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
