...
rorCheck:est.ErrorCheck(t, kms.EndpointsID),
...
resource "aws_kms_key" "foo" {
  ...
  key_id = aws_kms_key.foo.key_id  plaintext = "Super secret data"
}
...
resource "aws_kms_key" "foo" {
  ...
  key_id = aws_kms_key.foo.key_id  plaintext = "Super secret data"  context = {
name = "value"
  }
}
`
