// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package kmsimport (
...
func (p *servicePackage) SDKResources(ctx context.Context) []*types.ServicePackageSDKResource {
	return []*types.ServicePackageSDKResource{Factory:  ResourceAlias,
TypeName: "aws_kms_alias",
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*kms_sdkv1.KMS, error) {
	sess := config["session"].(*session_sdkv1.Session)	return kms_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
}
