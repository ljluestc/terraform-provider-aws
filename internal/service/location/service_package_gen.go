// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package locationimport (
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*locationservice_sdkv1.LocationService, error) {
	sess := config["session"].(*session_sdkv1.Session)	return locationservice_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
