...
"To properly test inviting Macie member account must be provided."
	...
	dataSourceAlternate := "data.aws_caller_identity.member"	resource.Test(t, resource.TestCase{
PreCheck: func() {
...
ImportStateVerify: true,
	...
	ctx := acctest.Context(t)
	var macie2Output macie2.GetMemberOutput
	resourceName := "aws_macie2_member.member"	resource.Test(t, resource.TestCase{
PreCheck: func() {
acctest.PreCheck(ctx, t)
acctest.PreCheckAlternateAccount(t)
},
...
ExpectNonEmptyPlan: true,
	...
	var macie2Output macie2.GetMemberOutput
	resourceName := "aws_macie2_member.member"
	email := envvar.SkipIfEmpty(t, envVarAlternateEmail, envVarAlternateEmailMessageError)	resource.Test(t, resource.TestCase{
PreCheck: func() {
acctest.PreCheck(ctx, t)
acctest.PreCheckAlternateAccount(t)
},
...
input := &macie2.GetMemberInput{Id: aws.String(rs.Primary.ID)}resp, err := conn.GetMemberWithContext(ctx, input)if err != nil {
return err
}if resp == nil {
...
resp, err := conn.GetMemberWithContext(ctx, input)if tfawserr.ErrCodeEquals(err, macie2.ErrCodeResourceNotFoundException) ||
...
}resource "aws_macie2_account" "admin" {}resource "aws_macie2_member" "member" {
...
data "aws_caller_identity" "member" {
  provider = "awsalternate"
}data "aws_caller_identity" "admin" {}resource "aws_macie2_account" "admin" {}resource "aws_macie2_account" "member" {
  provider = "awsalternate"
