// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package macie2import (
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*macie2_sdkv1.Macie2, error) {
	sess := config["session"].(*session_sdkv1.Session)	return macie2_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
