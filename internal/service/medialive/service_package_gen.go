// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package medialiveimport (
...
Factory: newResourceMultiplexProgram,	}
	...
	return []*types.ServicePackageSDKResource{Factory:  ResourceChannel,
...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*medialive_sdkv2.Client, error) {
	cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))	return medialive_sdkv2.NewFromConfig(cfg, func(o *medialive_sdkv2.Options) {
