// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package mediapackageimport (
...
cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))return mediapackage_sdkv2.NewFromConfig(cfg, func(o *mediapackage_sdkv2.Options) {
