...
}output, err := conn.DescribeACLsWithContext(ctx, &input)if tfawserr.ErrCodeEquals(err, memorydb.ErrCodeACLNotFoundFault) {
...
}output, err := conn.DescribeClustersWithContext(ctx, &input)if tfawserr.ErrCodeEquals(err, memorydb.ErrCodeClusterNotFoundFault) {
return nil, &retry.NotFoundError{
LastError:   err,
LastRequest: input,
}
...
}output, err := conn.DescribeParameterGroupsWithContext(ctx, &input)if tfawserr.ErrCodeEquals(err, memorydb.ErrCodeParameterGroupNotFoundFault) {
return nil, &retry.NotFoundError{
LastError:   err,
LastRequest: input,
}
...
}output, err := conn.DescribeSnapshotsWithContext(ctx, &input)if tfawserr.ErrCodeEquals(err, memorydb.ErrCodeSnapshotNotFoundFault) {
return nil, &retry.NotFoundError{
LastError:   err,
LastRequest: input,
}
...
}output, err := conn.DescribeSubnetGroupsWithContext(ctx, &input)if tfawserr.ErrCodeEquals(err, memorydb.ErrCodeSubnetGroupNotFoundFault) {
return nil, &retry.NotFoundError{
LastError:   err,
LastRequest: input,
}
...
}output, err := conn.DescribeUsersWithContext(ctx, &input)if tfawserr.ErrCodeEquals(err, memorydb.ErrCodeUserNotFoundFault) {
return nil, &retry.NotFoundError{
LastError:   err,
LastRequest: input,
}
