...
tags, err := listTags(ctx, meta.(*conns.AWSClient).MemoryDBConn(ctx), identifier)if err != nil {
return err
}if inContext, ok := tftags.FromContext(ctx); ok {
inContext.TagsOut = types.Some(tags)
}return nil
}// []*SERVICE.Tag handling// Tags returns memorydb service tags.
