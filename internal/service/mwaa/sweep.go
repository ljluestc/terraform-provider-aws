...
conn := client.MWAAConn(ctx)sweepResources := make([]sweep.Sweepable, 0)
var sweeperErrs *multierror.ErrorlistOutput, err := conn.ListEnvironmentsWithContext(ctx, &mwaa.ListEnvironmentsInput{})
if err != nil {
