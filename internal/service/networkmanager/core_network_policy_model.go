...
Segmentstring`json:"segment,omitempty"`
ShareWithinterface{} `json:"share-with,omitempty"`
ShareWithExceptinterface{} `json:",omitempty"`
}type CoreNetworkAttachmentPolicy struct {
RuleNumberint `json:"rule-number,omitempty"`
...
TagValueOfKeystring `json:"tag-value-of-key,omitempty"`
...
Descriptioniption,omitempty"`
AllowFilter-filter,omitempty"`
DenyFilterinterface{} `json:"deny-filter,omitempty"`
EdgeLocationsinterface{} `json:"edge-locations,omitempty"`
IsolateAttachments boolts"`
RequireAttachmentAcceptance boolt-acceptance"`
}type CoreNetworkPolicyCoreNetworkConfiguration struct {
AsnRanges"asn-ranges"`
VpnEcmpSupportbool`json:"vpn-ecmp-support"`
...
Asnint64`json:"asn,omitempty"`
InsideCidrBlocks interface{} `json:"inside-cidr-blocks,omitempty"`
}func (c CoreNetworkPolicySegmentAction) MarshalJSON() ([]byte, error) {
type Alias CoreNetworkPolicySegmentActionvar share interface{}if c.ShareWith != nil {
sWIntf := c.ShareWith.([]string)if sWIntf[0] == "*" {
share = sWIntf[0]
} else {
share = sWIntf
}
