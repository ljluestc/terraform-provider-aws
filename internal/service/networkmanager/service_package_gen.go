// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package networkmanagerimport (
...
TypeName: "aws_networkmanager_sites",	}
	...
	return []*types.ServicePackageSDKResource{Factory:  ResourceAttachmentAccepter,
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*networkmanager_sdkv1.NetworkManager, error) {
	sess := config["session"].(*session_sdkv1.Session)	return networkmanager_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
