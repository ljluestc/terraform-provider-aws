...
dataSourceName := "data.aws_oam_links.test"resource.Test(t, resource.TestCase{
PreCheck: func() {
...
data "aws_partition" "source" {}data "aws_caller_identity" "monitoring" {
...
data "aws_partition" "monitoring" {
 ...
 "ForAnyValue:StringEquals" = {
  ...
  depends_on = [aws_oam_sink_policy.test]  label_template  = "$AccountName"
