// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package oamimport (
...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*oam_sdkv2.Client, error) {
	cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))	return oam_sdkv2.NewFromConfig(cfg, func(o *oam_sdkv2.Options) {
