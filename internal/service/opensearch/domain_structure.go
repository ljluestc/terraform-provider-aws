...
options.MaintenanceSchedules = autoTuneOptionsInput.MaintenanceSchedulesoptions.RollbackOnDisable = aws.String(tfMap["rollback_on_disable"].(string))return options
}
...
var autoTuneMaintenanceSchedules []*opensearchservice.AutoTuneMaintenanceSchedulefor _, tfMapRaw := range tfList {
