...
func expandAdvancedSecurityOptions(m []interface{}) *opensearchservice.AdvancedSecurityOptionsInput_ {
	...
	group := m[0].(map[string]interface{})	if advancedSecurityEnabled, ok := group["enabled"]; ok {
config.Enabled = aws.Bool(advancedSecurityEnabled.(bool))if advancedSecurityEnabled.(bool) {
...
if len(v) > 0 && v[0] != nil {
	...
	masterUserOptions := v[0].(map[string]interface{})	if v, ok := masterUserOptions["master_user_arn"].(string); ok && v != "" {
...
func expandAutoTuneOptions(tfMap map[string]interface{}) *opensearchservice.AutoTuneOptions {
	if tfMap == nil {
return nil
	}	options := &opensearchservice.AutoTuneOptions{}	autoTuneOptionsInput := expandAutoTuneOptionsInput(tfMap)	options.DesiredState = autoTuneOptionsInput.DesiredState
	options.MaintenanceSchedules = autoTuneOptionsInput.MaintenanceSchedules	options.RollbackOnDisable = aws.String(tfMap["rollback_on_disable"].(string))	return options
}
func expandAutoTuneOptionsInput(tfMap map[string]interface{}) *opensearchservice.AutoTuneOptionsInput_ {
	if tfMap == nil {
return nil
	}	options := &opensearchservice.AutoTuneOptionsInput_{}	options.DesiredState = aws.String(tfMap["desired_state"].(string))	if v, ok := tfMap["maintenance_schedule"].(*schema.Set); ok && v.Len() > 0 {
...
func expandAutoTuneMaintenanceSchedules(tfList []interface{}) []*opensearchservice.AutoTuneMaintenanceSchedule {
	var autoTuneMaintenanceSchedules []*opensearchservice.AutoTuneMaintenanceSchedule	for _, tfMapRaw := range tfList {
tfMap, _ := tfMapRaw.(map[string]interface{})autoTuneMaintenanceSchedule := &opensearchservice.AutoTuneMaintenanceSchedule{}startAt, _ := time.Parse(time.RFC3339, tfMap["start_at"].(string))
autoTuneMaintenanceSchedule.StartAt = aws.Time(startAt)if v, ok := tfMap["duration"].([]interface{}); ok {
	autoTuneMaintenanceSchedule.Duration = expandAutoTuneMaintenanceScheduleDuration(v[0].(map[string]interface{}))
}autoTuneMaintenanceSchedule.CronExpressionForRecurrence = aws.String(tfMap["cron_expression_for_recurrence"].(string))autoTuneMaintenanceSchedules = append(autoTuneMaintenanceSchedules, autoTuneMaintenanceSchedule)
...
return &opensearchservice.SAMLOptionsInput_{}
	...
	group := data[0].(map[string]interface{})	if SAMLEnabled, ok := group["enabled"]; ok {
options.Enabled = aws.Bool(SAMLEnabled.(bool))if SAMLEnabled.(bool) {
...
return &opensearchservice.SAMLIdp{}
	}	m := l[0].(map[string]interface{})	return &opensearchservice.SAMLIdp{
...
func expandOffPeakWindowOptions(tfMap map[string]interface{}) *opensearchservice.OffPeakWindowOptions {
	if tfMap == nil {
return nil
	}	apiObject := &opensearchservice.OffPeakWindowOptions{}	if v, ok := tfMap["enabled"].(bool); ok {
...
func expandOffPeakWindow(tfMap map[string]interface{}) *opensearchservice.OffPeakWindow {
	if tfMap == nil {
return nil
	}	apiObject := &opensearchservice.OffPeakWindow{}	if v, ok := tfMap["window_start_time"].([]interface{}); ok && len(v) > 0 && v[0] != nil {
...
func expandWindowStartTime(tfMap map[string]interface{}) *opensearchservice.WindowStartTime {
	if tfMap == nil {
return nil
	}	apiObject := &opensearchservice.WindowStartTime{}	if v, ok := tfMap["hours"].(int); ok {
...
return []map[string]interface{}{}
	...
	m["enabled"] = aws.BoolValue(advancedSecurityOptions.Enabled)	if aws.BoolValue(advancedSecurityOptions.Enabled) && advancedSecurityOptions.AnonymousAuthEnabled != nil {
...
return nil
	}	m := map[string]interface{}{}	m["desired_state"] = aws.StringValue(autoTuneOptions.DesiredState)	if v := autoTuneOptions.MaintenanceSchedules; v != nil {
m["maintenance_schedule"] = flattenAutoTuneMaintenanceSchedules(v)
	}	m["rollback_on_disable"] = aws.StringValue(autoTuneOptions.RollbackOnDisable)	return m
}
...
return nil
	}	var tfList []interface{}	for _, autoTuneMaintenanceSchedule := range autoTuneMaintenanceSchedules {
m := map[string]interface{}{}m["start_at"] = aws.TimeValue(autoTuneMaintenanceSchedule.StartAt).Format(time.RFC3339)m["duration"] = []interface{}{flattenAutoTuneMaintenanceScheduleDuration(autoTuneMaintenanceSchedule.Duration)}m["cron_expression_for_recurrence"] = aws.StringValue(autoTuneMaintenanceSchedule.CronExpressionForRecurrence)tfList = append(tfList, m)
	}	return tfList
}
func flattenAutoTuneMaintenanceScheduleDuration(autoTuneMaintenanceScheduleDuration *opensearchservice.Duration) map[string]interface{} {
	m := map[string]interface{}{}	m["value"] = aws.Int64Value(autoTuneMaintenanceScheduleDuration.Value)
	m["unit"] = aws.StringValue(autoTuneMaintenanceScheduleDuration.Unit)	return m
}
...
"idp":     flattenESSAMLIdpOptions(samlOptions.Idp),
	...
	m["subject_key"] = aws.StringValue(samlOptions.SubjectKey)	// samlOptions.master_backend_role and samlOptions.master_user_name will be added to the
	...
	m["master_user_name"] = d.Get("saml_options.0.master_user_name").(string)	return []interface{}{m}
}
...
func expandLogPublishingOptions(m *schema.Set) map[string]*opensearchservice.LogPublishingOption {
	options := make(map[string]*opensearchservice.LogPublishingOption)	for _, vv := range m.List() {
...
func flattenOffPeakWindow(apiObject *opensearchservice.OffPeakWindow) map[string]interface{} {
	if apiObject == nil {
return nil
	}	tfMap := map[string]interface{}{}	if v := apiObject.WindowStartTime; v != nil {
...
func flattenWindowStartTime(apiObject *opensearchservice.WindowStartTime) map[string]interface{} {
	if apiObject == nil {
return nil
	}	tfMap := map[string]interface{}{}	if v := apiObject.Hours; v != nil {
