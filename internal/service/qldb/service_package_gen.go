// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package qldbimport (
...
cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))return qldb_sdkv2.NewFromConfig(cfg, func(o *qldb_sdkv2.Options) {
