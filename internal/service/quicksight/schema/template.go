...
if !ok {
return nil
}sourceEntity := &quicksight.TemplateSourceEntity{}if v, ok := tfMap["source_analysis"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}definition := &quicksight.TemplateVersionDefinition{}if v, ok := tfMap["analysis_defaults"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}field := &quicksight.CalculatedField{}if v, ok := tfMap["data_set_identifier"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}column := &quicksight.ColumnConfiguration{}if v, ok := tfMap["column"].([]interface{}); ok && len(v) > 0 {
...
column := &quicksight.ColumnIdentifier{}if v, ok := tfMap["data_set_identifier"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}config := &quicksight.DataSetConfiguration{}if v, ok := tfMap["column_group_schema_list"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}group := &quicksight.ColumnGroupSchema{}if v, ok := tfMap["column_group_schema_list"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}column := &quicksight.ColumnGroupColumnSchema{}if v, ok := tfMap["name"].(string); ok && v != "" {
...
schema := &quicksight.DataSetSchema{}if v, ok := tfMap["column_schema_list"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}column := &quicksight.ColumnSchema{}if v, ok := tfMap["data_type"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}group := &quicksight.FilterGroup{}if v, ok := tfMap["cross_dataset"].(string); ok && v != "" {
...
function{}if v, ok := tfMap["categorical_aggregation_
function"].(string); ok && v != "" {function.CategoricalAggregation
function = aws.String(v)
}
if v, ok := tfMap["date_aggregation_
function"].(string); ok && v != "" {function.DateAggregation
function = aws.String(v)
}
if v, ok := tfMap["numerical_aggregation_
function"].([]interface{}); ok && len(v) > 0 {function.NumericalAggregation
...
function{}if v, ok := tfMap["simple_numerical_aggregation"].(string); ok && v != "" {function.SimpleNumericalAggregation = aws.String(v)
}
if v, ok := tfMap["percentile_aggregation"].([]interface{}); ok && len(v) > 0 {function.PercentileAggregation = expandPercentileAggregation(v)
}returnfunction
...
if !ok {
return nil
}agg := &quicksight.PercentileAggregation{}if v, ok := tfMap["simple_numerical_aggregation"].(float64); ok {
...
if !ok {
return nil
}config := &quicksight.RollingDateConfiguration{}if v, ok := tfMap["data_set_identifier"].(string); ok {
...
if tfMap == nil {
return nil
}param := &quicksight.ParameterDeclaration{}if v, ok := tfMap["date_time_parameter_declaration"].([]interface{}); ok && len(v) > 0 {
