...
if tfMap == nil {
return nil
}filter := &quicksight.Filter{}if v, ok := tfMap["category_filter"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}filter := &quicksight.CategoryFilter{}if v, ok := tfMap["filter_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.CategoryFilterConfiguration{}if v, ok := tfMap["custom_filter_configuration"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.CustomFilterConfiguration{}if v, ok := tfMap["category_value"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.CustomFilterListConfiguration{}if v, ok := tfMap["category_values"].([]interface{}); ok {
...
if !ok {
return nil
}config := &quicksight.FilterListConfiguration{}if v, ok := tfMap["category_values"].([]interface{}); ok {
config.CategoryValues = flex.ExpandStringList(v)
}
if v, ok := tfMap["match_operator"].(string); ok && v != "" {
config.MatchOperator = aws.String(v)
...
if !ok {
return nil
}filter := &quicksight.NumericEqualityFilter{}if v, ok := tfMap["filter_id"].(string); ok && v != "" {
filter.FilterId = aws.String(v)
}
if v, ok := tfMap["column"].([]interface{}); ok && len(v) > 0 {
filter.Column = expandColumnIdentifier(v)
...
if !ok {
return nil
}config := &quicksight.FilterScopeConfiguration{}if v, ok := tfMap["selected_sheets"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.SelectedSheetsFilterScopeConfiguration{}if v, ok := tfMap["sheet_visual_scoping_configurations"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}config := &quicksight.SheetVisualScopingConfiguration{}if v, ok := tfMap["scope"].(string); ok && v != "" {
...
if !ok {
return nil
}filter := &quicksight.NumericRangeFilter{}if v, ok := tfMap["filter_id"].(string); ok && v != "" {
filter.FilterId = aws.String(v)
}
if v, ok := tfMap["column"].([]interface{}); ok && len(v) > 0 {
filter.Column = expandColumnIdentifier(v)
...
if !ok {
return nil
}filter := &quicksight.NumericRangeFilterValue{}if v, ok := tfMap["parameter"].(string); ok && v != "" {
...
if !ok {
return nil
}filter := &quicksight.RelativeDatesFilter{}if v, ok := tfMap["filter_id"].(string); ok && v != "" {
filter.FilterId = aws.String(v)
}
if v, ok := tfMap["column"].([]interface{}); ok && len(v) > 0 {
filter.Column = expandColumnIdentifier(v)
...
if !ok {
return nil
}config := &quicksight.AnchorDateConfiguration{}if v, ok := tfMap["anchor_option"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.ExcludePeriodConfiguration{}if v, ok := tfMap["amount"].(int); ok {
...
if !ok {
return nil
}filter := &quicksight.TimeEqualityFilter{}if v, ok := tfMap["filter_id"].(string); ok && v != "" {
filter.FilterId = aws.String(v)
}
if v, ok := tfMap["column"].([]interface{}); ok && len(v) > 0 {
filter.Column = expandColumnIdentifier(v)
...
if !ok {
return nil
}filter := &quicksight.TimeRangeFilter{}if v, ok := tfMap["filter_id"].(string); ok && v != "" {
filter.FilterId = aws.String(v)
}
if v, ok := tfMap["column"].([]interface{}); ok && len(v) > 0 {
filter.Column = expandColumnIdentifier(v)
...
if !ok {
return nil
}filter := &quicksight.TimeRangeFilterValue{}if v, ok := tfMap["parameter"].(string); ok && v != "" {
filter.Parameter = aws.String(v)
}
...
if !ok {
return nil
}filter := &quicksight.TopBottomFilter{}if v, ok := tfMap["filter_id"].(string); ok && v != "" {
filter.FilterId = aws.String(v)
}
if v, ok := tfMap["column"].([]interface{}); ok && len(v) > 0 {
filter.Column = expandColumnIdentifier(v)
...
if tfMap == nil {
return nil
}config := &quicksight.AggregationSortConfiguration{}if v, ok := tfMap["sort_direction"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}options := &quicksight.DrillDownFilter{}if v, ok := tfMap["category_filter"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}filter := &quicksight.CategoryDrillDownFilter{}if v, ok := tfMap["column"].([]interface{}); ok && len(v) > 0 {
filter.Column = expandColumnIdentifier(v)
}
...
if !ok {
return nil
}filter := &quicksight.NumericEqualityDrillDownFilter{}if v, ok := tfMap["column"].([]interface{}); ok && len(v) > 0 {
filter.Column = expandColumnIdentifier(v)
}
if v, ok := tfMap["value"].(float64); ok {
filter.Value = aws.Float64(v)
...
if !ok {
return nil
}filter := &quicksight.TimeRangeDrillDownFilter{}if v, ok := tfMap["range_maximum"].(string); ok && v != "" {
t, _ := time.Parse(time.RFC3339, v) // Format validated with validate
func
