...
if !ok {
return nil
}param := &quicksight.DateTimeParameterDeclaration{}if v, ok := tfMap["name"].(string); ok && v != "" {
...
if !ok {
return nil
}values := &quicksight.DateTimeDefaultValues{}if v, ok := tfMap["dynamic_value"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}value := &quicksight.DynamicDefaultValue{}if v, ok := tfMap["default_value_column"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.DateTimeValueWhenUnsetConfiguration{}if v, ok := tfMap["custom_value"].(string); ok && v != "" {
...
if !ok {
return nil
}param := &quicksight.DecimalParameterDeclaration{}if v, ok := tfMap["name"].(string); ok && v != "" {
param.Name = aws.String(v)
}
...
if !ok {
return nil
}config := &quicksight.DecimalValueWhenUnsetConfiguration{}if v, ok := tfMap["custom_value"].(float64); ok && v != 0.0 {
...
if !ok {
return nil
}values := &quicksight.DecimalDefaultValues{}if v, ok := tfMap["dynamic_value"].([]interface{}); ok && len(v) > 0 {
values.DynamicValue = expandDynamicDefaultValue(v)
}
if v, ok := tfMap["static_values"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}param := &quicksight.IntegerParameterDeclaration{}if v, ok := tfMap["name"].(string); ok && v != "" {
param.Name = aws.String(v)
}
if v, ok := tfMap["parameter_value_type"].(string); ok && v != "" {
param.ParameterValueType = aws.String(v)
...
if !ok {
return nil
}config := &quicksight.IntegerValueWhenUnsetConfiguration{}if v, ok := tfMap["custom_value"].(int); ok && v != 0 {
...
if !ok {
return nil
}values := &quicksight.IntegerDefaultValues{}if v, ok := tfMap["dynamic_value"].([]interface{}); ok && len(v) > 0 {
values.DynamicValue = expandDynamicDefaultValue(v)
}
if v, ok := tfMap["static_values"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}param := &quicksight.StringParameterDeclaration{}if v, ok := tfMap["name"].(string); ok && v != "" {
param.Name = aws.String(v)
}
if v, ok := tfMap["parameter_value_type"].(string); ok && v != "" {
param.ParameterValueType = aws.String(v)
...
if !ok {
return nil
}config := &quicksight.StringValueWhenUnsetConfiguration{}if v, ok := tfMap["custom_value"].(string); ok && v != "" {
...
if !ok {
return nil
}values := &quicksight.StringDefaultValues{}if v, ok := tfMap["dynamic_value"].([]interface{}); ok && len(v) > 0 {
values.DynamicValue = expandDynamicDefaultValue(v)
}
if v, ok := tfMap["static_values"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}values := &quicksight.ParameterSelectableValues{}if v, ok := tfMap["link_to_data_set_column"].([]interface{}); ok && len(v) > 0 {
