...
if !ok {
return nil
}defaults := &quicksight.AnalysisDefaults{}if v, ok := tfMap["default_new_sheet_configuration"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.DefaultNewSheetConfiguration{}if v, ok := tfMap["interactive_layout_configuration"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.DefaultInteractiveLayoutConfiguration{}if v, ok := tfMap["free_form"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.DefaultFreeFormLayoutConfiguration{}if v, ok := tfMap["canvas_size_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.FreeFormLayoutCanvasSizeOptions{}if v, ok := tfMap["screen_canvas_size_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.FreeFormLayoutScreenCanvasSizeOptions{}if v, ok := tfMap["optimized_view_port_width"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.DefaultGridLayoutConfiguration{}if v, ok := tfMap["canvas_size_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.GridLayoutCanvasSizeOptions{}if v, ok := tfMap["screen_canvas_size_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.GridLayoutScreenCanvasSizeOptions{}if v, ok := tfMap["optimized_view_port_width"].(string); ok && v != "" {
options.OptimizedViewPortWidth = aws.String(v)
}
...
if !ok {
return nil
}config := &quicksight.DefaultPaginatedLayoutConfiguration{}if v, ok := tfMap["section_based"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.DefaultSectionBasedLayoutConfiguration{}if v, ok := tfMap["canvas_size_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.SectionBasedLayoutCanvasSizeOptions{}if v, ok := tfMap["paper_canvas_size_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.SectionBasedLayoutPaperCanvasSizeOptions{}if v, ok := tfMap["paper_margin"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}spacing := &quicksight.Spacing{}if v, ok := tfMap["bottom"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}sheet := &quicksight.SheetDefinition{}if v, ok := tfMap["sheet_id"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}layout := &quicksight.Layout{}if v, ok := tfMap["configuration"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.LayoutConfiguration{}if v, ok := tfMap["free_form_layout"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.FreeFormLayoutConfiguration{}if v, ok := tfMap["elements"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}layout := &quicksight.FreeFormLayoutElement{}if v, ok := tfMap["element_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.FreeFormLayoutElementBackgroundStyle{}if v, ok := tfMap["color"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.FreeFormLayoutElementBorderStyle{}if v, ok := tfMap["color"].(string); ok && v != "" {
config.Color = aws.String(v)
}
if v, ok := tfMap["visibility"].(string); ok && v != "" {
config.Visibility = aws.String(v)
...
if !ok {
return nil
}config := &quicksight.LoadingAnimation{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
config.Visibility = aws.String(v)
}
return config
...
if tfMap == nil {
return nil
}layout := &quicksight.SheetElementRenderingRule{}if v, ok := tfMap["expression"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.SheetElementConfigurationOverrides{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
config.Visibility = aws.String(v)
}
return config
...
if !ok {
return nil
}config := &quicksight.GridLayoutConfiguration{}if v, ok := tfMap["elements"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}layout := &quicksight.GridLayoutElement{}if v, ok := tfMap["element_id"].(string); ok && v != "" {
layout.ElementId = aws.String(v)
}
if v, ok := tfMap["element_type"].(string); ok && v != "" {
layout.ElementType = aws.String(v)
...
if !ok {
return nil
}config := &quicksight.SectionBasedLayoutConfiguration{}if v, ok := tfMap["body_sections"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}config := &quicksight.BodySectionConfiguration{}if v, ok := tfMap["section_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.BodySectionContent{}if v, ok := tfMap["layout"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.SectionLayoutConfiguration{}if v, ok := tfMap["free_form_layout"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.FreeFormSectionLayoutConfiguration{}if v, ok := tfMap["elements"].([]interface{}); ok && len(v) > 0 {
config.Elements = expandFreeFormLayoutElements(v)
}return config
...
if !ok {
return nil
}config := &quicksight.SectionPageBreakConfiguration{}if v, ok := tfMap["after"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.SectionAfterPageBreak{}if v, ok := tfMap["status"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.SectionStyle{}if v, ok := tfMap["height"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}config := &quicksight.HeaderFooterSectionConfiguration{}if v, ok := tfMap["section_id"].(string); ok && v != "" {
config.SectionId = aws.String(v)
}
...
if tfMap == nil {
return nil
}layout := &quicksight.SheetControlLayout{}if v, ok := tfMap["configuration"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.SheetControlLayoutConfiguration{}if v, ok := tfMap["grid_layout"].([]interface{}); ok && len(v) > 0 {
config.GridLayout = expandGridLayoutConfiguration(v)
}return config
...
if tfMap == nil {
return nil
}box := &quicksight.SheetTextBox{}if v, ok := tfMap["sheet_text_box_id"].(string); ok && v != "" {
