...
if tfMap == nil {
return nil
}visual := &quicksight.Visual{}if v, ok := tfMap["bar_chart_visual"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.DataLabelOptions{}if v, ok := tfMap["category_label_visibility"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}options := &quicksight.DataLabelType{}if v, ok := tfMap["data_path_label_type"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.DataPathLabelType{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.FieldLabelType{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
options.FieldId = aws.String(v)
}
if v, ok := tfMap["visibility"].(string); ok && v != "" {
options.Visibility = aws.String(v)
...
if !ok {
return nil
}options := &quicksight.MaximumLabelType{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
options.Visibility = aws.String(v)
}return options
...
if !ok {
return nil
}options := &quicksight.MinimumLabelType{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
options.Visibility = aws.String(v)
}return options
...
if !ok {
return nil
}options := &quicksight.RangeEndsLabelType{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
options.Visibility = aws.String(v)
}return options
...
if !ok {
return nil
}options := &quicksight.LegendOptions{}if v, ok := tfMap["height"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.TooltipOptions{}if v, ok := tfMap["selected_tooltip_type"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.FieldBasedTooltip{}if v, ok := tfMap["aggregation_visibility"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}item := &quicksight.TooltipItem{}if v, ok := tfMap["column_tooltip_item"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}item := &quicksight.ColumnTooltipItem{}if v, ok := tfMap["label"].(string); ok && v != "" {
...
if !ok {
return nil
}item := &quicksight.FieldTooltipItem{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.VisualPalette{}if v, ok := tfMap["chart_color"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}color := &quicksight.DataPathColor{}if v, ok := tfMap["color"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}value := &quicksight.DataPathValue{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}options := &quicksight.ColumnHierarchy{}if v, ok := tfMap["date_time_hierarchy"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.DateTimeHierarchy{}if v, ok := tfMap["hierarchy_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.ExplicitHierarchy{}if v, ok := tfMap["hierarchy_id"].(string); ok && v != "" {
config.HierarchyId = aws.String(v)
}
...
if !ok {
return nil
}config := &quicksight.PredefinedHierarchy{}if v, ok := tfMap["hierarchy_id"].(string); ok && v != "" {
config.HierarchyId = aws.String(v)
}
if v, ok := tfMap["columns"].([]interface{}); ok && len(v) > 0 {
config.Columns = expandColumnIdentifiers(v)
...
if !ok {
return nil
}options := &quicksight.VisualSubtitleLabelOptions{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
options.Visibility = aws.String(v)
}
...
if !ok {
return nil
}format := &quicksight.LongFormatText{}if v, ok := tfMap["plain_text"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.VisualTitleLabelOptions{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
options.Visibility = aws.String(v)
}
if v, ok := tfMap["format_text"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}format := &quicksight.ShortFormatText{}if v, ok := tfMap["plain_text"].(string); ok && v != "" {
format.PlainText = aws.String(v)
}
if v, ok := tfMap["rich_text"].(string); ok && v != "" {
format.RichText = aws.String(v)
...
if !ok {
return nil
}config := &quicksight.ComparisonConfiguration{}if v, ok := tfMap["comparison_method"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.ColorScale{}if v, ok := tfMap["color_fill_type"].(string); ok && v != "" {
...
color := &quicksight.DataColor{}if v, ok := tfMap["color"].(string); ok && v != "" {
color.Color = aws.String(v)
}
