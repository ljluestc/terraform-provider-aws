...
if !ok {
return nil
}options := &quicksight.AxisDisplayOptions{}if v, ok := tfMap["axis_line_visibility"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.AxisDataOptions{}if v, ok := tfMap["date_axis_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.DateAxisOptions{}if v, ok := tfMap["missing_date_visibility"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.NumericAxisOptions{}if v, ok := tfMap["range"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.AxisDisplayRange{}if v, ok := tfMap["data_driven"].([]interface{}); ok && len(v) > 0 {
...
//if !ok {
//return nil
//}options := &quicksight.AxisDisplayDataDrivenRange{}return options
...
if !ok {
return nil
}options := &quicksight.AxisDisplayMinMaxRange{}if v, ok := tfMap["maximum"].(float64); ok {
...
if !ok {
return nil
}options := &quicksight.AxisScale{}if v, ok := tfMap["linear"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.AxisLinearScale{}if v, ok := tfMap["step_count"].(int); ok {
...
if !ok {
return nil
}options := &quicksight.AxisLogarithmicScale{}if v, ok := tfMap["base"].(float64); ok {
...
if !ok {
return nil
}options := &quicksight.ScrollBarOptions{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.VisibleRangeOptions{}if v, ok := tfMap["percent_range"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.PercentVisibleRange{}if v, ok := tfMap["from"].(float64); ok {
...
if !ok {
return nil
}options := &quicksight.AxisTickLabelOptions{}if v, ok := tfMap["rotation_angle"].(float64); ok {
...
if !ok {
return nil
}options := &quicksight.ChartAxisLabelOptions{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
options.Visibility = aws.String(v)
}
...
if tfMap == nil {
return nil
}options := &quicksight.AxisLabelOptions{}if v, ok := tfMap["custom_label"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.AxisLabelReferenceOptions{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}options := &quicksight.ContributionAnalysisDefault{}if v, ok := tfMap["measure_field_id"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}line := &quicksight.ReferenceLine{}if v, ok := tfMap["status"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.ReferenceLineDataConfiguration{}if v, ok := tfMap["axis_binding"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.ReferenceLineDynamicDataConfiguration{}if v, ok := tfMap["calculation"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.ReferenceLineStaticDataConfiguration{}if v, ok := tfMap["value"].(float64); ok {
...
if !ok {
return nil
}config := &quicksight.ReferenceLineLabelConfiguration{}if v, ok := tfMap["font_color"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.ReferenceLineCustomLabelConfiguration{}if v, ok := tfMap["custom_label"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.ReferenceLineValueLabelConfiguration{}if v, ok := tfMap["relative_position"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.ReferenceLineStyleConfiguration{}if v, ok := tfMap["color"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.SmallMultiplesOptions{}if v, ok := tfMap["max_visible_columns"].(int); ok {
...
if !ok {
return nil
}config := &quicksight.PanelConfiguration{}if v, ok := tfMap["background_color"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.PanelTitleOptions{}if v, ok := tfMap["horizontal_text_alignment"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.ItemsLimitConfiguration{}if v, ok := tfMap["items_limit"].(int); ok {
...
tfMap := map[string]interface{}{}return []interface{}{tfMap}
