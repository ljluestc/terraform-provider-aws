...
if !ok {
return nil
}color := &quicksight.ConditionalFormattingColor{}if v, ok := tfMap["gradient"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}color := &quicksight.ConditionalFormattingGradientColor{}if v, ok := tfMap["expression"].(string); ok && v != "" {
...
if !ok {
return nil
}color := &quicksight.GradientColor{}if v, ok := tfMap["stops"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}options := &quicksight.GradientStop{}if v, ok := tfMap["gradient_offset"].(float64); ok {
...
if !ok {
return nil
}color := &quicksight.ConditionalFormattingSolidColor{}if v, ok := tfMap["color"].(string); ok && v != "" {
...
if !ok {
return nil
}icon := &quicksight.ConditionalFormattingIcon{}if v, ok := tfMap["custom_condition"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}icon := &quicksight.ConditionalFormattingCustomIconCondition{}if v, ok := tfMap["color"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.ConditionalFormattingCustomIconOptions{}if v, ok := tfMap["icon"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.ConditionalFormattingIconDisplayConfiguration{}if v, ok := tfMap["icon_display_option"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.ConditionalFormattingIconSet{}if v, ok := tfMap["expression"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.TextConditionalFormat{}if v, ok := tfMap["background_color"].([]interface{}); ok && len(v) > 0 {
