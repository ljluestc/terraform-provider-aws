...
const dimensionsFieldMaxItems200 = 200func dimensionFieldSchema(maxItems int) *schema.Schema {
...
if tfMap == nil {
return nil
}field := &quicksight.DimensionField{}if v, ok := tfMap["categorical_dimension_field"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}field := &quicksight.CategoricalDimensionField{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
...
if !ok {
return nil
}field := &quicksight.DateDimensionField{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
field.FieldId = aws.String(v)
}
if v, ok := tfMap["hierarchy_id"].(string); ok && v != "" {
field.HierarchyId = aws.String(v)
...
if !ok {
return nil
}field := &quicksight.NumericalDimensionField{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
field.FieldId = aws.String(v)
}
if v, ok := tfMap["hierarchy_id"].(string); ok && v != "" {
field.HierarchyId = aws.String(v)
...
if tfMap == nil {
return nil
}field := &quicksight.MeasureField{}if v, ok := tfMap["calculated_measure_field"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}field := &quicksight.CalculatedMeasureField{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
field.FieldId = aws.String(v)
}
...
if !ok {
return nil
}field := &quicksight.CategoricalMeasureField{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
field.FieldId = aws.String(v)
}
...
if !ok {
return nil
}field := &quicksight.DateMeasureField{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
field.FieldId = aws.String(v)
}
if v, ok := tfMap["aggregation_
function"].(string); ok && v != "" {
...
if !ok {
return nil
}field := &quicksight.NumericalMeasureField{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
field.FieldId = aws.String(v)
}
if v, ok := tfMap["column"].([]interface{}); ok && len(v) > 0 {
field.Column = expandColumnIdentifier(v)
...
function != nil {
tfMap["aggregation_
function"] = aws.StringValue(apiObject.Aggregation
function)
}
if apiObject.Column != nil {
tfMap["column"] = flattenColumnIdentifier(apiObject.Column)
