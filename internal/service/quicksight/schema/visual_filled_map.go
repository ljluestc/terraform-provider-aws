...
if tfMap == nil {
turn nil
}options := &quicksight.FilledMapConditionalFormattingOption{}if v, ok := tfMap["shape"].([]interface{}); ok && len(v) > 0 {
tions.Shape = expandFilledMapShapeConditionalFormatting(v)
}return options
...
if !ok {
turn nil
}options := &quicksight.FilledMapShapeConditionalFormatting{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
tions.FieldId = aws.String(v)
}
if v, ok := tfMap["format"].([]interface{}); ok && len(v) > 0 {
tions.Format = expandShapeConditionalFormat(v)
}return options
...
if !ok {
turn nil
}options := &quicksight.ShapeConditionalFormat{}if v, ok := tfMap["background_color"].([]interface{}); ok && len(v) > 0 {
tions.BackgroundColor = expandConditionalFormattingColor(v)
}return options
...
Map["chart_configuration"] = flattenFilledMapConfiguration(apiObject.ChartConfiguration)
}
if apiObject.ColumnHierarchies != nil {
Map["column_hierarchies"] = flattenColumnHierarchy(apiObject.ColumnHierarchies)
}
if apiObject.ConditionalFormatting != nil {
Map["conditional_formatting"] = flattenFilledMapConditionalFormatting(apiObject.ConditionalFormatting)
}
if apiObject.Subtitle != nil {
Map["subtitle"] = flattenVisualSubtitleLabelOptions(apiObject.Subtitle)
}
if apiObject.Title != nil {
Map["title"] = flattenVisualTitleLabelOptions(apiObject.Title)
...
Map["field_wells"] = flattenFilledMapFieldWells(apiObject.FieldWells)
}
if apiObject.Legend != nil {
Map["legend"] = flattenLegendOptions(apiObject.Legend)
}
if apiObject.MapStyleOptions != nil {
Map["map_style_options"] = flattenGeospatialMapStyleOptions(apiObject.MapStyleOptions)
}
if apiObject.SortConfiguration != nil {
Map["sort_configuration"] = flattenFilledMapSortConfiguration(apiObject.SortConfiguration)
}
if apiObject.Tooltip != nil {
Map["tooltip"] = flattenTooltipOptions(apiObject.Tooltip)
}
if apiObject.WindowOptions != nil {
Map["window_options"] = flattenGeospatialWindowOptions(apiObject.WindowOptions)
}return []interface{}{tfMap}
...
Map["filled_map_aggregated_field_wells"] = flattenFilledMapAggregatedFieldWells(apiObject.FilledMapAggregatedFieldWells)
}return []interface{}{tfMap}
...
Map["geospatial"] = flattenDimensionFields(apiObject.Geospatial)
}
if apiObject.Values != nil {
Map["values"] = flattenMeasureFields(apiObject.Values)
}return []interface{}{tfMap}
...
Map["category_sort"] = flattenFieldSortOptions(apiObject.CategorySort)
}return []interface{}{tfMap}
...
Map["conditional_formatting_options"] = flattenFilledMapConditionalFormattingOption(apiObject.ConditionalFormattingOptions)
}return []interface{}{tfMap}
...
Map["field_id"] = aws.StringValue(apiObject.FieldId)
}
if apiObject.Format != nil {
Map["format"] = flattenShapeConditionalFormat(apiObject.Format)
}return []interface{}{tfMap}
...
Map["background_color"] = flattenConditionalFormattingColor(apiObject.BackgroundColor)
}return []interface{}{tfMap}
}
