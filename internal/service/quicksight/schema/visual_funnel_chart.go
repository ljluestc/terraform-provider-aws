...
if !ok {
return nil
}visual := &quicksight.FunnelChartVisual{}if v, ok := tfMap["visual_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.FunnelChartConfiguration{}if v, ok := tfMap["category_label_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.FunnelChartFieldWells{}if v, ok := tfMap["funnel_chart_aggregated_field_wells"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.FunnelChartAggregatedFieldWells{}if v, ok := tfMap["category"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.FunnelChartSortConfiguration{}if v, ok := tfMap["category_items_limit"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.FunnelChartDataLabelOptions{}if v, ok := tfMap["category_label_visibility"].(string); ok && v != "" {
