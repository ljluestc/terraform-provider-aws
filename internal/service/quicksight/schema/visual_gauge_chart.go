...
if !ok {
return nil
}visual := &quicksight.GaugeChartVisual{}if v, ok := tfMap["visual_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.GaugeChartConfiguration{}if v, ok := tfMap["data_labels"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.GaugeChartFieldWells{}if v, ok := tfMap["target_values"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.GaugeChartOptions{}if v, ok := tfMap["primary_value_display_type"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.GaugeChartConditionalFormatting{}if v, ok := tfMap["conditional_formatting_options"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}options := &quicksight.GaugeChartConditionalFormattingOption{}if v, ok := tfMap["arc"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.GaugeChartArcConditionalFormatting{}if v, ok := tfMap["foreground_color"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.GaugeChartPrimaryValueConditionalFormatting{}if v, ok := tfMap["icon"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.ArcConfiguration{}if v, ok := tfMap["arc_angle"].(float64); ok {
...
if !ok {
return nil
}config := &quicksight.ArcAxisConfiguration{}if v, ok := tfMap["range"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.ArcAxisDisplayRange{}if v, ok := tfMap["max"].(float64); ok {
