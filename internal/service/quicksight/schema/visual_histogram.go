...
if !ok {
return nil
}visual := &quicksight.HistogramVisual{}if v, ok := tfMap["visual_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.HistogramConfiguration{}if v, ok := tfMap["bin_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.HistogramFieldWells{}if v, ok := tfMap["histogram_aggregated_field_wells"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.HistogramAggregatedFieldWells{}if v, ok := tfMap["values"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.HistogramBinOptions{}if v, ok := tfMap["selected_bin_type"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.BinCountOptions{}if v, ok := tfMap["value"].(int); ok {
...
if !ok {
return nil
}options := &quicksight.BinWidthOptions{}if v, ok := tfMap["bin_count_limit"].(int); ok {
