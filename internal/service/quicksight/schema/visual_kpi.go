...
if !ok {
return nil
}visual := &quicksight.KPIVisual{}if v, ok := tfMap["visual_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.KPIConfiguration{}if v, ok := tfMap["field_wells"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.KPIFieldWells{}if v, ok := tfMap["trend_groups"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.KPIOptions{}if v, ok := tfMap["primary_value_display_type"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.ProgressBarOptions{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.SecondaryValueOptions{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
options.Visibility = aws.String(v)
}return options
...
if !ok {
return nil
}options := &quicksight.TrendArrowOptions{}if v, ok := tfMap["visibility"].(string); ok && v != "" {
options.Visibility = aws.String(v)
}return options
...
if !ok {
return nil
}config := &quicksight.KPISortConfiguration{}if v, ok := tfMap["trend_group_sort"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.KPIConditionalFormatting{}if v, ok := tfMap["conditional_formatting_options"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}options := &quicksight.KPIConditionalFormattingOption{}if v, ok := tfMap["primary_value"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.KPIPrimaryValueConditionalFormatting{}if v, ok := tfMap["icon"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.KPIProgressBarConditionalFormatting{}if v, ok := tfMap["foreground_color"].([]interface{}); ok && len(v) > 0 {
