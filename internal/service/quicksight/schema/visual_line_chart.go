...
if !ok {
return nil
}visual := &quicksight.LineChartVisual{}if v, ok := tfMap["visual_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.LineChartConfiguration{}if v, ok := tfMap["type"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.LineChartFieldWells{}if v, ok := tfMap["line_chart_aggregated_field_wells"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.LineChartAggregatedFieldWells{}if v, ok := tfMap["category"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.LineChartSortConfiguration{}if v, ok := tfMap["category_items_limit"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.LineChartDefaultSeriesSettings{}if v, ok := tfMap["axis_binding"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.LineChartLineStyleSettings{}if v, ok := tfMap["line_interpolation"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.LineChartMarkerStyleSettings{}if v, ok := tfMap["marker_color"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}config := &quicksight.ForecastConfiguration{}if v, ok := tfMap["forecast_properties"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.TimeBasedForecastProperties{}if v, ok := tfMap["lower_boundary"].(float64); ok {
...
if !ok {
return nil
}scenario := &quicksight.ForecastScenario{}if v, ok := tfMap["what_if_point_scenario"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}scenario := &quicksight.WhatIfPointScenario{}if v, ok := tfMap["date"].(string); ok && v != "" {
...
if !ok {
return nil
}scenario := &quicksight.WhatIfRangeScenario{}if v, ok := tfMap["end_date"].(string); ok && v != "" {
t, _ := time.Parse(time.RFC3339, v) // Format validated with validate
func
...
if !ok {
return nil
}options := &quicksight.LineSeriesAxisDisplayOptions{}if v, ok := tfMap["axis_options"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}options := &quicksight.MissingDataConfiguration{}if v, ok := tfMap["treatment_option"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}options := &quicksight.SeriesItem{}if v, ok := tfMap["data_field_series_item"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.DataFieldSeriesItem{}if v, ok := tfMap["axis_binding"].(string); ok && v != "" {
options.AxisBinding = aws.String(v)
}
...
if !ok {
return nil
}options := &quicksight.FieldSeriesItem{}if v, ok := tfMap["axis_binding"].(string); ok && v != "" {
options.AxisBinding = aws.String(v)
}
if v, ok := tfMap["field_id"].(string); ok && v != "" {
options.FieldId = aws.String(v)
...
if !ok {
return nil
}options := &quicksight.LineChartSeriesSettings{}if v, ok := tfMap["line_style_settings"].([]interface{}); ok && len(v) > 0 {
options.LineStyleSettings = expandLineChartLineStyleSettings(v)
}
if v, ok := tfMap["marker_style_settings"].([]interface{}); ok && len(v) > 0 {
options.MarkerStyleSettings = expandLineChartMarkerStyleSettings(v)
