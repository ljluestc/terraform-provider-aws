...
if !ok {
return nil
}visual := &quicksight.PieChartVisual{}if v, ok := tfMap["visual_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.PieChartConfiguration{}if v, ok := tfMap["category_label_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.PieChartFieldWells{}if v, ok := tfMap["pie_chart_aggregated_field_wells"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.PieChartAggregatedFieldWells{}if v, ok := tfMap["category"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.PieChartSortConfiguration{}if v, ok := tfMap["category_items_limit"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.DonutOptions{}if v, ok := tfMap["arc_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.ArcOptions{}if v, ok := tfMap["arc_thickness"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.DonutCenterOptions{}if v, ok := tfMap["label_visibility"].(string); ok && v != "" {
