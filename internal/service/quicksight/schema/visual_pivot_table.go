...
if !ok {
return nil
}visual := &quicksight.PivotTableVisual{}if v, ok := tfMap["visual_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.PivotTableConfiguration{}if v, ok := tfMap["field_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.PivotTableFieldWells{}if v, ok := tfMap["pivot_table_aggregated_field_wells"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.PivotTableAggregatedFieldWells{}if v, ok := tfMap["columns"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.PivotTableSortConfiguration{}if v, ok := tfMap["field_sort_options"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}options := &quicksight.PivotFieldSortOptions{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.PivotTableSortBy{}if v, ok := tfMap["column"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.DataPathSort{}if v, ok := tfMap["direction"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.PivotTableFieldOptions{}if v, ok := tfMap["data_path_options"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}options := &quicksight.PivotTableDataPathOption{}if v, ok := tfMap["width"].(string); ok && v != "" {
...
if tfMap == nil {
return nil
}options := &quicksight.PivotTableFieldOption{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
options.FieldId = aws.String(v)
}
...
if !ok {
return nil
}options := &quicksight.PivotTablePaginatedReportOptions{}if v, ok := tfMap["overflow_column_header_visibility"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.PivotTableOptions{}if v, ok := tfMap["collapsed_row_dimensions_visibility"].(string); ok && v != "" {
...
if !ok {
return nil
}style := &quicksight.TableCellStyle{}if v, ok := tfMap["background_color"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.GlobalTableBorderOptions{}if v, ok := tfMap["side_specific_border"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.TableSideBorderOptions{}if v, ok := tfMap["bottom"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.TableBorderOptions{}if v, ok := tfMap["color"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.PivotTableTotalOptions{}if v, ok := tfMap["column_subtotal_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.SubtotalOptions{}if v, ok := tfMap["custom_label"].(string); ok && v != "" {
options.CustomLabel = aws.String(v)
}
...
if tfMap == nil {
return nil
}options := &quicksight.PivotTableFieldSubtotalOptions{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
options.FieldId = aws.String(v)
}
return options
...
if !ok {
return nil
}options := &quicksight.PivotTotalOptions{}if v, ok := tfMap["custom_label"].(string); ok && v != "" {
options.CustomLabel = aws.String(v)
}
...
if !ok {
return nil
}options := &quicksight.RowAlternateColorOptions{}if v, ok := tfMap["status"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.PivotTableConditionalFormatting{}if v, ok := tfMap["conditional_formatting_options"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}options := &quicksight.PivotTableConditionalFormattingOption{}if v, ok := tfMap["cell"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.PivotTableCellConditionalFormatting{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
options.FieldId = aws.String(v)
}
...
if !ok {
return nil
}options := &quicksight.PivotTableConditionalFormattingScope{}if v, ok := tfMap["role"].(string); ok && v != "" {
