...
if !ok {
return nil
}visual := &quicksight.TableVisual{}if v, ok := tfMap["visual_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.TableConfiguration{}if v, ok := tfMap["field_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.TableFieldWells{}if v, ok := tfMap["table_aggregated_field_wells"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.TableAggregatedFieldWells{}if v, ok := tfMap["group_by"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.TableUnaggregatedFieldWells{}if v, ok := tfMap["values"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}options := &quicksight.UnaggregatedField{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.TableSortConfiguration{}if v, ok := tfMap["pagination_configuration"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.TableFieldOptions{}if v, ok := tfMap["order"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}options := &quicksight.TableFieldOption{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
options.FieldId = aws.String(v)
}
...
if !ok {
return nil
}options := &quicksight.TableFieldURLConfiguration{}if v, ok := tfMap["image_configuration"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.TableFieldImageConfiguration{}if v, ok := tfMap["sizing_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.TableCellImageSizingConfiguration{}if v, ok := tfMap["table_cell_image_scaling_configuration"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.TableFieldLinkConfiguration{}if v, ok := tfMap["target"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.TableFieldLinkContentConfiguration{}if v, ok := tfMap["custom_icon_content"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.TableFieldCustomIconContent{}if v, ok := tfMap["icon"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.TableFieldCustomTextContent{}if v, ok := tfMap["value"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.TablePaginatedReportOptions{}if v, ok := tfMap["overflow_column_header_visibility"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.TableOptions{}if v, ok := tfMap["orientation"].(string); ok && v != "" {
...
if !ok {
return nil
}options := &quicksight.TotalOptions{}if v, ok := tfMap["custom_label"].(string); ok && v != "" {
options.CustomLabel = aws.String(v)
}
...
if !ok {
return nil
}options := &quicksight.TableConditionalFormatting{}if v, ok := tfMap["conditional_formatting_options"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}options := &quicksight.TableConditionalFormattingOption{}if v, ok := tfMap["cell"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.TableCellConditionalFormatting{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
options.FieldId = aws.String(v)
}
...
if !ok {
return nil
}options := &quicksight.TableRowConditionalFormatting{}if v, ok := tfMap["background_color"].([]interface{}); ok && len(v) > 0 {
...
if tfMap == nil {
return nil
}options := &quicksight.TableInlineVisualization{}if v, ok := tfMap["data_bars"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.DataBarsOptions{}if v, ok := tfMap["field_id"].(string); ok && v != "" {
options.FieldId = aws.String(v)
}
