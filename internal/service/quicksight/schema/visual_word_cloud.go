...
if !ok {
return nil
}visual := &quicksight.WordCloudVisual{}if v, ok := tfMap["visual_id"].(string); ok && v != "" {
...
if !ok {
return nil
}config := &quicksight.WordCloudChartConfiguration{}if v, ok := tfMap["category_label_options"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.WordCloudFieldWells{}if v, ok := tfMap["word_cloud_aggregated_field_wells"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.WordCloudAggregatedFieldWells{}if v, ok := tfMap["group_by"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}config := &quicksight.WordCloudSortConfiguration{}if v, ok := tfMap["category_items_limit"].([]interface{}); ok && len(v) > 0 {
...
if !ok {
return nil
}options := &quicksight.WordCloudOptions{}if v, ok := tfMap["cloud_layout"].(string); ok && v != "" {
