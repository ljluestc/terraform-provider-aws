...
functest.RegisterServiceErrorCheckFunc(rds.EndpointsID, testAccErrorCheckSkip)
}
func testAccErrorCheckSkip(t *testing.T) resource.ErrorCheckFunc {
funcngine mode serverless you requested is currently unavailable",
		"engine mode multimaster you requested is currently unavailable",
		"requested engine version was not found or does not support parallelquery 
functionality",
		"Backtrack is not enabled for the aurora engine",
		"Read replica DB clusters are not available in this region for engine auro
func
}
func TestAccRDSCluster_basic(t *testing.T) {
	ctx := acctest.Context(t)
	var dbCluster rds.DBCluster
funcourceName := "aws_rds_cluster.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
...
func() { acctest.PreCheck(ctx, t) },
		...
		CheckDestroy:testAccCheckClusterDestroy(ctx),
		Steps: []resource.TestStep{
funcConfig: testAccClusterConfig_identifierPrefix("tf-test-"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &v),
...
funcineVersion2 := "13.5"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func TestAccRDSCluster_allowMajorVersionUpgradeWithCustomParametersApplyImm(t *testing.T) {
	...
	engine := "aurora-postgresql"
	engineVersion1 := "12.9"
	engineVersion2 := "13.5"	resource.ParallelTest(t, resource.TestCase{
funcrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
		CheckDestroy:testAccCheckClusterDestroy(ctx),
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &dbCluster2),
					resource.T
func	resource.TestCheckResourceAttr(resourceName, "engine", engine),
					resource.TestCheckResourceAttr(resourceName, "engine_version", engineVersion2),
				),
			},
		},
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{
					"allow_major_version_upgrade",
					"apply_imm
func	"cluster_identifier_prefix",
					"db_instance_parameter_group_name",
					"enable_global_write_forwarding",
					"master_password",
					"skip_final_snapshot",
...
func TestAccRDSCluster_onlyMajorVersion(t *testing.T) {
	...
	// to TestAccDMSReplicationInstance_engineVersion
	engine := "aurora-postgresql"
	engineVersion1 := "11"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
		CheckDestroy:testAccCheckClusterDestroy(ctx),
		Steps: []resource.TestStep{
funcConfig: testAccClusterConfig_majorVersionOnly(rName, false, engine, engineVersion1),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &dbCluster1),
					resource.TestCheckResourceAttr(resourceName, "engine", engine),
					resource.TestCheckResourceAttr(resourceName, "engine_version", engineVersion1),
...
func TestAccRDSCluster_minorVersion(t *testing.T) {
	...
	engine := "aurora-postgresql"
	engineVersion1 := "14.6"
	engineVersion2 := "14.7"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func TestAccRDSCluster_allocatedStorage(t *testing.T) {
	...
	var dbCluster rds.DBCluster
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName := "aws_rds_cluster.test"	resource.Paral
funceCheck: 
func() { acctest.PreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func TestAccRDSCluster_storageTypeAuroraIopt1UpdateAurora(t *testing.T) {
	...
	var dbCluster1, dbCluster2 rds.DBCluster
funcrageTypeAuroraIOPT1 := "aurora-iopt1"
	storageTypeAurora := "aurora"
	storageTypeEmpty := ""
	resourceName := "aws_rds_cluster.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		...
		Steps: []resource.TestStep{
			{
funcConfig: testAccClusterConfig_auroraStorageType(rName, storageTypeAuroraIOPT1),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &dbCluster1),
					resource.TestCheckResourceAttr(resourceName, "storage_type", storageTypeAuroraIOPT1),
				),
...
func	testAccCheckClusterExists(ctx, resourceName, &dbCluster),
				),
			},
		},
	})
...
func TestAccRDSCluster_pointInTimeRestore(t *testing.T) {
	...
	resourceName := "aws_rds_cluster.restore"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func// This is a regression test to make sure that we always cover the scenario as highlighted in
...
func	testAccCheckClusterExists(ctx, resourceName, &v),
...
func TestAccRDSCluster_ReplicationSourceIdentifier_kmsKeyID(t *testing.T) {
	ctx := acctest.Context(t)
	if testing.Short() {
func	var primaryCluster rds.DBCluster
...
func
	...
	var providers []*schema.Provider	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() {
...
func TestAccRDSCluster_backupsUpdate(t *testing.T) {
	ctx := acctest.Context(t)
	var v rds.DBCl
funcourceName := "aws_rds_cluster.test"	ri := sdkacctest.RandInt()
	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
...
func() { acctest.PreCheck(ctx, t) },
		...
		Steps: []resource.TestStep{
			{
funcConfig: testAccClusterConfig_iamAuth(sdkacctest.RandInt()),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &v),
					resource.TestCheckResourceAttr(
...
func TestAccRDSCluster_engineMode(t *testing.T) {
	...
	if testing.Short() {
		t.Skip("skipping long-running test in short mode")
	}	var dbCluster1, dbCluster2 rds.DBCluster	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName := "aws_rds_cluster.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
func	resource.TestCheckResourceAttr(resourceName, "engine_mode", "serverless"),
...
func dbCluster rds.DBCluster
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName := "aws_rds_cluster.test"
	dataSourceName := "data.aws_rds_engine_version.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		ErrorCheck:
funcotoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func
	...
	dataSourceNameUpgrade := "data.aws_rds_engine_version.upgrade"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func TestAccRDSCluster_GlobalClusterIdentifierEngineMode_global(t *testing.T) {
	ctx := acctest.Context(t)
	var dbCluster1 rds.DBCluster	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	globalClusterResourceName := "aws_rds_global_cluster.test"
	resourceName := "aws_rds_cluster.test"
funceCheck: 
func() { acctest.PreCheck(ctx, t); testAccPreCheckGlobalCluster(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
		CheckDestroy:testAccCheckClusterDestroy(ctx),
		Steps: []resource.TestStep{
...
func TestAccRDSCluster_GlobalClusterIdentifierEngineModeGlobal_remove(t *testing.T) {
	ctx := acctest.Context(t)
	var dbCluster1 rds.DBCluster	rName := sdkac
funcbalClusterResourceName := "aws_rds_global_cluster.test"
	resourceName := "aws_rds_cluster.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t); testAccPreCheckGlobalCluster(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
...
func TestAccRDSCluster_GlobalClusterIdentifier_primarySecondaryClusters(t *testing.T) {
	...
	var primaryDbCluster, secondaryDbCluster rds.DBCluster	rNameGlobal :=
funcmePrimary := sdkacctest.RandomWithPrefix("tf-acc-test-primary")
	rNameSecondary := sdkacctest.RandomWithPrefix("tf-acc-test-secondary")	resourceNamePrimary := "aws_rds_cluster.primary"
	resourceNameSecondary := "aws_rds_cluster.secondary"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() {
			acctest.PreCheck(ctx, t)
			acctest.PreCheckMultipleRegion(t, 2)
...
func primaryDbCluster, secondaryDbCluster rds.DBCluster	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
funcSkip("skipping long-running test in short mode")
	...
	var primaryDbCluster, secondaryDbCluster rds.DBCluster	rNameGlobal := sdkacctest.RandomWithPrefix("tf-acc-test-global")
...
func	resource.TestCheckResourceAttrSet(resourceName, "master_user_secret.0.kms_key_id"),
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{
					...
					"db_instance_parameter_group_name",
					"enable
func	"manage_master_user_password",
					"skip_final_snapshot",
				},
			},
		},
...
func dbCluster1, dbCluster2 rds.DBCluster
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName := "aws_rds_cluster.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
...
func TestAccRDSCluster_scaling(t *testing.T) {
	...
	if testing.Short() {
		t.Skip("skipping long-running test in short mode")
	}	var dbCluster rds.DBCluster	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	resourceName := "aws_rds_cluster.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
func	resource.TestCheckResourceAttr(resourceName, "scaling_configuration.#", "1"),
...
func() { acctest.PreCheck(ctx, t) },
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &dbCluster),
func	resource.TestCheckResourceAttr(resourceName, "serverlessv2_scaling_configuration.0.max_capacity", "128"),
...
funceference: https://github.com/hashicorp/terraform-provider-aws/issues/11698
...
func dbClusterSnapshot rds.DBClusterSnapshot	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func
	var dbCluster, sourceDbCluster rds.DBCluster
	var dbClusterSnapshot rds.DBClusterSnapshot	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	sourceDbResourceName := "aws_rds_cluster.source"
	snapshotResourceName := "aws_db_cluster_snapshot.test"
	resourceName := "aws_rds_cluster.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		...
		Steps: []resource.TestStep{
			{
funcConfig: testAccClusterConfig_SnapshotID_engineMode(rName, "serverless"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, sourceDbResourceName, &sourceDbCluster),
					testAccCheckClusterSnapshotExists(ctx, snapshotResourceName, &dbClusterSnapshot),
					testAccCheckClusterExists(ctx, resourceName, &dbCluster),
...
func
	...
	snapshotResourceName := "aws_db_cluster_snapshot.test"
	resourceName := "aws_rds_cluster.test"
	dataSourceName := "data.aws_rds_engine_version.upgrade"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
func() { acctest.PreCheck(ctx, t) },
		ErrorCheck:acctest.ErrorCheck(t, rds.EndpointsID),
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
func	testAccCheckClusterExists(ctx, sourceDbResourceName, &sourceDbCluster),
					testAccCheckClusterSnapshotExists(ctx, snapshotResourceName, &dbClusterSnapshot),
					testAccCheckClusterExists(ctx, resourceName, &dbCluster),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
func	testAccCheckClusterSnapshotExists(ctx, snapshotResourceName, &dbClusterSnapshot),
					testAccCheckClusterExists(ctx, resourceName, &dbCluster),
...
func
	...
	// in other tests.	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	sourceDbResourceName := "aws_rds_cluster.source"
	snapshotResourceName := "aws_db_cluster_snapshot.test"
	resourceName := "aws_rds_cluster.test"	resource.ParallelTest(t, resource.TestCase{
		PreCheck: 
...
func
funcurn 
func(s *terraform.State, provider *schema.Provider) error {
		conn := provider.Meta().(*conns.AWSClient).RDSConn(ctx)		for _, rs := range s.RootModule().Resources {
			if rs.Type != "aws_rds_cluster" {
				continue
			}			_, err := tfrds.FindDBClusterByID(ctx, conn, rs.Primary.ID)			if tfresource.NotFound(err) {
				continue
			}			if err != nil {
				return err
func			return fmt.Errorf("RDS Cluster %s still exists", rs.Primary.ID)
		}		return nil
	}
}
...
func testAccCheckClusterExists(ctx context.Context, n string, v *rds.DBCluster) resource.TestCheckFunc {
	return testAccCheckClusterExistsWithProvider(ctx, n, v, 
func() *schema.Provider { return acctest.Provider })
}
func testAccCheckClusterExistsWithProvider(ctx context.Context, n string, v *rds.DBCluster, providerF 
func() *schema.Provider) resource.TestCheckFunc {
	return 
func(s *terraform.State) error {
...
funceturn fmt.Errorf("Not found: %s", n)
		...
		}		conn := providerF().Meta().(*conns.AWSClient).RDSConn(ctx)		output, err := tfrds.FindDBClusterByID(ctx, conn, rs.Primary.ID)
		if err != nil {
			return err
		}
func
...
funcurn fmt.Sprintf(`
data "aw
func "aws_partition" "current" {}resource "aws_kms_key" "example" {
...
"Resource": "*"
 ...
 POLICY}resource "aws_rds_cluster" "test" {
cluster_identifier = %[1]q
database_name= "test"
engine= "aurora-mysql"
manage_master_user_password= true
...
master_username= "tfacctest"
func
func "aws_rds_orderable_db_instance" "test" {
...
engine
funcentifier= %[2]q
instance_class= data.aws_rds_orderable_db_instance.test.instance_classlifecycle {
...
resource "aws_rds_cluster_instance" "test" {
funcgine= aws_rds_cluster.test.engine
engine_version= aws_rds_cluster.test.engine_version
identifier= %[2]q
...
resource "aws_rds_cluster_instance" "test" {
funcuster_identifier= aws_rds_cluster.test.id
db_parameter_group_name = aws_db_parameter_group.test.name
engine= data.aws_rds_orderable_db_instance.test.engine
engine_version = data.aws_rds_orderable_db_instance.test.engine_version
identifier = %[1]q
...
skip_final_snapshot = true
engine = aws_rds_cluster.test.enginerestore_to_point_in_time {
...
funcurce "aws_rds_cluster" "restore" {
cluster_identifier = "%[1]s-restore"
skip_final_snapshot= true
engine= aws_rds_cluster.test.engine
enabled_cloudwatch_logs_exports = [%[2]q]restore_to_point_in_time {
 source_cluster_identifier= aws_rds_cluster.test.cluster_identifier
 restore_type= "full-copy"
 use_latest_restorable_time = true
}
...
data "aws_partition" "current" {}resource "aws_kms_key" "foo" {
...
func "aws_rds_engine_version" "test" {
engine= "aurora-postgresql"
...
cluster_identifier = %[1]q
func_cluster_parameter_group_name = "default.${local.parameter_group_name}"
engine= data.aws_rds_engine_version.test.engine
...
funcuster_identifier = aws_rds_cluster.test.cluster_identifier
engine= aws_rds_cluster.test.engine
...
role = aws_iam_role.rds_sample_role.namepolicy = <<EOF
{
"Version": "2012-10-17",
"Statement": {
 "Effect": "Allow",
...
role = aws_iam_role.another_rds_sample_role.namepolicy = <<EOF
{
"Version": "2012-10-17",
"Statement": {
 "Effect": "Allow",
...
db_cluster_parameter_group_name = "default.aurora-mysql5.7"
skip_final_snapshot= true
iam_roles = [aws_iam_role.rds_sample_role.arn, aws_iam_role.another_rds_sample_role.arn]tags = {
 Environment = "production"
func
depends_on = [aws_iam_role.another_rds_sample_role, aws_iam_role.rds_sample_role]
}
...
db_cluster_parameter_group_name = "default.aurora-mysql5.7"
skip_final_snapshot= true
iam_roles = [aws_iam_role.another_rds_sample_role.arn]tags = {
 Environment = "production"
...
data "aws_region" "current" {}resource "aws_rds_cluster_parameter_group" "test" {
name= %[1]q
family= "aurora-mysql5.7"
description = "RDS default cluster parameter group"parameter {
 name= "binlog_format"
 value= "STATEMENT"
...
provider = "awsalternate"description = %[1]qpolicy = <<POLICY
{
"Version": "2012-10-17",
"Id": "kms-tf-1",
"Statement": [
...
provider = "awsalternate"count = 3vpc_id= aws_vpc.test.id
...
provider = "awsalternate"cluster_identifier= "%[1]s-replica"
db_subnet_group_name = aws_db_subnet_group.test.name
engine= "aurora-mysql"
...
source_region = data.aws_region.current.namedepends_on = [
...
master_password= "barbarbarbar"
master_username= "foo"
skip_final_snapshot = truescaling_configuration {
 min_capacity = 2
}
}
`, rName)
...
func testAccClusterConfig_GlobalClusterID_primarySecondaryClusters(rNameGlobal, rNamePrimary, rNameSecondary string) string {
	return acctest.ConfigCompose(
		...
		fmt.Sprintf(`
data "aws_region" "current" {}data "aws_availability_zones" "alternate" {
...
provider= "awsalternate"
funcbnet_ids = aws_subnet.alternate[*].id
...
engine = aws_rds_global_cluster.test.engine
engine_version= aws_rds_global_cluster.test.engine_version
depends_on= [aws_rds_cluster_instance.primary]lifecycle {
 ignore_changes = [
...
func testAccClusterConfig_GlobalClusterID_secondaryClustersWriteForwarding(rNameGlobal, rNamePrimary, rNameSecondary string) string {
	return acctest.ConfigCompose(
		acctest.ConfigMultipleRegionProvider(2),
func "aws_region" "current" {}data "aws_availability_zones" "alternate" {
provider = "awsalternate"
state = "available"filter {
 name= "opt-in-status"
 values = ["opt-in-not-required"]
...
identifier= "%[2]s"
funcstance_class= "db.r4.large" # only db.r4 or db.r5 are valid for Aurora global db
engine= aws_rds_cluster.primary.engine
engine_version= aws_rds_cluster.primary.engine_version
}resource "aws_vpc" "alternate" {
provider= "awsalternate"
...
provider = "awsalternate"
func_subnet_group_name= aws_db_subnet_group.alternate.name
skip_final_snapshot= true
source_region= data.aws_region.current.name
global_cluster_identifier= aws_rds_global_cluster.test.id
...
cluster_identifier = aws_rds_cluster.secondary.id
instance_class= "db.r4.large" # only db.r4 or db.r5 are valid for Aurora global db
funcgine_version= aws_rds_cluster.secondary.engine_version
}
`, rNameGlobal, rNamePrimary, rNameSecondary))
}
...
func "aws_rds_engine_version" "default" {
engine = "aurora-postgresql"
}data "aws_rds_orderable_db_instance" "test" {
...
provider= "awsalternate"
depends_on = [aws_rds_cluster_instance.primary]cluster_identifier= "%[1]s-secondary"
db_subnet_group_name = aws_db_subnet_group.alternate.name
engine= aws_rds_global_cluster.test.engine
engine_version= aws_rds_global_cluster.test.engine_version
global_cluster_identifier= aws_rds_global_cluster.test.id
...
provider = "awsalternate"cluster_identifier = aws_rds_cluster.secondary.id
engine= aws_rds_cluster.secondary.engine
engine_version= aws_rds_cluster.secondary.engine_version
...
skip_final_snapshot = true
engine = data.aws_rds_engine_version.test.engine
engine_version= data.aws_rds_engine_version.test.versionserverlessv2_scaling_configuration {
 max_capacity = %[2]f
 min_capacity = %[3]f
}
}
...
funcThis config will never need the version updated. Use as a model for changing the other
	// tests.
	return fmt.Sprintf(`
data "aws_rds_engine_version" "test" {
engine = "aurora-mysql"
...
skip_final_snapshot = true
funcgine = data.aws_rds_engine_version.test.engine
}
...
func_cluster_identifier = aws_rds_cluster.source.id
db_cluster_snapshot_identifier = %[1]q
}resource "aws_rds_cluster" "test" {
cluster_identifier= %[1]q
engine = "aurora-mysql"
...
skip_final_snapshot = true
snapshot_identifier = aws_db_cluster_snapshot.test.id
vpc_security_group_ids = [data.aws_security_group.default.id]tags = {
 key1 = "value1"
}
}
`, rName)
...
func testAccClusterConfig_SnapshotID_encryptedRestore(rName string) string {
	return fmt.Sprintf(`
resource "aws_kms_key" "test" {}resource "aws_rds_cluster" "source" {
cluster_identifier= "%[1]s-source"
engine = "aurora-mysql"
master_password= "barbarbarbar"
master_username= "foo"
...
db_cluster_identifier = aws_rds_cluster.source.id
funcresource "aws_rds_cluster" "test" {
cluster_identifier= %[1]q
engine = "aurora-mysql"
skip_final_snapshot = true
snapshot_identifier = aws_db_cluster_snapshot.test.idstorage_encrypted = true
kms_key_id= aws_kms_key.test.arn
}
`, rName)
}
...
master_username= "foo"
skip_final_snapshot= true
enable_http_endpoint = %tscaling_configuration {
 auto_pause= false
 max_capacity= 128
 min_capacity= 4
