...
funcarallel()	type testCase struct {
...
func
			...
			compareActualEngineVersion(d, test.configuredVersion, test.actualVersion, test.pendingVersion)			if want, got := test.expectedEngineVersion, d.Get("engine_version"); got != want {
