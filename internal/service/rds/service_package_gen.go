// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package rdsimport (
...
functory:DataSourceClusterSnapshot,
...
{
funceName: "aws_db_cluster_snapshot",
	Name:"DB Cluster Snapshot",
	Tags: &types.ServicePackageResourceTags{
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*rds_sdkv1.RDS, error) {
	sess := config["session"].(*session_sdkv1.Session)	return rds_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
}
funcewClient returns a new AWS SDK for Go v2 client for this service package's AWS API.
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*rds_sdkv2.Client, error) {
	cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))	return rds_sdkv2.NewFromConfig(cfg, 
func(o *rds_sdkv2.Options) {
if endpoint := config["endpoint"].(string); endpoint != "" {
	o.BaseEndpoint = aws_sdkv2.String(endpoint)
func nil
}
func ServicePackage(ctx context.Conte
