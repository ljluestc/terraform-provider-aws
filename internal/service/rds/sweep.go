...
return fmt.Errorf("error getting client: %s", err)
	...
	sweepResources := make([]sweep.Sweepable, 0)	err = conn.DescribeDBClusterParameterGroupsPagesWithContext(ctx, input, 
func(page *rds.DescribeDBClusterParameterGroupsOutput, lastPage bool) bool {
if page == nil {
	return !lastPage
funcfor _, v := range page.DBClusterParameterGroups {
	name := aws.StringValue(v.DBClusterParameterGroupName)	if strings.HasPrefix(name, "default.") {
continue
	}	r := ResourceClusterParameterGroup()
	d := r.Data(nil)
	d.SetId(name)	sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
...
Filters: []*rds.Filter{{
	...
	sweepResources := make([]sweep.Sweepable, 0)	err = conn.DescribeDBClusterSnapshotsPagesWithContext(ctx, input, 
...
func_, v := range page.DBClusterSnapshots {
	...
	d := r.Data(nil)
	d.SetId(aws.StringValue(v.DBClusterSnapshotIdentifier))	sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
	})	if sweep.SkipSweepError(err) {
...
func sweepClusters(region string) error {
	...
	if err != nil {
return fmt.Errorf("error getting client: %s", err)
funcn := client.RDSConn(ctx)	var sweeperErrs *multierror.Error
	sweepResources := make([]sweep.Sweepable, 0)	input := &rds.DescribeDBClustersInput{}
	err = conn.DescribeDBClustersPagesWithContext(ctx, input, 
func(page *rds.DescribeDBClustersOutput, lastPage bool) bool {
if page == nil {
	return !lastPage
}for _, v := range page.DBClusters {
	arn := aws.StringValue(v.DBClusterArn)
func:= aws.StringValue(v.DBClusterIdentifier)
	r := ResourceCluster()
	d := r.Data(nil)
	d.SetId(id)
	...
	d.Set("skip_final_snapshot", true)	if engineMode := aws.StringValue(v.EngineMode); engineMode == EngineModeGlobal || engineMode == EngineModeProvisioned {
...
return fmt.Errorf("error getting client: %s", err)
	...
	conn := client.RDSConn(ctx)
funcepResources := make([]sweep.Sweepable, 0)	err = conn.DescribeEventSubscriptionsPagesWithContext(ctx, input, 
...
func = conn.DescribeGlobalClustersPagesWithContext(ctx, input, 
...
if page == nil {
	...
	d.Set("global_cluster_members", flattenGlobalClusterMembers(v.
func
	sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
	})	if sweep.SkipSweepError(err) {
...
return fmt.Errorf("error getting client: %s", err)
	...
	conn := client.RDSConn(ctx)
	sweepResources := make([]sweep.Sweepable, 0)	err = conn.DescribeDBInstancesPagesWithContext(ctx, input, 
...
funcet("skip_final_snapshot", true)	sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
	})	if sweep.SkipSweepError(err) {
...
return fmt.Errorf("error getting client: %s", err)
	...
	conn := client.RDSConn(ctx)
	sweepResources := make([]sweep.Sweepable, 0)	err = conn.DescribeOptionGroupsPagesWithContext(ctx, input, 
func(page *rds.DescribeOptionGroupsOutput, lastPage bool) bool {
if page == nil {
	return !lastPage
func
for _, v := range page.OptionGroupsList {
	name := aws.StringValue(v.OptionGroupName)	if strings.HasPrefix(name, "default:") {
continue
...
return fmt.Errorf("error getting client: %s", err)
	...
	conn := client.RDSConn(ctx)
	sweepResources := make([]sweep.Sweepable, 0)	err = conn.DescribeDBParameterGroupsPagesWithContext(ctx, input, 
func(page *rds.DescribeDBParameterGroupsOutput, lastPage bool) bool {
if page == nil {
	return !lastPage
}
funce := aws.StringValue(v.DBParameterGroupName)	if strings.HasPrefix(name, "default.") {
continue
	}	r := ResourceParameterGroup()
	d := r.Data(nil)
	d.SetId(name)	sweepResources = append(sweepResources, sweep.NewSweepResource(r,
funcreturn !lastPage
	})	if sweep.SkipSweepError(err) {
...
return fmt.Errorf("Error getting client: %s", err)
	...
	sweepResources := make([]sweep.Sweepable, 0)	err = conn.DescribeDBProxiesPagesWithContext(ctx, input, 
func(page *rds.DescribeDBProxiesOutput, lastPage bool) bool {
if page == nil {
	return !lastPage
}for _, v := range page.DBProxies {
	r := ResourceProxy()
funcetId(aws.StringValue(v.DBProxyName))	sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
	})	if sweep.SkipSweepError(err) {
...
return fmt.Errorf("error getting client: %s", err)
	...
	sweepResources := make([]sweep.Sweepable, 0)	err = conn.DescribeDBSnapshotsPagesWithContext(ctx, input, 
func(page *rds.DescribeDBSnapshotsOutput, lastPage bool) bool {
if page == nil {
	return !lastPage
}for _, v := range page.DBSnapshots {
	id := aws.StringValue(v.DBSnapshotIdentifier)	if strings.HasPrefix(id, "rds:") {
func	r := ResourceSnapshot()
	d := r.Data(nil)
...
return fmt.Errorf("error getting client: %s", err)
	...
	sweepResources := make([]sweep.Sweepable, 0)	err = conn.DescribeDBSubnetGroupsPagesWithContext(ctx, input, 
...
if page == nil {
	...
	d := r.Data(nil)
	d.SetId(aws.StringValue(v.DBSubnetGroupName))	sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
func
return !lastPage
	})	if sweep.SkipSweepError(err) {
...
return fmt.Errorf("error listing RDS DB Subnet Groups (%s): %w"
func	err = sweep.SweepOrchestrator(ctx, sweepResources)	if err != nil {
...
return fmt.Errorf("error getting client: %s", err)
	...
	sweepResources := make([]sweep.Sweepable, 0)
	var backupARNs []string	err = conn.DescribeDBInstanceAutomatedBackupsPagesWithContext(ctx, input, 
...
funcrn fmt.Errorf("error listing RDS Instance Automated Backups (%s): %w", region, err)
	}	err = sweep.SweepOrchestrator(ctx, sweepResources)	if err != nil {
