...
var output []*redshift.Clustererr := conn.DescribeClustersPagesWithContext(ctx, input, func(page *redshift.DescribeClustersOutput, lastPage bool) bool {
if page == nil {
return !lastPage
...
output, err := findClusters(ctx, conn, input)if err != nil {
return nil, err
