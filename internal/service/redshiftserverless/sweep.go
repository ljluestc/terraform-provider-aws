...
var errs *multierror.Errorerr = conn.ListNamespacesPagesWithContext(ctx, input, func(page *redshiftserverless.ListNamespacesOutput, lastPage bool) bool {
...
sweepResources := make([]sweep.Sweepable, 0)
var errs *multierror.Errorerr = conn.ListWorkgroupsPagesWithContext(ctx, input, func(page *redshiftserverless.ListWorkgroupsOutput, lastPage bool) bool {
...
sweepResources := make([]sweep.Sweepable, 0)
var errs *multierror.Errorerr = conn.ListSnapshotsPagesWithContext(ctx, input, func(page *redshiftserverless.ListSnapshotsOutput, lastPage bool) bool {
