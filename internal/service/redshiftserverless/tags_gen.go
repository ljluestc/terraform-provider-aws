...
package redshiftserverlessimport (
"context"
...
tags, err := listTags(ctx, meta.(*conns.AWSClient).RedshiftServerlessConn(ctx), identifier)if err != nil {
return err
}if inContext, ok := tftags.FromContext(ctx); ok {
inContext.TagsOut = types.Some(tags)
}return nil
}// []*SERVICE.Tag handling// Tags returns redshiftserverless service tags.
func Tags(tags tftags.KeyValueTags) []*redshiftserverless.Tag {
result := make([]*redshiftserverless.Tag, 0, len(tags))for k, v := range tags.Map() {
