...
"log"
"testing"
"time""github.com/aws/aws-sdk-go/service/route53resolver"
...
resourceName := "aws_route53_resolver_firewall_rule.test"propagationSleep :=func() resource.TestCheck
func {
...
action := "ALLOW"
priority := "100"resource.ParallelTest(t, resource.TestCase{
