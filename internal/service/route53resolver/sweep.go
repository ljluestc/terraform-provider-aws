...
// +build sweeppackage route53resolverimport (
"fmt"
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListResolverDnssecConfigsPagesWithContext(ctx, input,
...
d.Set("resource_id", v.ResourceId)sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListResolverEndpointsPagesWithContext(ctx, input,
...
r := ResourceEndpoint()
d := r.Data(nil)
d.SetId(aws.StringValue(v.Id))sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
})if sweep.SkipSweepError(err) {
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListFirewallConfigsPagesWithContext(ctx, input,
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListFirewallDomainListsPagesWithContext(ctx, input,
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListFirewallRuleGroupAssociationsPagesWithContext(ctx, input,
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListFirewallRuleGroupsPagesWithContext(ctx, input,
...
d := r.Data(nil)
d.SetId(FirewallRuleCreateResourceID(aws.StringValue(v.FirewallRuleGroupId), aws.StringValue(v.FirewallDomainListId)))sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
})if sweep.SkipSweepError(err) {
continue
}if err != nil {
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListResolverQueryLogConfigAssociationsPagesWithContext(ctx, input,
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListResolverQueryLogConfigsPagesWithContext(ctx, input,
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListResolverRuleAssociationsPagesWithContext(ctx, input,
...
d.Set("vpc_id", v.VPCId)sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
})if sweep.SkipSweepError(err) {
...
sweepResources := make([]sweep.Sweepable, 0)err = conn.ListResolverRulesPagesWithContext(ctx, input,
