...
return fmt.Errorf("error getting client: %s", err)
	...
	var errs *multierror.Error	err = conn.ListAppMonitorsPagesWithContext(ctx, &cloudwatchrum.ListAppMonitorsInput{}, func(resp *cloudwatchrum.ListAppMonitorsOutput, lastPage bool) bool {
...
d := r.Data(nil)
d.SetId(aws.StringValue(c.Name))sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
	})	if err != nil {
