...
testAccCheckBucketServerSideEncryptionConfigurationExists(ctxcontext.Context,nstring)resource.TestCheckFunc{
return
...
iferr!=nil{
returnerr
}nn:=acctest.Provider.Meta().(*conns.AWSClient).S3Conn(ctx)_,err=tfs3.FindBucketServerSideEncryptionConfiguration(ctx,conn,bucket,expectedBucketOwner)returnerr
}
}
testAccBucketServerSideEncryptionConfigurationConfig_basic(rNamestring)string{
returnfmt.Sprintf(`
resource"aws_s3_bucket""test"{
bucket=%[1]q
}resource"aws_s3_bucket_server_side_encryption_configuration""test"{
bucket=aws_s3_bucket.test.idrule{
#ThisisAmazonS3bucketdefaultencryption.
...
testAccBucketServerSideEncryptionConfigurationConfig_applySSEByDefaultKMSMasterKeyARN(rNamestring)string{
returnfmt.Sprintf(`
resource"aws_kms_key""test"{
description="KMSKeyforBucket%[1]s"
...
testAccBucketServerSideEncryptionConfigurationConfig_applySSEByDefaultKMSMasterKeyID(rNamestring)string{
returnfmt.Sprintf(`
resource"aws_kms_key""test"{
description="KMSKeyforBucket%[1]s"
deletion_window_in_days=10
...
testAccBucketServerSideEncryptionConfigurationConfig_applySSEByDefaultSSEAlgorithm(rName,sseAlgorithmstring)string{
returnfmt.Sprintf(`
resource"aws_s3_bucket""test"{
bucket=%[1]q
}resource"aws_s3_bucket_server_side_encryption_configuration""test"{
...
`
ctestAccBucketServerSideEncryptionConfigurationConfig_keyEnabled(rNamestring,enabledbool)string{
returnfmt.Sprintf(`
resource"aws_s3_bucket""test"{
bucket=%[1]q
}resource"aws_s3_bucket_server_side_encryption_configuration""test"{
...
testAccBucketServerSideEncryptionConfigurationConfig_applySSEByDefaultKeyEnabled(rNamestring,enabledbool)string{
returnfmt.Sprintf(`
resource"aws_kms_key""test"{
description="KMSKeyforBucket%[1]s"
deletion_window_in_days=10
...
testAccBucketServerSideEncryptionConfigurationConfig_migrateNoChange(rNamestring)string{
returnfmt.Sprintf(`
resource"aws_s3_bucket""test"{
bucket=%[1]q
}resource"aws_s3_bucket_server_side_encryption_configuration""test"{
