...
resourceName := "aws_s3_bucket_server_side_encryption_configuration.test"resource.ParallelTest(t, resource.TestCase{
PreCheck: 
...
ImportStateVerify: true,
 ...
 TestAccS3BucketServerSideEncryptionConfiguration_ApplySEEByDefault_AES256(t *testing.T) {me := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName := "aws_s3_bucket_server_side_encryption_configuration.test"resource.ParallelTest(t, resource.TestCase{
PreCheck: 
() { acctest.PreCheck(ctx, t) },
ErrorCheck: acctest.ErrorCheck(t, s3.EndpointsID),
...
ImportStateVerify: true,
 ...
 TestAccS3BucketServerSideEncryptionConfiguration_ApplySSEByDefault_KMS(t *testing.T) {
ctx := acctest.Context(t)ourceName := "aws_s3_bucket_server_side_encryption_configuration.test"resource.ParallelTest(t, resource.TestCase{
PreCheck: 
() { acctest.PreCheck(ctx, t) },
ErrorCheck: acctest.ErrorCheck(t, s3.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
ImportStateVerify: true,
 ...
 TestAccS3BucketServerSideEncryptionConfiguration_ApplySSEByDefault_KMSDSSE(t *testing.T) {
...
ImportStateVerify: true,
 ...
 TestAccS3BucketServerSideEncryptionConfiguration_ApplySSEByDefault_UpdateSSEAlgorithm(t *testing.T) {
ctx := acctest.Context(t)
rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName := "aws_s3_bucket_server_side_encryption_configuration.test"ource.ParallelTest(t, resource.TestCase{
PreCheck: 
() { acctest.PreCheck(ctx, t) },
ErrorCheck: acctest.ErrorCheck(t, s3.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
...
ImportStateVerify: true,
 ...
 TestAccS3BucketServerSideEncryptionConfiguration_ApplySSEByDefault_KMSWithMasterKeyARN(t *testing.T) {
ctx := acctest.Context(t)
rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
ImportStateVerify: true,
 ...
 TestAccS3BucketServerSideEncryptionConfiguration_ApplySSEByDefault_KMSWithMasterKeyID(t *testing.T) {
ctx := acctest.Context(t)
rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName := "aws_s3_bucket_server_side_encryption_configuration.test"resource.ParallelTest(t, resource.TestCase{rorCheck: acctest.ErrorCheck(t, s3.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
CheckDestroy: acctest.CheckDestroyNoop,
Steps: []resource.TestStep{
{
...
ImportStateVerify: true,
 ...
 TestAccS3BucketServerSideEncryptionConfiguration_BucketKeyEnabled(t *testing.T) {
ctx := acctest.Context(t)
rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName := "aws_s3_bucket_server_side_encryption_configuration.test"resource.ParallelTest(t, resource.TestCase{
PreCheck: 
() { acctest.PreCheck(ctx, t) },otoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
CheckDestroy: acctest.CheckDestroyNoop,
Steps: []resource.TestStep{
{
...
ImportStateVerify: true,
 ...
 TestAccS3BucketServerSideEncryptionConfiguration_ApplySSEByDefault_BucketKeyEnabled(t *testing.T) {
ctx := acctest.Context(t)
rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName := "aws_s3_bucket_server_side_encryption_configuration.test"resource.ParallelTest(t, resource.TestCase{
PreCheck: 
() { acctest.PreCheck(ctx, t) },
ErrorCheck: acctest.ErrorCheck(t, s3.EndpointsID),eckDestroy: acctest.CheckDestroyNoop,
Steps: []resource.TestStep{
{
...
ImportStateVerify: true,
 ...
 TestAccS3BucketServerSideEncryptionConfiguration_migrate_noChange(t *testing.T) {
ctx := acctest.Context(t)
rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName := "aws_s3_bucket_server_side_encryption_configuration.test"
...
resource.TestCheckNoResourceAttr(resourceName, "rule.0.bucket_key_enabled"),
 ...
 TestAccS3BucketServerSideEncryptionConfiguration_migrate_withChange(t *testing.T) {
ctx := acctest.Context(t)
rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
resourceName := "aws_s3_bucket_server_side_encryption_configuration.test"
bucketResourceName := "aws_s3_bucket.test"resource.ParallelTest(t, resource.TestCase{
...
resource.TestCheckNoResourceAttr(resourceName, "rule.0.bucket_key_enabled"),
 ...
 testAccCheckBucketServerSideEncryptionConfigurationExists(ctx context.Context, n string) resource.TestCheckFunc {
return 
...
if err != nil {
return err
}nn := acctest.Provider.Meta().(*conns.AWSClient).S3Conn(ctx)_, err = tfs3.FindBucketServerSideEncryptionConfiguration(ctx, conn, bucket, expectedBucketOwner)return err
}
}
 testAccBucketServerSideEncryptionConfigurationConfig_basic(rName string) string {
return fmt.Sprintf(`
...
`, rName)
 ...
 testAccBucketServerSideEncryptionConfigurationConfig_applySSEByDefaultKMSMasterKeyARN(rName string) string {
return fmt.Sprintf(`
...
bucket = aws_s3_bucket.test.idle {
apply_server_side_encryption_by_default {
...
`, rName)
 ...
 testAccBucketServerSideEncryptionConfigurationConfig_applySSEByDefaultKMSMasterKeyID(rName string) string {
return fmt.Sprintf(`
resource "aws_kms_key" "test" {
description = "KMS Key for Bucket %[1]s"
deletion_window_in_days = 10
...
`, rName)
 ...
 testAccBucketServerSideEncryptionConfigurationConfig_applySSEByDefaultSSEAlgorithm(rName, sseAlgorithm string) string {
return fmt.Sprintf(`
resource "aws_s3_bucket" "test" {
bucket = %[1]q
}resource "aws_s3_bucket_server_side_encryption_configuration" "test" {
...
`
c testAccBucketServerSideEncryptionConfigurationConfig_keyEnabled(rName string, enabled bool) string {
return fmt.Sprintf(`
resource "aws_s3_bucket" "test" {
bucket = %[1]q
}resource "aws_s3_bucket_server_side_encryption_configuration" "test" {
...
sse_algorithm = "AES256"
 ...
 testAccBucketServerSideEncryptionConfigurationConfig_applySSEByDefaultKeyEnabled(rName string, enabled bool) string {
return fmt.Sprintf(`
resource "aws_kms_key" "test" {
description = "KMS Key for Bucket %[1]s"
deletion_window_in_days = 10
...
`, rName, enabled)
 ...
 testAccBucketServerSideEncryptionConfigurationConfig_migrateNoChange(rName string) string {
return fmt.Sprintf(`
resource "aws_s3_bucket" "test" {
bucket = %[1]q
}resource "aws_s3_bucket_server_side_encryption_configuration" "test" {
