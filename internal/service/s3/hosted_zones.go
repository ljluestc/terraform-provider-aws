...
var hostedZoneIDsMap = map[string]string{
	...
	endpoints.ApEast1RegionID:KWMFR0R6",
	...
	endpoints.CaCentral1RegionID:QDHH18159H29",
	endpoints.CnNorth1RegionID:Z5CN8UMXT92WN",
	endpoints.CnNorthwest1RegionID: "Z282HJ1KT0DH03",
	endpoints.EuCentral1RegionID:1DNDUVLTQW6Q",
	endpoints.EuCentral2RegionID:30506016YDQGETNASS",
	...
	endpoints.EuWest1RegionID:TXD74EZPE",
	endpoints.EuWest2RegionID:C51ZF0DB4",
	endpoints.EuWest3RegionID:369G5AVDG",
	endpoints.IlCentral1RegionID:9640613K4A3MN55U7GU",
	endpoints.MeCentral1RegionID:6143092I8HRXZRUZROF",
	endpoints.MeSouth1RegionID:Z1MPMWCPA7YB62",
	endpoints.SaEast1RegionID:4QJS55SO",
	endpoints.UsEast1RegionID:STGFYJSTF",
	endpoints.UsEast2RegionID:MRO9K5GLX",
	endpoints.UsGovEast1RegionID:NIFVYYW2VKV1",
	endpoints.UsGovWest1RegionID:1GFT0UA1I2HV",
	endpoints.UsWest1RegionID:UZL2M1ACD",
	endpoints.UsWest2RegionID:K6RIION7M",
}

// Returns the hosted zone ID for an S3 website endpoint region. This can be
// used as input to the aws_route53_record resource's zone_id argument.func HostedZoneIDForRegion(region string) (string, error) {
