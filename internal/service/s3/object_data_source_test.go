...
"github.com/hashicorp/terraform-provider-aws/internal/conns"
 ...
 := acctest.Context(t)
rInt := sdkacctest.RandInt()var rObj s3.GetObjectOutput
var dsObj s3.GetObjectOutputresourceName := "aws_s3_object.object"
dataSourceName := "data.aws_s3_object.obj"resource.ParallelTest(t, resource.TestCase{
PreCheck:
...
resource.TestCheckNoResourceAttr(dataSourceName, "body"),
 ...
 TestAccS3ObjectDataSource_basicViaAccessPoint(t *testing.T) { dsObj, rObj s3.GetObjectOutput
...
resource.TestCheckResourceAttrPair(dataSourceName, "key", resourceName, "key"),
 ...
 TestAccS3ObjectDataSource_readableBody(t *testing.T) {
...
resource.TestCheckResourceAttr(dataSourceName, "body", "yes"),
 ...
 TestAccS3ObjectDataSource_kmsEncrypted(t *testing.T) {
ctx := acctest.Context(t)
rInt := sdkacctest.RandInt() rObj s3.GetObjectOutput
var dsObj s3.GetObjectOutputresourceName := "aws_s3_object.object"
dataSourceName := "data.aws_s3_object.obj"resource.ParallelTest(t, resource.TestCase{
PreCheck:
() { acctest.PreCheck(ctx, t) },
...
resource.TestCheckResourceAttr(dataSourceName, "body", "Keep Calm and Carry On"),
 ...
 TestAccS3ObjectDataSource_bucketKeyEnabled(t *testing.T) {
ctx := acctest.Context(t)
rInt := sdkacctest.RandInt()
 dsObj s3.GetObjectOutputresourceName := "aws_s3_object.object"
dataSourceName := "data.aws_s3_object.obj"resource.ParallelTest(t, resource.TestCase{
PreCheck:
() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, s3.EndpointsID),
...
resource.TestCheckResourceAttr(dataSourceName, "body", "Keep Calm and Carry On"),
 ...
 TestAccS3ObjectDataSource_allParams(t *testing.T) {
ctx := acctest.Context(t)
rInt := sdkacctest.RandInt()var rObj s3.GetObjectOutput
...
resource.TestCheckResourceAttrPair(dataSourceName, "object_lock_retain_until_date", resourceName, "object_lock_retain_until_date"),
 ...
 TestAccS3ObjectDataSource_objectLockLegalHoldOff(t *testing.T) {
ctx := acctest.Context(t)
rInt := sdkacctest.RandInt()var rObj s3.GetObjectOutput
var dsObj s3.GetObjectOutputourceName := "aws_s3_object.object"
dataSourceName := "data.aws_s3_object.obj"resource.ParallelTest(t, resource.TestCase{
PreCheck:
() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, s3.EndpointsID),
...
resource.TestCheckNoResourceAttr(dataSourceName, "body"),
 ...
 TestAccS3ObjectDataSource_objectLockLegalHoldOn(t *testing.T) {
ctx := acctest.Context(t)
rInt := sdkacctest.RandInt()
retainUntilDate := time.Now().UTC().AddDate(0, 0, 10).Format(time.RFC3339)var rObj s3.GetObjectOutput
var dsObj s3.GetObjectOutputourceName := "aws_s3_object.object"
dataSourceName := "data.aws_s3_object.obj"resource.ParallelTest(t, resource.TestCase{
PreCheck:
() { acctest.PreCheck(ctx, t) },
...
resource.TestCheckNoResourceAttr(dataSourceName, "body"),
 ...
 TestAccS3ObjectDataSource_leadingSlash(t *testing.T) {
ctx := acctest.Context(t)
var rObj s3.GetObjectOutput
var dsObj1, dsObj2, dsObj3 s3.GetObjectOutputresourceName := "aws_s3_object.object"
dataSourceName1 := "data.aws_s3_object.obj1"
dataSourceName2 := "data.aws_s3_object.obj2"
rInt := sdkacctest.RandInt()
resourceOnlyConf, conf := testAccObjectDataSourceConfig_leadingSlash(rInt)resource.ParallelTest(t, resource.TestCase{
PreCheck:
() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, s3.EndpointsID),
ProtoV5ProviderFactories:acctest.ProtoV5ProviderFactories,
...
resource.TestCheckResourceAttr(dataSourceName1, "body", "yes"),testAccCheckObjectExistsDataSource(ctx, dataSourceName2, &dsObj2),
...
resource.TestCheckResourceAttr(dataSourceName2, "body", "yes"),testAccCheckObjectExistsDataSource(ctx, dataSourceName3, &dsObj3),
...
resource.TestCheckResourceAttr(dataSourceName3, "body", "yes"),
 ...
 TestAccS3ObjectDataSource_multipleSlashes(t *testing.T) {
ctx := acctest.Context(t)
var rObj1, rObj2 s3.GetObjectOutput
var dsObj1, dsObj2, dsObj3 s3.GetObjectOutputresourceName1 := "aws_s3_object.object1"
resourceName2 := "aws_s3_object.object2"
dataSourceName1 := "data.aws_s3_object.obj1"
dataSourceName2 := "data.aws_s3_object.obj2"
rInt := sdkacctest.RandInt()
resourceOnlyConf, conf := testAccObjectDataSourceConfig_multipleSlashes(rInt)resource.ParallelTest(t, resource.TestCase{
PreCheck:
() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, s3.EndpointsID),
ProtoV5ProviderFactories:acctest.ProtoV5ProviderFactories,
...
s-correct-form
Config: conf,
Check: resource.ComposeTestCheckFunc(testAccCheckObjectExistsDataSource(ctx, dataSourceName1, &dsObj1),
resource.TestCheckResourceAttr(dataSourceName1, "content_length", "3"),
...
resource.TestCheckResourceAttr(dataSourceName3, "body", "no"),
 ...
 TestAccS3ObjectDataSource_singleSlashAsKey(t *testing.T) {
ctx := acctest.Context(t)
...
() { acctest.PreCheck(ctx, t) },
ErrorCheck:acctest.ErrorCheck(t, s3.EndpointsID),
ProtoV5ProviderFactories:acctest.ProtoV5ProviderFactories,eps: []resource.TestStep{
{
...
t, err := conn.GetObjectWithContext(ctx, &s3.GetObjectInput{
...
rs.Primary.Attributes["bucket"]+"/"+rs.Primary.Attributes["key"], err)
 ...
 testAccObjectDataSourceConfig_basic(randInt int) string {
return fmt.Sprintf(`
...
cket = aws_s3_bucket.object_bucket.bucket
key= aws_s3_object.object.key
}
`, randInt)
}
 testAccObjectDataSourceConfig_basicViaAccessPoint(rName string) string {
return fmt.Sprintf(`
...
`, rName)
 ...
 testAccObjectDataSourceConfig_readableBody(randInt int) string {
return fmt.Sprintf(`
resource "aws_s3_bucket" "object_bucket" {
bucket = "tf-object-test-bucket-%[1]d"
}resource "aws_s3_object" "object" {
...
`, randInt)
 ...
 testAccObjectDataSourceConfig_kmsEncrypted(randInt int) string {
return fmt.Sprintf(`
resource "aws_s3_bucket" "object_bucket" {
bucket = "tf-object-test-bucket-%[1]d"
...
`, randInt)
 ...
 testAccObjectDataSourceConfig_bucketKeyEnabled(randInt int) string {
return fmt.Sprintf(`
resource "aws_s3_bucket" "object_bucket" {
bucket = "tf-object-test-bucket-%[1]d"
}resource "aws_kms_key" "example" {
...
`, randInt)
 ...
 testAccObjectDataSourceConfig_allParams(randInt int) string {
return fmt.Sprintf(`
resource "aws_s3_bucket" "object_bucket" {
bucket = "tf-object-test-bucket-%[1]d"
...
`, randInt)
 ...
 testAccObjectDataSourceConfig_lockLegalHoldOff(randInt int) string {
return fmt.Sprintf(`
resource "aws_s3_bucket" "object_bucket" {
bucket = "tf-object-test-bucket-%[1]d"object_lock_enabled = true
}resource "aws_s3_bucket_versioning" "object_bucket" {
bucket = aws_s3_bucket.object_bucket.id
versioning_configuration {
status = "Enabled"
...
`, randInt)
 ...
 testAccObjectDataSourceConfig_lockLegalHoldOn(randInt int, retainUntilDate string) string {
return fmt.Sprintf(`
resource "aws_s3_bucket" "object_bucket" {
bucket = "tf-object-test-bucket-%[1]d"object_lock_enabled = true
}resource "aws_s3_bucket_versioning" "object_bucket" {
...
`, randInt, retainUntilDate)
 ...
 testAccObjectDataSourceConfig_leadingSlash(randInt int) (string, string) {
...
`, randInt)both := fmt.Sprintf(`
%[1]sdata "aws_s3_object" "obj1" {
bucket = aws_s3_bucket.object_bucket.bucket
...
`, resources, randInt)return resources, both
}
 testAccObjectDataSourceConfig_multipleSlashes(randInt int) (string, string) {
resources := fmt.Sprintf(`
resource "aws_s3_bucket" "object_bucket" {
bucket = "tf-object-test-bucket-%[1]d"
...
`, randInt)h := fmt.Sprintf(`
%sdata "aws_s3_object" "obj1" {
bucket = aws_s3_bucket.object_bucket.bucket
key= "first/second/third/"
}data "aws_s3_object" "obj2" {
bucket = aws_s3_bucket.object_bucket.bucket
...
`, resources)return resources, both
}
 testAccObjectDataSourceConfig_singleSlashAsKey(rName string) string {
return fmt.Sprintf(`
resource "aws_s3_bucket" "test" {
bucket = %[1]q
}data "aws_s3_object" "test" {
