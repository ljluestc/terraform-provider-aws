...
funcTestAccS3ControlMultiRegionAccessPointDataSource_basic(t*testing.T){
...
functestAccMultiRegionAccessPointDataSource_base(bucket1Namestring,bucket2Namestring,rNamestring)string{
...
functestAccMultiRegionAccessPointDataSourceConfig_basic(bucket1Namestring,bucket2Namestring,rNamestring)string{
	returnacctest.ConfigCompose(testAccMultiRegionAccessPointDataSource_base(bucket1Name,bucket2Name,rName),fmt.Sprintf(`
