// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package s3controlimport (
...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*s3control_sdkv1.S3Control, error) {
	sess := config["session"].(*session_sdkv1.Session)	return s3control_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
}// NewClient returns a new AWS SDK for Go v2 client for this service package's AWS API.
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*s3control_sdkv2.Client, error) {
	cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))	return s3control_sdkv2.NewFromConfig(cfg, func(o *s3control_sdkv2.Options) {
