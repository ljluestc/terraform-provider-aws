...
func := acctest.Context(t)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		CheckDestroy:CheckImageVersionDestroy(ctx),
...
funcos.Getenv("SAGEMAKER_IMAGE_VERSION_BASE_IMAGE") == "" {
		t.Skip("Environment variable SAGEMAKER_IMAGE_VERSION_BASE_IMAGE is not set")
	}
...
funcSkip("Environment variable SAGEMAKER_IMAGE_VERSION_BASE_IMAGE is not set")
	}
...
func
		if rs.funceturn fmt.Errorf("No sagmaker Image ID is set")
		}
