...
Statement = {
 ...
 Principal = {
ata.aws_partition.main.dns_suffix}"
 }
 Condition = {
...
arn = aws_sqs_queue.test.arn
role_arn = aws_iam_role.test.arndead_letter_config {
...
role_arn = aws_iam_role.test.arnecs_parameters {
...
role_arn = aws_iam_role.test.arneventbridge_parameters {
 detail_type = %[3]q
 source = %[4]q
}
  }
...
role_arn = aws_iam_role.test.arninput = jsonencode({
 MessageBody = %[2]q
...
role_arn = aws_iam_role.test.arnkinesis_parameters {
 partition_key = %[3]q
}
  }
}
...
arn = aws_sqs_queue.test.arn
role_arn = aws_iam_role.test.arnretry_policy {
...
role_arn = aws_iam_role.test.arnsagemaker_pipeline_parameters {
 pipeline_parameter {
...
role_arn = aws_iam_role.test.arnsqs_parameters {
