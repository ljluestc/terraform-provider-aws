...
"fmt"
"testing"
"unicode""github.com/aws/aws-sdk-go/service/secretsmanager"
"github.com/hashicorp/terraform-plugin-testing/helper/resource"
"github.com/hashicorp/terraform-plugin-testing/terraform"
"github.com/hashicorp/terraform-provider-aws/internal/acctest"
)func TestAccSecretsManagerRandomPasswordDataSource_basic(t *testing.T) {
ctx := acctest.Context(t)
datasourceName := "data.aws_secretsmanager_random_password.test"resource.ParallelTest(t, resource.TestCase{
