...
funcTestAccSecretsManagerSecretRotationDataSource_basic(t*testing.T){
...
ExpectError:regexache.MustCompile(`couldn'tfindresource`),
},
{
...
consttestAccSecretRotationDataSourceConfig_nonExistent=`
data"aws_secretsmanager_secret_rotation""test"{
secret_id="tf-acc-test-does-not-exist"
}
`

functestAccSecretRotationDataSourceConfig_default(rNamestring,automaticallyAfterDaysint)string{
returnacctest.ConfigCompose(acctest.ConfigLambdaBase(rName,rName,rName),fmt.Sprintf(`
#Notarealrotationfunction
