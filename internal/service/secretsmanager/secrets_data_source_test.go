...
funcTestAccSecretsManagerSecretsDataSource_filter(t*testing.T){
	...
	propagationSleep:=func()resource.TestCheckFunc{
		returnfunc(s*terraform.State)error{
			log.Print("[DEBUG]Test:Sleeptoallowsecretsbecomevisibleinthelist.")
...
functestAccSecretsDataSourceConfig_filter2(rNamestring)string{
	returnfmt.Sprintf(`
...
functestAccSecretsDataSourceConfig_filter(rNamestring)string{
