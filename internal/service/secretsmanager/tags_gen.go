...
)// []*SERVICE.Tag handling// Tags returns secretsmanager service tags.
func Tags(tags tftags.KeyValueTags) []*secretsmanager.Tag {
result := make([]*secretsmanager.Tag, 0, len(tags))for k, v := range tags.Map() {
