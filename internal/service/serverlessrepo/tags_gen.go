...
package serverlessrepoimport (
	"context"	"github.com/aws/aws-sdk-go/aws"
	"github.com/aws/aws-sdk-go/service/serverlessapplicationrepository"
	tftags "github.com/hashicorp/terraform-provider-aws/internal/tags"
	"github.com/hashicorp/terraform-provider-aws/internal/types"
)// []*SERVICE.Tag handling// Tags returns serverlessrepo service tags.
func Tags(tags tftags.KeyValueTags) []*serverlessapplicationrepository.Tag {
	result := make([]*serverlessapplicationrepository.Tag, 0, len(tags))	for k, v := range tags.Map() {
