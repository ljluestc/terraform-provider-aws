...
resourceNamePortfolio := "aws_servicecatalog_portfolio.test"rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
Statement = [{
 ...
 Effect = "Allow"
 Principal = {
g.${data.aws_partition.current.dns_suffix}"
 }
 Sid = ""
}]
  })
