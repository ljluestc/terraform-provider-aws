// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package servicediscoveryimport (
...
sess := config["session"].(*session_sdkv1.Session)return servicediscovery_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
}
