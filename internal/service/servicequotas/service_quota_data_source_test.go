...
funcTestAccServiceQuotasServiceQuotaDataSource_quotaCode(t*testing.T){
	ctx:=acctest.Context(t)
	constdataSourceName="data.aws_servicequotas_service_quota.test"
		...
		Steps:[]resource.TestStep{
			{
				...
				Check:resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName,"quota_name","VPCsperRegion"),
					resource.TestCheckResourceAttr(dataSourceName,"service_code",setQuotaServiceCode),
					resource.TestCheckResourceAttr(dataSourceName,"service_name","AmazonVirtualPrivateCloud(AmazonVPC)"),
...
funcTestAccServiceQuotasServiceQuotaDataSource_quotaCode_Unset(t*testing.T){
	ctx:=acctest.Context(t)
	constdataSourceName="data.aws_servicequotas_service_quota.test"
		...
		Steps:[]resource.TestStep{
			{
				...
				Check:resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName,"service_name","AmazonSimpleStorageService(AmazonS3)"),
					resource.TestCheckResourceAttr(dataSourceName,"usage_metric.#","0"),
					resource.TestMatchResourceAttr(dataSourceName,"value",regexache.MustCompile(`^\d+$`)),
...
funcTestAccServiceQuotasServiceQuotaDataSource_quotaCode_hasUsageMetric(t*testing.T){
	ctx:=acctest.Context(t)
	constdataSourceName="data.aws_servicequotas_service_quota.test"
		...
		Steps:[]resource.TestStep{
			{
				...
				Check:resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName,"service_name","AmazonEC2AutoScaling"),
...
funcTestAccServiceQuotasServiceQuotaDataSource_PermissionError_quotaCode(t*testing.T){
	ctx:=acctest.Context(t)
	resource.ParallelTest(t,resource.TestCase{
		PreCheck:func(){
			acctest.PreCheck(ctx,t)
...
funcTestAccServiceQuotasServiceQuotaDataSource_quotaName(t*testing.T){
	ctx:=acctest.Context(t)
...
funcTestAccServiceQuotasServiceQuotaDataSource_quotaName_Unset(t*testing.T){
	ctx:=acctest.Context(t)
	constdataSourceName="data.aws_servicequotas_service_quota.test"
...
funcTestAccServiceQuotasServiceQuotaDataSource_quotaName_hasUsageMetric(t*testing.T){
	ctx:=acctest.Context(t)
	constdataSourceName="data.aws_servicequotas_service_quota.test"
...
funcTestAccServiceQuotasServiceQuotaDataSource_PermissionError_quotaName(t*testing.T){
	ctx:=acctest.Context(t)
	resource.ParallelTest(t,resource.TestCase{
		PreCheck:func(){
			acctest.PreCheck(ctx,t)
		...
		Steps:[]resource.TestStep{
			{
				Config:testAccServiceQuotaDataSourceConfig_permissionErrorName("elasticloadbalancing","ApplicationLoadBalancersperRegion"),
				ExpectError:regexache.MustCompile(`DEPENDENCY_ACCESS_DENIED_ERROR`),
			},
		},
	})
...
functestAccServiceQuotaDataSourceConfig_code(serviceCode,quotaCodestring)string{
	returnfmt.Sprintf(`
...
functestAccServiceQuotaDataSourceConfig_permissionErrorCode(serviceCode,quotaCodestring)string{
	policy:=`{
"Version":"2012-10-17",
"Statement":[
{
...
functestAccServiceQuotaDataSourceConfig_name(serviceCode,quotaNamestring)string{
	returnfmt.Sprintf(`
data"aws_servicequotas_service_quota""test"{
quota_name=%[1]q
service_code=%[2]q
...
functestAccServiceQuotaDataSourceConfig_permissionErrorName(serviceCode,quotaNamestring)string{
	policy:=`{
"Version":"2012-10-17",
"Statement":[
{
