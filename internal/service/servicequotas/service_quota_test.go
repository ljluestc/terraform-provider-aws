...
// SPDX-License-Identifier: MPL-2.0package servicequotas_testimport (
	"fmt"
	"os"
...
func TestAccServiceQuotasServiceQuota_basic(t *testing.T) {
	...
	const resourceName = "aws_servicequotas_service_quota.test"	resource.ParallelTest(t, resource.TestCase{
PreCheck: func() {
acctest.PreCheck(ctx, t)
testAccPreCheck(ctx, t)
preCheckServiceQuotaSet(ctx, setQuotaServiceCode, setQuotaQuotaCode, t)rorCheck: acctest.ErrorCheck(t, servicequotas.EndpointsID),
...
acctest.PreCheck(ctx, t)
testAccPreCheck(ctx, t)
preCheckServiceQuotaUnset(ctx, unsetQuotaServiceCode, unsetQuotaQuotaCode, t)rorCheck: acctest.ErrorCheck(t, servicequotas.EndpointsID),
otoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
eckDestroy:nil,
eps: []resource.TestStep{
{
...
acctest.PreCheck(ctx, t)
testAccPreCheck(ctx, t)
preCheckServiceQuotaHasUsageMetric(ctx, hasUsageMetricServiceCode, hasUsageMetricQuotaCode, t)rorCheck: acctest.ErrorCheck(t, servicequotas.EndpointsID),
otoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
eckDestroy:nil,
eps: []resource.TestStep{
{
...
"WARNING: This test will submit a real service quota increase!")
	}	resourceName := "aws_servicequotas_service_quota.test"	resource.ParallelTest(t, resource.TestCase{
eCheck:k(ctx, t); testAccPreCheck(ctx, t) },
rorCheck: acctest.ErrorCheck(t, servicequotas.EndpointsID),
otoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
eckDestroy:nil,
eps: []resource.TestStep{
{
...
eCheck:k(ctx, t); testAccPreCheck(ctx, t); acctest.PreCheckAssumeRoleARN(t) },
rorCheck: acctest.ErrorCheck(t, servicequotas.EndpointsID),
otoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
eckDestroy:nil,
eps: []resource.TestStep{
...
data "aws_servicequotas_service_quota" "test" {
  ...
  value_service_quota.test.value
}
...
ctest.ConfigAssumeRolePolicy(policy),
t.Sprintf(`
resource "aws_servicequotas_service_quota" "test" {
  service_code = %[1]q
  quota_code= %[2]q
