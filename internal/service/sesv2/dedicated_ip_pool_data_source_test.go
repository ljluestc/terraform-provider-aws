...
// SPDX-License-Identifier: MPL-2.0package sesv2_testimport (
	...
	dataSourceName := "data.aws_sesv2_dedicated_ip_pool.test"	resource.ParallelTest(t, resource.TestCase{
PreCheck: func() {
acctest.PreCheck(ctx, t)
testAccPreCheckDedicatedIPPool(ctx, t)rorCheck: acctest.ErrorCheck(t, names.SESV2EndpointID),
