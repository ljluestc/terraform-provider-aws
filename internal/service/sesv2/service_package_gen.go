// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package sesv2import (
...
TypeName: "aws_sesv2_email_identity_mail_from_attributes",	}
	...
	return []*types.ServicePackageSDKResource{Factory:  ResourceConfigurationSet,
TypeName: "aws_sesv2_configuration_set",
...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*sesv2_sdkv2.Client, error) {
	cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))	return sesv2_sdkv2.NewFromConfig(cfg, func(o *sesv2_sdkv2.Options) {
