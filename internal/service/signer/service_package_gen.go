// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package signerimport (
...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*signer_sdkv2.Client, error) {
	cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))	return signer_sdkv2.NewFromConfig(cfg, func(o *signer_sdkv2.Options) {
