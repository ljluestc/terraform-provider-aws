...
// SPDX-License-Identifier: MPL-2.0package ssm_testimport (
	...
	name := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)	resource.ParallelTest(t, resource.TestCase{
...
resource.TestCheckResourceAttr(resourceName, "with_decryption", "true"),
	...
	ctx := acctest.Context(t)
	resourceName := "data.aws_ssm_parameter.test"
	name := sdkacctest.RandomWithPrefix("/tf-acc-test/tf-acc-test")	resource.ParallelTest(t, resource.TestCase{
PreCheck:.PreCheck(ctx, t) },
ErrorCheck: acctest.ErrorCheck(t, ssm.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
Steps: []resource.TestStep{
...
resource.TestCheckResourceAttr(resourceName, "with_decryption", "false"),
	...
	dataSourceName := "data.aws_ssm_parameter.test"	resource.ParallelTest(t, resource.TestCase{
PreCheck:.PreCheck(ctx, t) },
ErrorCheck: acctest.ErrorCheck(t, ssm.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
