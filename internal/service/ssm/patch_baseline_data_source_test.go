...
funcTestAccSSMPatchBaselineDataSource_existingBaseline(t*testing.T){
...
resource.TestCheckResourceAttr(dataSourceName,"description","DefaultPatchBaselineforCentOSProvidedbyAWS."),
...
funcTestAccSSMPatchBaselineDataSource_newBaseline(t*testing.T){
ctx:=acctest.Context(t)
dataSourceName:="data.aws_ssm_patch_baseline.test"
...
//TestagainstoneofthedefaultbaselinescreatedbyAWS
functestAccPatchBaselineDataSourceConfig_existing()string{
return`
...
//Createanewbaselineandpullitback
functestAccPatchBaselineDataSourceConfig_new(namestring)string{
returnfmt.Sprintf(`
