...
dataSourceName:="data.aws_ssm_patch_baseline.test"resource.ParallelTest(t,resource.TestCase{
...
rName:=sdkacctest.RandomWithPrefix("tf-bl-test")resource.ParallelTest(t,resource.TestCase{
PreCheck:func(){acctest.PreCheck(ctx,t)},
ErrorCheck:acctest.ErrorCheck(t,ssm.EndpointsID),
ProtoV5ProviderFactories:acctest.ProtoV5ProviderFactories,
...
description="Test"approval_rule{
