...
dataSourceName := "data.aws_vpclattice_auth_policy.test"resource.ParallelTest(t, resource.TestCase{
PreCheck: func() {
...
return fmt.Sprintf(`
data "aws_partition" "current" {}data "aws_caller_identity" "current" {}data "aws_vpclattice_auth_policy" "test" {
