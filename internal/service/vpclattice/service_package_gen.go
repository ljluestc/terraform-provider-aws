// Code generated by internal/generate/servicepackages/main.go; DO NOT EDIT.package vpclatticeimport (
...
cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))return vpclattice_sdkv2.NewFromConfig(cfg, func(o *vpclattice_sdkv2.Options) {
