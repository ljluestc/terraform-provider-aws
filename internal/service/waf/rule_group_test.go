...
var idx intruleName := fmt.Sprintf("tfacc%s", sdkacctest.RandString(5))
...
ctx := acctest.Context(t)
var before, after waf.RuleGroupruleName := fmt.Sprintf("tfacc%s", sdkacctest.RandString(5))
groupName := fmt.Sprintf("tfacc%s", sdkacctest.RandString(5))
...
var idx0, idx1, idx2, idx3 intgroupName := fmt.Sprintf("tfacc%s", sdkacctest.RandString(5))
