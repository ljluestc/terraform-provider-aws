...
// +build sweeppackage wafimport (
"fmt"
"log"
"sync""github.com/aws/aws-sdk-go/aws"
...
var mutex = &sync.Mutex{}input := &waf.ListByteMatchSetsInput{}err = listByteMatchSetsPages(ctx, conn, input, func(page *waf.ListByteMatchSetsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, byteMatchSet := range page.ByteMatchSets {
r := ResourceByteMatchSet()
d := r.Data(nil)id := aws.StringValue(byteMatchSet.ByteMatchSetId)
d.SetId(id)// read concurrently and gather errors
g.Go(func() error {
// Need to Read first to fill in byte_match_tuples attribute
err := sdk.ReadResource(ctx, r, d, client)if err != nil {
...
defer mutex.Unlock()
sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))return nil
})
}return !lastPage
})if err != nil {
...
var errs *multierror.Error
var g multierror.Group
var mutex = &sync.Mutex{}input := &waf.ListGeoMatchSetsInput{}err = listGeoMatchSetsPages(ctx, conn, input, func(page *waf.ListGeoMatchSetsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, geoMatchSet := range page.GeoMatchSets {
r := ResourceGeoMatchSet()
d := r.Data(nil)id := aws.StringValue(geoMatchSet.GeoMatchSetId)
d.SetId(id)// read concurrently and gather errors
g.Go(func() error {
...
var errs *multierror.Error
var g multierror.Group
var mutex = &sync.Mutex{}input := &waf.ListIPSetsInput{}err = listIPSetsPages(ctx, conn, input, func(page *waf.ListIPSetsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, ipSet := range page.IPSets {
r := ResourceIPSet()
d := r.Data(nil)id := aws.StringValue(ipSet.IPSetId)
d.SetId(id)// read concurrently and gather errors
g.Go(func() error {
...
var errs *multierror.Error
var g multierror.Group
var mutex = &sync.Mutex{}input := &waf.ListRateBasedRulesInput{}err = listRateBasedRulesPages(ctx, conn, input, func(page *waf.ListRateBasedRulesOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, rule := range page.Rules {
r := ResourceRateBasedRule()
d := r.Data(nil)id := aws.StringValue(rule.RuleId)
d.SetId(id)// read concurrently and gather errors
g.Go(func() error {
...
var errs *multierror.Error
var g multierror.Group
var mutex = &sync.Mutex{}input := &waf.ListRegexMatchSetsInput{}err = listRegexMatchSetsPages(ctx, conn, input, func(page *waf.ListRegexMatchSetsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, regexMatchSet := range page.RegexMatchSets {
r := ResourceRegexMatchSet()
d := r.Data(nil)id := aws.StringValue(regexMatchSet.RegexMatchSetId)
d.SetId(id)// read concurrently and gather errors
g.Go(func() error {
...
var errs *multierror.Error
var g multierror.Group
var mutex = &sync.Mutex{}input := &waf.ListRegexPatternSetsInput{}err = listRegexPatternSetsPages(ctx, conn, input, func(page *waf.ListRegexPatternSetsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, regexPatternSet := range page.RegexPatternSets {
r := ResourceRegexPatternSet()
d := r.Data(nil)id := aws.StringValue(regexPatternSet.RegexPatternSetId)
d.SetId(id)// read concurrently and gather errors
g.Go(func() error {
...
var errs *multierror.Error
var g multierror.Group
var mutex = &sync.Mutex{}input := &waf.ListRuleGroupsInput{}err = listRuleGroupsPages(ctx, conn, input, func(page *waf.ListRuleGroupsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, ruleGroup := range page.RuleGroups {
r := ResourceRuleGroup()
d := r.Data(nil)id := aws.StringValue(ruleGroup.RuleGroupId)
d.SetId(id)// read concurrently and gather errors
g.Go(func() error {
...
var errs *multierror.Error
var g multierror.Group
var mutex = &sync.Mutex{}input := &waf.ListRulesInput{}err = listRulesPages(ctx, conn, input, func(page *waf.ListRulesOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, rule := range page.Rules {
if rule == nil {
...
var errs *multierror.Error
var g multierror.Group
var mutex = &sync.Mutex{}input := &waf.ListSizeConstraintSetsInput{}err = listSizeConstraintSetsPages(ctx, conn, input, func(page *waf.ListSizeConstraintSetsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, sizeConstraintSet := range page.SizeConstraintSets {
r := ResourceSizeConstraintSet()
d := r.Data(nil)id := aws.StringValue(sizeConstraintSet.SizeConstraintSetId)
d.SetId(id)// read concurrently and gather errors
g.Go(func() error {
...
var errs *multierror.Error
var g multierror.Group
var mutex = &sync.Mutex{}input := &waf.ListSqlInjectionMatchSetsInput{}err = listSQLInjectionMatchSetsPages(ctx, conn, input, func(page *waf.ListSqlInjectionMatchSetsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, sqlInjectionMatchSet := range page.SqlInjectionMatchSets {
r := ResourceSQLInjectionMatchSet()
d := r.Data(nil)id := aws.StringValue(sqlInjectionMatchSet.SqlInjectionMatchSetId)
d.SetId(id)// read concurrently and gather errors
g.Go(func() error {
...
var errs *multierror.Error
var g multierror.Group
var mutex = &sync.Mutex{}input := &waf.ListWebACLsInput{}err = listWebACLsPages(ctx, conn, input, func(page *waf.ListWebACLsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
...
d := r.Data(nil)id := aws.StringValue(webACL.WebACLId)
d.SetId(id)// read concurrently and gather errors
g.Go(func() error {
...
var errs *multierror.Error
var g multierror.Group
var mutex = &sync.Mutex{}input := &waf.ListXssMatchSetsInput{}err = listXSSMatchSetsPages(ctx, conn, input, func(page *waf.ListXssMatchSetsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, xssMatchSet := range page.XssMatchSets {
r := ResourceXSSMatchSet()
d := r.Data(nil)id := aws.StringValue(xssMatchSet.XssMatchSetId)
d.SetId(id)// read concurrently and gather errors
g.Go(func() error {
