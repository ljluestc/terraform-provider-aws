...
// SPDX-License-Identifier: MPL-2.0package wafregional_testimport (
	...
	resourceName := "aws_wafregional_byte_match_set.byte_set"	resource.ParallelTest(t, resource.TestCase{
...
ImportStateVerify: true,
	...
	byteMatchSetName := fmt.Sprintf("byte-batch-set-%s", sdkacctest.RandString(5))
	resourceName := "aws_wafregional_byte_match_set.byte_match_set"	resource.ParallelTest(t, resource.TestCase{
PreCheck: func() { acctest.PreCheck(ctx, t); acctest.PreCheckPartitionHasService(t, wafregional.EndpointsID) },
ErrorCheck:acctest.ErrorCheck(t, wafregional.EndpointsID),
ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
CheckDestroy:testAccCheckByteMatchSetDestroy(ctx),
...
}func testAccCheckByteMatchSetDisappears(ctx context.Context, v *waf.ByteMatchSet) resource.TestCheck
func {
...
}func testAccCheckByteMatchSetExists(ctx context.Context, n string, v *waf.ByteMatchSet) resource.TestCheck
func {
	returnfunc(s *terraform.State) error {
...
}func testAccCheckByteMatchSetDestroy(ctx context.Context) resource.TestCheck
func {
	returnfunc(s *terraform.State) error {
...
text_transformation= "NONE"
target_string= "GET"
positional_constraint = "EXACTLY"field_to_match {
type = "METHOD"
}
  }  byte_match_tuples {
text_transformation= "LOWERCASE"
target_string= "badrefer2+"
positional_constraint = "ENDS_WITH"field_to_match {
type = "URI"
}
  }
}
