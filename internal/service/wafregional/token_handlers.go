...
"context"
"fmt"
"time""github.com/aws/aws-sdk-go/service/waf"
...
defer conns.GlobalMutexKV.Unlock(t.Region)var out interface{}
var tokenOut *waf.GetChangeTokenOutput
err := retry.RetryContext(ctx, 15*time.Minute,func() *retry.RetryError {
var err errortokenOut, err = t.Connection.GetChangeToken(&waf.GetChangeTokenInput{})
if err != nil {
...
tokenOut, err = t.Connection.GetChangeToken(&waf.GetChangeTokenInput{})if err != nil {
