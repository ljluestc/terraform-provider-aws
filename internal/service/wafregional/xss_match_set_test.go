...
resourceName := "aws_wafregional_xss_match_set.test"resource.ParallelTest(t, resource.TestCase{
...
}func testAccCheckXSSMatchSetExists(ctx context.Context, n string, v *waf.XssMatchSet) resource.TestCheck
func {
...
}func testAccCheckXSSMatchSetDestroy(ctx context.Context) resource.TestCheck
func {
returnfunc(s *terraform.State) error {
...
resource "aws_wafregional_xss_match_set" "test" {
  name = %[1]q  xss_match_tuple {
text_transformation = "CMD_LINE"field_to_match {
type = "BODY"
}
  }  xss_match_tuple {
text_transformation = "HTML_ENTITY_DECODE"field_to_match {
type = "METHOD"
}
  }
}
