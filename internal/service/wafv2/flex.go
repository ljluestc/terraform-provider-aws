...
func expandRules(l []interface{}) []*wafv2.Rule {
	if len(l) == 0 || l[0] == nil {
return nil
	}	rules := make([]*wafv2.Rule, 0)	for _, rule := range l {
if rule == nil {
continue
}
...
Statement:ment(m["statement"].([]interface{})),
...
func expandCaptchaConfig(l []interface{}) *wafv2.CaptchaConfig {
	configuration := &wafv2.CaptchaConfig{}	if len(l) == 0 || l[0] == nil {
...
return configuration
}m = inner[0].(map[string]interface{})if v, ok := m["immunity_time"]; ok {
...
func expandAssociationConfig(l []interface{}) *wafv2.AssociationConfig {
	if len(l) == 0 || l[0] == nil {
return nil
	}	configuration := &wafv2.AssociationConfig{}	m := l[0].(map[string]interface{})
...
func expandRequestBodyConfigItem(l []interface{}) *wafv2.RequestBodyAssociatedResourceTypeConfig {
	configuration := &wafv2.RequestBodyAssociatedResourceTypeConfig{}	if len(l) == 0 || l[0] == nil {
return configuration
	}	m := l[0].(map[string]interface{})
...
func expandRuleLabels(l []interface{}) []*wafv2.Label {
	if len(l) == 0 || l[0] == nil {
return nil
	}	labels := make([]*wafv2.Label, 0)	for _, label := range l {
if label == nil {
continue
}
...
return nil
	...
	action := &wafv2.RuleAction{}	if v, ok := m["allow"]; ok && len(v.([]interface{})) > 0 {
...
func expandAllowAction(l []interface{}) *wafv2.AllowAction {
	action := &wafv2.AllowAction{}	if len(l) == 0 || l[0] == nil {
return action
...
func expandBlockAction(l []interface{}) *wafv2.BlockAction {
	action := &wafv2.BlockAction{}	if len(l) == 0 || l[0] == nil {
return action
	}	m, ok := l[0].(map[string]interface{})
	if !ok {
return action
...
func expandCaptchaAction(l []interface{}) *wafv2.CaptchaAction {
	action := &wafv2.CaptchaAction{}	if len(l) == 0 || l[0] == nil {
return action
	}	m, ok := l[0].(map[string]interface{})
	if !ok {
return action
...
func expandChallengeAction(l []interface{}) *wafv2.ChallengeAction {
	action := &wafv2.ChallengeAction{}	if len(l) == 0 || l[0] == nil {
return action
	}	m, ok := l[0].(map[string]interface{})
	if !ok {
return action
...
func expandCountAction(l []interface{}) *wafv2.CountAction {
	action := &wafv2.CountAction{}	if len(l) == 0 || l[0] == nil {
return action
	}	m, ok := l[0].(map[string]interface{})
	if !ok {
return action
...
func expandCustomResponseBodies(m []interface{}) map[string]*wafv2.CustomResponseBody {
	if len(m) == 0 {
return nil
	}	customResponseBodies := make(map[string]*wafv2.CustomResponseBody, len(m))	for _, v := range m {
...
return nil
	...
	if !ok {
return nil
	}	customResponse := &wafv2.CustomResponse{}	if v, ok := m["custom_response_body_key"].(string); ok && v != "" {
...
return nil
	...
	requestHandling := &wafv2.CustomRequestHandling{}	if v, ok := m["insert_header"].(*schema.Set); ok && len(v.List()) > 0 {
...
func expandCustomHeaders(l []interface{}) []*wafv2.CustomHTTPHeader {
	if len(l) == 0 || l[0] == nil {
return nil
	}	headers := make([]*wafv2.CustomHTTPHeader, 0)	for _, header := range l {
if header == nil {
continue
}
...
func expandVisibilityConfig(l []interface{}) *wafv2.VisibilityConfig {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	configuration := &wafv2.VisibilityConfig{}	if v, ok := m["cloudwatch_metrics_enabled"]; ok {
...
func expandRuleGroupRootStatement(l []interface{}) *wafv2.Statement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return expandStatement(m)
}
func expandStatements(l []interface{}) []*wafv2.Statement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	statements := make([]*wafv2.Statement, 0)	for _, statement := range l {
if statement == nil {
continue
}
...
func expandStatement(m map[string]interface{}) *wafv2.Statement {
	if m == nil {
return nil
	}	statement := &wafv2.Statement{}	if v, ok := m["and_statement"]; ok {
...
func expandAndStatement(l []interface{}) *wafv2.AndStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.AndStatement{
...
func expandByteMatchStatement(l []interface{}) *wafv2.ByteMatchStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.ByteMatchStatement{
...
return nil
	...
	f := &wafv2.FieldToMatch{}	if v, ok := m["all_query_arguments"]; ok && len(v.([]interface{})) > 0 {
...
func expandForwardedIPConfig(l []interface{}) *wafv2.ForwardedIPConfig {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.ForwardedIPConfig{
...
func expandIPSetForwardedIPConfig(l []interface{}) *wafv2.IPSetForwardedIPConfig {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.IPSetForwardedIPConfig{
FallbackBehavior: aws.String(m["fallback_behavior"].(string)),
HeaderName:aws.String(m["header_name"].(string)),
...
func expandCookies(l []interface{}) *wafv2.Cookies {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	cookies := &wafv2.Cookies{
...
return nil
	...
	CookieMatchPattern := &wafv2.CookieMatchPattern{}	if v, ok := m["included_cookies"]; ok && len(v.([]interface{})) > 0 {
...
func expandJSONBody(l []interface{}) *wafv2.JsonBody {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	jsonBody := &wafv2.JsonBody{
MatchScope:aws.String(m["match_scope"].(string)),
OversizeHandling: aws.String(m["oversize_handling"].(string)),
...
func expandBody(l []interface{}) *wafv2.Body {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	body := &wafv2.Body{}	if v, ok := m["oversize_handling"].(string); ok && v != "" {
...
return nil
	...
	jsonMatchPattern := &wafv2.JsonMatchPattern{}	if v, ok := m["all"].([]interface{}); ok && len(v) > 0 {
...
func expandSingleHeader(l []interface{}) *wafv2.SingleHeader {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.SingleHeader{
Name: aws.String(m["name"].(string)),
	}
}
func expandSingleQueryArgument(l []interface{}) *wafv2.SingleQueryArgument {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.SingleQueryArgument{
Name: aws.String(m["name"].(string)),
	}
}
func expandTextTransformations(l []interface{}) []*wafv2.TextTransformation {
	if len(l) == 0 || l[0] == nil {
return nil
	}	rules := make([]*wafv2.TextTransformation, 0)	for _, rule := range l {
if rule == nil {
continue
}
...
func expandIPSetReferenceStatement(l []interface{}) *wafv2.IPSetReferenceStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	statement := &wafv2.IPSetReferenceStatement{
...
func expandGeoMatchStatement(l []interface{}) *wafv2.GeoMatchStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	statement := &wafv2.GeoMatchStatement{
...
func expandLabelMatchStatement(l []interface{}) *wafv2.LabelMatchStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	statement := &wafv2.LabelMatchStatement{
...
return nil
	...
	s := m["statement"].([]interface{})	if len(s) == 0 || s[0] == nil {
return nil
	}	m = s[0].(map[string]interface{})	return &wafv2.NotStatement{
...
func expandOrStatement(l []interface{}) *wafv2.OrStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.OrStatement{
Statements: expandStatements(m["statement"].([]interface{})),
	}
}
func expandRegexMatchStatement(l []interface{}) *wafv2.RegexMatchStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.RegexMatchStatement{
RegexString:aws.String(m["regex_string"].(string)),
FieldToMatch:eld_to_match"].([]interface{})),
TextTransformations: expandTextTransformations(m["text_transformation"].(*schema.Set).List()),
	}
}
func expandRegexPatternSetReferenceStatement(l []interface{}) *wafv2.RegexPatternSetReferenceStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.RegexPatternSetReferenceStatement{
ARN:aws.String(m["arn"].(string)),
FieldToMatch:eld_to_match"].([]interface{})),
TextTransformations: expandTextTransformations(m["text_transformation"].(*schema.Set).List()),
	}
...
func expandSizeConstraintStatement(l []interface{}) *wafv2.SizeConstraintStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.SizeConstraintStatement{
...
func expandSQLiMatchStatement(l []interface{}) *wafv2.SqliMatchStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.SqliMatchStatement{
FieldToMatch:eld_to_match"].([]interface{})),
TextTransformations: expandTextTransformations(m["text_transformation"].(*schema.Set).List()),
	}
}
func expandXSSMatchStatement(l []interface{}) *wafv2.XssMatchStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.XssMatchStatement{
FieldToMatch:eld_to_match"].([]interface{})),
TextTransformations: expandTextTransformations(m["text_transformation"].(*schema.Set).List()),
	}
}
func expandHeaders(l []interface{}) *wafv2.Headers {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.Headers{
...
return nil
	...
	f := &wafv2.HeaderMatchPattern{}	if v, ok := m["all"]; ok && len(v.([]interface{})) > 0 {
f.All = &wafv2.All{}
...
Priority:aws.Int64(int64(m["priority"].(int))),
Statement:t(m["statement"].([]interface{})),
VisibilityConfig: expandVisibilityConfig(m["visibility_config"].([]interface{})),
	}	if v, ok := m["rule_label"].(*schema.Set); ok && v.Len() > 0 {
rule.RuleLabels = expandRuleLabels(v.List())
	}	return rule
...
return nil
	...
	action := &wafv2.OverrideAction{}	if v, ok := m["count"]; ok && len(v.([]interface{})) > 0 {
...
return nil
	...
	action := &wafv2.DefaultAction{}	if v, ok := m["allow"]; ok && len(v.([]interface{})) > 0 {
action.Allow = expandAllowAction(v.([]interface{}))
	}	if v, ok := m["block"]; ok && len(v.([]interface{})) > 0 {
action.Block = expandBlockAction(v.([]interface{}))
	}	return action
...
func expandWebACLRootStatement(l []interface{}) *wafv2.Statement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return expandWebACLStatement(m)
}
...
func expandRuleGroupReferenceStatement(l []interface{}) *wafv2.RuleGroupReferenceStatement {
	if len(l) == 0 || l[0] == nil {
return nil
	}	m := l[0].(map[string]interface{})	return &wafv2.RuleGroupReferenceStatement{
ARN:aws.String(m["arn"].(string)),
RuleActionOverrides: expandRuleActionOverrides(m["rule_action_override"].([]interface{})),
	}
}
func expandRuleActionOverrides(l []interface{}) []*wafv2.RuleActionOverride {
	if len(l) == 0 || l[0] == nil {
return nil
	}	overrides := make([]*wafv2.RuleActionOverride, 0)	for _, override := range l {
if override == nil {
continue
}
...
func flattenRuleAction(a *wafv2.RuleAction) interface{} {
	if a == nil {
return []interface{}{}
	}	m := map[string]interface{}{}	if a.Allow != nil {
...
return []interface{}{}
	...
	m := map[string]interface{}{}	if a.CustomRequestHandling != nil {
...
func flattenBlock(a *wafv2.BlockAction) []interface{} {
	if a == nil {
return []interface{}{}
	}	m := map[string]interface{}{}	if a.CustomResponse != nil {
...
func flattenStatement(s *wafv2.Statement) map[string]interface{} {
	if s == nil {
return map[string]interface{}{}
	}	m := map[string]interface{}{}	if s.AndStatement != nil {
...
func flattenFieldToMatch(f *wafv2.FieldToMatch) interface{} {
	if f == nil {
return []interface{}{}
	}	m := map[string]interface{}{}	if f.AllQueryArguments != nil {
...
func flattenHeaderMatchPattern(s *wafv2.HeaderMatchPattern) interface{} {
	if s == nil {
return []interface{}{}
	}	m := map[string]interface{}{}	if s.All != nil {
m["all"] = make([]map[string]interface{}, 1)
...
func flattenOverrideAction(a *wafv2.OverrideAction) interface{} {
	if a == nil {
return []interface{}{}
	}	m := map[string]interface{}{}	if a.Count != nil {
...
func flattenManagedRuleGroupStatement(apiObject *wafv2.ManagedRuleGroupStatement) interface{} {
	if apiObject == nil {
return []interface{}{}
	}	tfMap := map[string]interface{}{}	if apiObject.Name != nil {
...
func flattenManagedRuleGroupConfigs(c []*wafv2.ManagedRuleGroupConfig) []interface{} {
	if len(c) == 0 {
return nil
	}	var out []interface{}	for _, config := range c {
m := make(map[string]interface{})
...
func flattenRateBasedStatement(apiObject *wafv2.RateBasedStatement) interface{} {
	if apiObject == nil {
return []interface{}{}
	}	tfMap := map[string]interface{}{}	if apiObject.AggregateKeyType != nil {
...
func flattenRegexPatternSet(r []*wafv2.Regex) interface{} {
	if r == nil {
return []interface{}{}
	}	regexPatterns := make([]interface{}, 0)	for _, regexPattern := range r {
if regexPattern == nil {
continue
}
