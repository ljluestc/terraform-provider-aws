...
// +build sweeppackage wafv2import (
	"fmt"
	"log"
...
Scope: aws.String(wafv2.ScopeRegional),
	...
	sweepResources := make([]sweep.Sweepable, 0)	err = listIPSetsPages(ctx, conn, input, func(page *wafv2.ListIPSetsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
...
d.Set("name", v.Name)
d.Set("scope", input.Scope)sweepResources = append(sweepResources, sweep.NewSweepResource(r, d, client))
}return !lastPage
...
Scope: aws.String(wafv2.ScopeRegional),
	...
	sweepResources := make([]sweep.Sweepable, 0)	err = listRegexPatternSetsPages(ctx, conn, input, func(page *wafv2.ListRegexPatternSetsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
...
Scope: aws.String(wafv2.ScopeRegional),
	...
	sweepResources := make([]sweep.Sweepable, 0)	err = listRuleGroupsPages(ctx, conn, input, func(page *wafv2.ListRuleGroupsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
...
Scope: aws.String(wafv2.ScopeRegional),
	...
	sweepResources := make([]sweep.Sweepable, 0)	err = listWebACLsPages(ctx, conn, input, func(page *wafv2.ListWebACLsOutput, lastPage bool) bool {
if page == nil {
return !lastPage
}for _, v := range page.WebACLs {
name := aws.StringValue(v.Name)// Exclude WebACLs managed by Firewall Manager as deletion returns AccessDeniedException.
